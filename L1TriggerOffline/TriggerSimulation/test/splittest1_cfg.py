...
#from L1TriggerOffline.TriggerSimulation.HitMatchingAlgorithmRegister_cfi import HitMatchingAlgorithm_globalgeometry_PSimHit_
#process.extend(HitMatchingAlgorithm_globalgeometry_PSimHit_)

#from L1TriggerOffline.TriggerSimulation.ClusteringAlgorithmRegister_cfi import ClusteringAlgorithm_a_PSimHit_
#process.extend(ClusteringAlgorithm_a_PSimHit_)

process.load("L1TriggerOffline.TriggerSimulation.LocalStub_cfi")

process.load("L1TriggerOffline.TriggerSimulation.GlobalStub_cfi")

process.load("L1TriggerOffline.TriggerSimulation.Tracklet_cfi")

process.load("L1TriggerOffline.TriggerSimulation.TrackTriggerHitsFromPixelDigis_cfi")
