...
class SingleTopSystematicsDumper : public edm::EDAnalyzer {
 ...
 private:
  ...
  //InputTags
  edm::InputTag leptonsPt_,leptonsPhi_,leptonsPz_,leptonsEta_,leptonsCharge_,jetsPt_,jetsPx_,jetsPy_,jetsPz_,jetsEta_,jetsEnergy_,jetsBTagAlgo_,jetsCorrTotal_,jetsAntiBTagAlgo_,METPt_,METPhi_,jetsFlavour_,UnclMETPx_,UnclMETPy_;
