...
SingleTopSystematicsDumper::SingleTopSystematicsDumper(const edm::ParameterSet& iConfig)
{
  ...
  //  cout<< "I work for now but I do nothing. But again, if you gotta do nothing, you better do it right. To prove my good will I will provide you with some numbers later."<<endl;
}
...
void SingleTopSystematicsDumper::analyze(const Event& iEvent, const EventSetup& iSetup)
{
  ...
  //	    << " result at 50 GeV, 0,6 |eta| " << perfHP->getResult( PerformanceResult::BTAGLEFF, measurePoint)
  //	    << std::endl;
