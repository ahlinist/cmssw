...
//
// last change : $Date: 2005/03/01 13:45:38 $
// by          : $Author: brunelie $
//
...
class H4Geom: public TObject
{
 public:
  ...
  int SmNumberingToElectronicsNumbering(int smCrystal) const;

  // Returns crystal number in supermodule numbering from crystal number in 
  // electronics numbering
  int ElectronicsNumberingToSmNumbering(int elecChannel) const;
