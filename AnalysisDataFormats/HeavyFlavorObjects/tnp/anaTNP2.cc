...
// ----------------------------------------------------------------------
anaTNP2::anaTNP2(const char *dir, int i) { 
  init(dir, i);
}

// ----------------------------------------------------------------------
void anaTNP2::init(const char *dir, int i) {
  ...
  system(Form("/bin/rm -f %s/anaTNP2.tex", fDirectory.c_str()));
  fNumbersFileName = fDirectory + string("/anaTNP2.tex");
  loadFiles(dir, i);
...
// ----------------------------------------------------------------------
void anaTNP2::loadFiles(const char *dir, int i) {
...
// ----------------------------------------------------------------------
void anaTNP2::makeAll(int channel) {
...
// ----------------------------------------------------------------------
void anaTNP2::readPidTables(const char *sample) {
...
// ----------------------------------------------------------------------
void anaTNP2::readHistograms(TFile *f, 
...
// ----------------------------------------------------------------------
void anaTNP2::addBackground(vector<TH1D> &vec, double sb, double p0, double p1) {  
  TH1D *h;
  int s; 
...
// ----------------------------------------------------------------------
void anaTNP2::biasPlots(const char *fname, const char *psname,  int mode) {
...
// ----------------------------------------------------------------------
bool anaTNP2::getBinCenters(string hname, double &eta, double &pT, int &Q) {
  bool ok(false); 
