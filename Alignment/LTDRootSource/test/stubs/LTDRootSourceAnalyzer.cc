...
// Class:      LTDRootSourceAnalyzer.cc
// 
/**\class LTDRootSourceAnalyzer LTDRootSourceAnalyzer.cc AlignmentTools/OptAlignGeneratedSource/test/stubs/LTDRootSourceAnalyzer.cc
...
// $Id: LTDRootSourceAnalyzer.cc,v 1.1 2006/01/26 15:03:51 case Exp $
//
//
...
class LTDRootSourceAnalyzer : public edm::EDAnalyzer
{
public:
  explicit  LTDRootSourceAnalyzer(edm::ParameterSet const& p) 
  { }
  explicit  LTDRootSourceAnalyzer(int i) 
  { }
  virtual ~ LTDRootSourceAnalyzer() { }
...
void LTDRootSourceAnalyzer::beginJob ( const edm::EventSetup& c ) {
...
void LTDRootSourceAnalyzer::analyze(const edm::Event& e, const edm::EventSetup& context)
{
  ...
  e.getByLabel("LTDRootSource", oaHandle); 
...
DEFINE_FWK_MODULE(LTDRootSourceAnalyzer)
