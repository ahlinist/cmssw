...
cmsDriver.py mc -s RAW2DIGI,RECO,VALIDATION --eventcontent RECO --conditions auto:startup -n 100 --no_exec --mc --customise RecoTracker/Loopers/Adapter.adapt,RecoTracker/Loopers/debug.debug --dbs find file,file.parent where dataset= /RelValTTbar/CMSSW_5_0_0-START50_*/GEN-SIM-RECO --process LOOPER
