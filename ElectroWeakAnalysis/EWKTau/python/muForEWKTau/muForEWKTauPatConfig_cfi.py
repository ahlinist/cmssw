...
# increase size of muon isolation cone from default of deltaR = 0.3 to 0.8;
...
#  o ...
allLayer0MuForEWKTau.isolation.tracker.deltaR = cms.double(0.8)
allLayer0MuForEWKTau.isolation.tracker.cut = cms.double(1.0)
allLayer0MuForEWKTau.isolation.ecal.deltaR = cms.double(0.8)
allLayer0MuForEWKTau.isolation.ecal.cut = cms.double(1.0)
allLayer0MuForEWKTau.isolation.hcal.deltaR = cms.double(0.8)
#allLayer0MuForEWKTau.isolation.hcal.cut = cms.double(2.0)
allLayer0MuForEWKTau.isolation.user.deltaR = cms.double(0.8)
...
# increase size of muon isolation cone from default of deltaR = 0.3 to 0.8 
allLayer1MuForEWKTau.isolation.hcal.deltaR = cms.double(0.8)
allLayer1MuForEWKTau.isolation.tracker.deltaR = cms.double(0.8)
allLayer1MuForEWKTau.isolation.user.deltaR = cms.double(0.8)
allLayer1MuForEWKTau.isolation.ecal.deltaR = cms.double(0.8)
