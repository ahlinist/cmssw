...
#ifndef ZETauRecoTauJetMcFilter_H
#define ZETauRecoTauJetMcFilter_H
...
#include <vector>
#include <set>
class ZETauRecoTauJetMcFilter: public edm::EDFilter {
 public:
  explicit ZETauRecoTauJetMcFilter(const edm::ParameterSet&);
  ~ZETauRecoTauJetMcFilter();
