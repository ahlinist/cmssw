...
## http://cmssw.cvs.cern.ch/cgi-bin/cmssw.cgi/CMSSW/ElectroWeakAnalysis/WENu/python/simpleCutBasedElectronIDSpring10_cfi.py?revision=1.6&view=markup&pathrev=V00-02-01
