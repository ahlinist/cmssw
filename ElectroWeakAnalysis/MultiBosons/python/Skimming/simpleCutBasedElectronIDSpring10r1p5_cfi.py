...
## http://cmssw.cvs.cern.ch/cgi-bin/cmssw.cgi/CMSSW/ElectroWeakAnalysis/WENu/python/simpleCutBasedElectronIDSpring10_cfi.py?revision=1.5&view=markup&pathrev=V00-01-08-09
...
## JV: this version has no delta eta cut in the EE as recommended for ICHEP
