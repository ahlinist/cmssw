...
sw_commissioning_selection = cms.PSet(
    verbose_output = cms.bool(False),
    ...
    maxDeltaRPhotonNearLepton = cms.double(0.5), ## off by default
    ...
    cutsToIgnore = cms.vstring("max DR(g,l_near)"),
    )
