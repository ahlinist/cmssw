#ifndef ElectroWeakAnalysis_MultiBosons_EgammaTrackExtractorVtx_H
#define ElectroWeakAnalysis_MultiBosons_EgammaTrackExtractorVtx_H
...
class EgammaTrackExtractorVtx : public reco::isodeposit::IsoDepositExtractor {

public:

  EgammaTrackExtractorVtx(){};
  EgammaTrackExtractorVtx(const edm::ParameterSet& par);

  virtual ~EgammaTrackExtractorVtx(){}
  ...
  virtual reco::IsoDeposit deposit (const edm::Event & ev,
      const edm::EventSetup & evSetup, const reco::Track & muon) const {
        edm::LogWarning("EgammaIsolationAlgos|EgammaTrackExtractorVtx") 
...
private:
  ...
  std::string theBeamlineOption;            //! "NONE", "BeamSpotFromEvent", "UseVertex"
