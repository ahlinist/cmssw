void plotL1Efficiency() {
    ...
    // PFTau Eta
        ...
        plotter->DrawHistogram("PFTauEta>>hnum(25.,-2.5,2.5)","PFTauEt>10.&&hasMatchedL1Jet==1","PFTauEt>15.");
	TH1F *h_PFTauEta_L1Jet = new TH1F(*((TH1F*)gDirectory->Get("hnum")));

        plotter->SetXTitle("Tau jet #eta");
        plotter->SetFileName("L1Eff_PFTauEta_L1Tau.C");
        plotter->DrawHistogram("PFTauEta>>hnum(25.,-2.5,2.5)","PFTauEt>10.&&hasMatchedL1TauJet==1","PFTauEt>15.");
	TH1F *h_PFTauEta_L1TauVeto_Emu = new TH1F(*((TH1F*)gDirectory->Get("hnum")));

        plotter->SetXTitle("Tau jet #eta");
        plotter->SetFileName("L1Eff_PFTauEta_L1TauVeto.C");
        plotter->DrawHistogram("PFTauEta>>hnum(25.,-2.5,2.5)","PFTauEt>10.&&L1TauVeto==0 && hasMatchedL1Jet==1","PFTauEt>15.");
	TH1F *h_PFTauEta_L1TauVeto_Sim = new TH1F(*((TH1F*)gDirectory->Get("hnum")));

        plotter->SetXTitle("Tau jet #eta");
        plotter->SetFileName("L1Eff_PFTauEta_L1IsolationVeto.C");
        plotter->DrawHistogram("PFTauEta>>hnum(25.,-2.5,2.5)","PFTauEt>10.&&L1IsolationVeto==0 && hasMatchedL1Jet==1","PFTauEt>15.");

        plotter->SetXTitle("Tau jet #eta");
        plotter->SetFileName("L1Eff_PFTauEta_L1TauVeto_L1IsolationVeto.C");
        plotter->DrawHistogram("PFTauEta>>hnum(25.,-2.5,2.5)","PFTauEt>10.&&L1TauVeto==0&&L1IsolationVeto==0&&hasMatchedL1Jet==1","PFTauEt>15.");
	TH1F *h_PFTauEta_L1TauIsoVeto_Sim = new TH1F(*((TH1F*)gDirectory->Get("hnum")));

        plotter->SetXTitle("Tau jet #eta");
        plotter->SetFileName("L1Eff_PFTauEta_L1EmTauVeto.C");
        plotter->DrawHistogram("PFTauEta>>hnum(25.,-2.5,2.5)","PFTauEt>10.&&L1EmTauVeto==0&&hasMatchedL1Jet==1","PFTauEt>15.");

        plotter->SetXTitle("Tau jet #eta");
        plotter->SetFileName("L1Eff_PFTauEta_L1HadTauVeto.C");
        plotter->DrawHistogram("PFTauEta>>hnum(25.,-2.5,2.5)","PFTauEt>10.&&L1HadTauVeto==0&&hasMatchedL1Jet==1","PFTauEt>15.");

        plotter->SetXTitle("Tau jet #eta");
        plotter->SetFileName("L1Eff_PFTauEta_L1EmTauVeto_L1HadTauVeto.C");
        plotter->DrawHistogram("PFTauEta>>hnum(25.,-2.5,2.5)","PFTauEt>10.&&(L1EmTauVeto==0||L1HadTauVeto==0)&&hasMatchedL1Jet==1","PFTauEt>15.");
