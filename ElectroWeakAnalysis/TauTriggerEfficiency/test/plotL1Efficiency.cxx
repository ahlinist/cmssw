...
struct Graphs {
  Graph(): L1Jet(0), L1TauVeto_Emu(0), L1TauVeto_Sim(0), L1TauIsoVeto_Sim(0) {}
...
Graphs plotHelper(Plotter *plotter, bool print, TString plotDir,
  ...
  ret.L1Jet =  plotter->DrawHistogram(draw,"hasMatchedL1Jet==1",selection2);
...
void plotL1Efficiency(  bool print=false) {
  ...
  Graphs PFTauEt = plotHelper(plotter, print, plotDir, "PFTauEt", 25, 0, 100, DenEtaCut);
  ...
  PFTauEt.L1Jet->SetMinimum(0);
  PFTauEt.L1Jet->SetMaximum(1.1);
  PFTauEt.L1Jet->Draw("PA");
  //PFTauEt.L1Jet->SetAxisRange(0.,1.1,"Y");
  PFTauEt.L1Jet->SetMarkerColor(kBlack);
  ...
  TLegend* leg = new TLegend(0.4,0.2,0.7,0.4);
  leg->AddEntry(PFTauEt.L1Jet,"L1 Jet matched","p");
  ...
  Graphs PFTauEta = plotHelper(plotter, print, plotDir, "PFTauEta", 25, -2.5, 2.5, DenEtCut);
  ...
  PFTauEta.L1Jet->SetMinimum(0);
  PFTauEta.L1Jet->SetMaximum(1.1);
  PFTauEta.L1Jet->Draw("PA");
  //PFTauEtaL1Jet->SetAxisRange(0.,1.1,"Y");
  PFTauEta.L1Jet->SetMarkerColor(kBlack);
  ...
  TLegend* leg = new TLegend(0.4,0.2,0.7,0.4);
  leg->AddEntry(PFTauEta.L1Jet,"L1 Jet matched","p");
