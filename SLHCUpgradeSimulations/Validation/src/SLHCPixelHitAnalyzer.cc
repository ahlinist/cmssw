...
SLHCPixelHitAnalyzer::SLHCPixelHitAnalyzer(edm::ParameterSet const& iConfig) : 
  conf_(iConfig),
  PixHitTree_(0),
  TrackTree_(0),
...
SLHCPixelHitAnalyzer::~SLHCPixelHitAnalyzer() { }  

// End job: write and close the ntuple file
void SLHCPixelHitAnalyzer::endJob() 
{
...
bool SLHCPixelHitAnalyzer::isValidMuonAssoc(const edm::Event& iEvent){
...
bool SLHCPixelHitAnalyzer::isOffTrackHits(const edm::Event& iEvent,const SiPixelCluster& clust, const edm::EventSetup & iSetup,const RectangularPixelTopology* topol, uint32_t geoId, TrajectoryStateOnSurface& tsos ){
...
void SLHCPixelHitAnalyzer::fillDet(const DetId &tofill, uint subdetid, const PixelGeomDetUnit* PixGeom)
{
  if (subdetid==1) {
...
void SLHCPixelHitAnalyzer::fillVertex(const PixelGeomDetUnit* PixGeom)
{
...
void SLHCPixelHitAnalyzer::fillClust(const SiPixelCluster& matchIt, const RectangularPixelTopology* topol, const PixelGeomDetUnit* PixGeom, TrajectoryStateOnSurface& tsos) 
...
void SLHCPixelHitAnalyzer::fillPix(const SiPixelCluster & LocPix, const RectangularPixelTopology * topol, const PixelGeomDetUnit * PixGeom)
{
...
void SLHCPixelHitAnalyzer::fillTrack(TrajectoryStateOnSurface& tsos,const Trajectory &traj, int TrackNumber) 
{
...
void SLHCPixelHitAnalyzer::fillSim(std::vector<PSimHit>::const_iterator isim, unsigned int subid, const PixelGeomDetUnit * theGeomDet, 
...
void SLHCPixelHitAnalyzer::init() 
{
  evt_.init();
  det_.init();
  vertex_.init();
...
void SLHCPixelHitAnalyzer::EvtStruct::init()
{
  int dummy_int = -9999;
...
void SLHCPixelHitAnalyzer::DetStruct::init()
{
  int dummy_int = -9999;
...
void SLHCPixelHitAnalyzer::VertexStruct::init()
{
  float dummy_float = -9999.0;
...
void SLHCPixelHitAnalyzer::ClusterStruct::init()
{
  float dummy_float = -9999.0;
  int dummy_int = -9999;
...
void SLHCPixelHitAnalyzer::PixInfoStruct::init()
{
  npix = 0;
  hasOverFlow = 0;
...
void SLHCPixelHitAnalyzer::RecHitStruct::init()
{
  float dummy_float = -9999.0;
  int dummy_int = -9999;
  uint32_t dummy_uint = 9999;
...
void SLHCPixelHitAnalyzer::TrackStruct::init()
{
  float dummy_float = -9999.0;
  int dummy_int = -9999;
...
void SLHCPixelHitAnalyzer::SimStruct::init()
{
  float dummy_float = -9999.0;
  int dummy_int = -9999;
  uint32_t dummy_uint = 9999;
...
void SLHCPixelHitAnalyzer::TrackOnlyStruct::init()
{
  int dummy_int = -9999;
  float dummy_float = -9999.0;
...
void SLHCPixelHitAnalyzer::readOffsets()
{
...
void SLHCPixelHitAnalyzer::sectorAndWheel(const  reco::Muon & muon0 ,int & w0,int & s0 )
{
 w0=0;
 s0=0;
...
float SLHCPixelHitAnalyzer::correctedTime(const  reco::Muon & aMuon)
{
...
// ----------------------------------------------------------------------
void SLHCPixelHitAnalyzer::bpixNames(const DetId &pID, int &DBlayer, int &DBladder, int &DBmodule) {
...
// ----------------------------------------------------------------------
void SLHCPixelHitAnalyzer::fpixNames(const DetId &pID, int &DBdisk, int &DBblade, int &DBpanel, int &DBmodule) {
