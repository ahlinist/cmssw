// -*- C++ -*-
//
// Package:    SLHCPrimaryVertexAnalyzer
// Class:      SLHCPrimaryVertexAnalyzer
// 
/**\class SLHCPrimaryVertexAnalyzer SLHCPrimaryVertexAnalyzer.cc Validation/RecoVertex/src/SLHCPrimaryVertexAnalyzer.cc
...
// $Id: SLHCPrimaryVertexAnalyzer.h,v 1.15 2009/03/06 15:08:42 werdmann Exp $
//
//
...
// class declaration
class SLHCPrimaryVertexAnalyzer : public edm::EDAnalyzer {
...
public:
  explicit SLHCPrimaryVertexAnalyzer(const edm::ParameterSet&);
  ~SLHCPrimaryVertexAnalyzer();
