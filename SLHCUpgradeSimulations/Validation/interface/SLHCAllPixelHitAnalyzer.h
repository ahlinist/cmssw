#ifndef SLHCAllPixelHitAnalyzer_h
#define SLHCAllPixelHitAnalyzer_h

/** \class SLHCAllPixelHitAnalyzer
 *
 *
 ************************************************************/
...
class SLHCAllPixelHitAnalyzer : public edm::EDAnalyzer
{
 public:
  
  explicit SLHCAllPixelHitAnalyzer(const edm::ParameterSet& ps);
  virtual ~SLHCAllPixelHitAnalyzer();
 ...
 protected:
  ...
  void fillEvt(const edm::Event&,int NbrHits, int NbrTracks);
