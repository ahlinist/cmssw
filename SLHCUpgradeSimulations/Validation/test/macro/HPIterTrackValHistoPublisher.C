...
//   }
   ...
   TH1F * rr[6]={rhp[6],rhp[0],rhp[4],rhp[5],rhp[1],rhp[7]};
   TH1F * ss[6]={shp[6],shp[0],shp[4],shp[5],shp[1],shp[7]};
   ...
   fillStepHisto(rdir, sdir, rl, sl, rhp, shp, "/fakerate", "#eta", "fakerate vs #eta", 0., MAXFAKE);
   // rearrange to a more natural order for plotting
   TH1F * rr[6]={rhp[6],rhp[0],rhp[4],rhp[5],rhp[1],rhp[7]};
   TH1F * ss[6]={shp[6],shp[0],shp[4],shp[5],shp[1],shp[7]};
   ...
   fillStepHisto(rdir, sdir, rl, sl, rhp, shp, "/fakeratePt", "p_{t}", "fakerate vs p_{t}", 0., MAXFAKE);
   // rearrange to a more natural order for plotting
   TH1F * rr[6]={rhp[6],rhp[0],rhp[4],rhp[5],rhp[1],rhp[7]};
   TH1F * ss[6]={shp[6],shp[0],shp[4],shp[5],shp[1],shp[7]};
   ...
   // fill with the histos we want for fake rate
   fillStepHisto(rdir, sdir, rl, sl, rhp, shp, "/fakerate_vs_hit", "hits", "fakerate vs hits", 0., MAXFAKE);
   // rearrange to a more natural order for plotting
   TH1F * rr[6]={rhp[6],rhp[0],rhp[4],rhp[5],rhp[1],rhp[7]};
   TH1F * ss[6]={shp[6],shp[0],shp[4],shp[5],shp[1],shp[7]};
