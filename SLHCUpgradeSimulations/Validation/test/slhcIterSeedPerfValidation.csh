...
echo "NewFile = $Datafiles/$NewRelease/$NewSelection/$sample/$NewFile.root"
    cat macro/IterSeedValHistoPublisher.C | sed \
      ...
      -e s@IterSeedValHistoPublisher@$sample@g \
      -e s@MINEFF@0.5@g \
      -e s@MAXEFF@1.025@g \
      -e s@MAXFAKE@1.0@g \
    > ! $sample.C
    ...
    cp seed*.pdf $NewRepository/$NewRelease/$NewSelection/$sample
