...
DTL1slhcProd = cms.EDProducer(
    ...
    #
    min_bending = cms.untracked.double(0.001),
    max_bending = cms.untracked.double(0.25),
    #
    labels = cms.untracked.vstring( "5-3-0", "3-2-0", "3-1-0", 
                                    "5-3-V", "5-0-V", "3-0-V",
                                    "M-2-0", "M-3-0", "M-5-0", "M-0-V",
                                    "mu-2-0", "mu-3-0", "mu-5-0", "mu-0-V",
                                    "Zo-2-0", "Zo-3-0", "Zo-5-0", "Zo-0-V"),
    #    
