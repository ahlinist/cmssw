...
process.source = cms.Source(
  ...
  fileNames = cms.untracked.vstring(
   'file:~/scratch0/CMSSW_3_3_6/src/SLHCUpgradeSimulations/L1Trigger/test/muonPair_Longbarrel_2dClust_PixelrayMatch_NoPU_L1TrkTrig_LowPt.root',
  )
)
#
###################################
...
process.PATtemplate = cms.EDAnalyzer("NicolaL1PrimComp",
...
################
# 
process.TFileService = cms.Service("TFileService", fileName = cms.string('muonPair_Tracklets_Longbarrel_2dClust_PixelrayMatch_NoPU_L1TrkTrig_LowPt.root' ))
#
