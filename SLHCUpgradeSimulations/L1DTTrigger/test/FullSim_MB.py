...
print 'Generating '+str(nevents)+' Minimum Bias events.'
...
"""
################################################################################
# MinBias settings for Pythia
# from slightly modified Configuration.Generator.MinBias_cfi

process.source = cms.Source("EmptySource")

process.generator = cms.EDFilter("Pythia6GeneratorFilter",
    firstRun = cms.untracked.uint32(theRun),
...
#   fileName = cms.untracked.string('file:./' + out_filename),
    ...
    fileName = cms.untracked.string('file:'+ output_dir + 'FullSim_MB_1.root'),
...
process.p2 = cms.Path(process.randomEngineStateProducer)
...
process.schedule = cms.Schedule(process.p0,process.p1,process.p2,process.outpath)
