...
patternFileName = cms.untracked.string(
     outputDir + 'PT' + 'GeV_Pt_Muons_ascii' + '.pat')
...
#-----------------------------------------------
process.DTL1slhcProd.min_invRb = cms.untracked.double(0.)
...
process.DTL1slhcProd.debug_stubs           = cms.untracked.bool(False)
process.DTL1slhcProd.debug_bti             = cms.untracked.bool(False)
process.DTL1slhcProd.debug_dttrackmatch             = cms.untracked.bool(False)
process.DTL1slhcProd.debug_tsphi             = cms.untracked.bool(False)
process.DTL1slhcProd.debug_tstheta             = cms.untracked.bool(False)
process.DTL1slhcProd.debug_dttf             = cms.untracked.bool(False)
process.DTL1slhcProd.debug_dtmatch             = cms.untracked.bool(False)
