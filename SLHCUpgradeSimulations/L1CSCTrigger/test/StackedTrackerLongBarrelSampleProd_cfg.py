...
process.HitMatchingAlgorithm_TTHit_ = cms.ESPrefer("HitMatchingAlgorithm_" +
                                                  StubsFromTTHits[1] +
                                                  "_TTHit_")
process.load("SLHCUpgradeSimulations.L1TrackTrigger.LocalStub_cfi")
process.LocalStubsFromSimHits.rawHits =\
                            cms.VInputTag(cms.InputTag("g4SimHits","TrackerHits"))
process.load("SLHCUpgradeSimulations.L1TrackTrigger.GlobalStub_cfi")
process.load("SLHCUpgradeSimulations.L1TrackTrigger.Tracklet_cfi")

process.load("SLHCUpgradeSimulations.L1TrackTrigger.TrackTriggerHitsFromPixelDigis_cfi")
