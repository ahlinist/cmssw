...
void htmlOutput(int run){
  ...
  htmlff << "<br>"<<endl;
  htmlff << "<hr>"<<endl;
  htmlff << "<h2><strong>RUN " <<endl;
  htmlff << run <<endl; 
  htmlff << "&nbsp;&nbsp;&nbsp;</strong></h2>"<<endl;
  htmlff << "<hr>"<<endl;
  htmlff << "<tr align=\"left\">"<<endl;
  htmlff << "<td>&nbsp;&nbsp;&nbsp;<a name=\"HF Monitor\"><h1>HF Monitor</h1></td></tr>"<<endl;
  htmlff << "<tr align=\"left\">"<<endl;
  htmlff << "<h3> HF Energy > 0 </h3>"<<endl;
  htmlff << "<td><a href=\"Energy_Occ.gif\"><img src=\"Energy_Occ.gif\"></a></td>"<<endl;
  htmlff << "<h3> Occupancy for Long fibers with Energy > 1 GeV </h3>"<<endl;
  htmlff << "<td><a href=\"Occ_L.gif\"><img src=\"Occ_L.gif\"></a></td>"<<endl;
  htmlff << "<h3> Occupancy for Short fibers with Energy > 1 GeV </h3>"<<endl;
  htmlff << "<td><a href=\"Occ_S.gif\"><img src=\"Occ_S.gif\"></a></td>"<<endl;
  htmlff << "<h3> SumTotalX[E*cos(2pi*phi/72)]</h3>"<<endl;
  htmlff << "<h3> SumTotalY[E*sin(2pi*phi/72)]</h3>"<<endl;
  htmlff << "<h3> SumTotalX/HFtotalE vs SumTotalY/HFtotalE </h3>"<<endl;
  htmlff << "<td><a href=\"HFCenterOfEnergy.gif\"><img src=\"HFCenterOfEnergy.gif\"></a></td>"<<endl;
  htmlff << "<h3> Etsum_eta_L: eta vs et</h3>"<<endl;
  htmlff << "<h3> Etsum_phi_L: phi vs et</h3>"<<endl;
  htmlff << "<h3> Etsum_map_L: eta vs phi vs et </h3>"<<endl;
  htmlff << "<h3> Etsum_rphi_L: r vs phi vs et </h3>"<<endl;
  htmlff << "<td><a href=\"Etsum_L.gif\"><img src=\"Etsum_L.gif\"></a></td>"<<endl;
  htmlff << "<h3> Etsum_eta_S: eta vs et</h3>"<<endl;
  htmlff << "<h3> Etsum_phi_S: phi vs et</h3>"<<endl;
  htmlff << "<h3> Etsum_map_S: eta vs phi vs et </h3>"<<endl;
  htmlff << "<h3> Etsum_rphi_S: r vs phi vs et </h3>"<<endl;
  htmlff << "<td><a href=\"Etsum_S.gif\"><img src=\"Etsum_S.gif\"></a></td>"<<endl;
  htmlff << "<h3> (L-S)/(L+S) </h3>"<<endl;
