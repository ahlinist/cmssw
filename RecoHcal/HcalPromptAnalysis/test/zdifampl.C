...
//
   ...
   c1 = new TCanvas("c1","Hcal4test",200,10,700,900);
	...
	Ceff->Sumw2();
      ...
      Ceff->SetXTitle("#eta");
      Ceff->SetYTitle("#phi");
      Ceff->SetZTitle("<E>,GeV for 1st Run - HB Depth1");
	...
	Czeff->Sumw2();
      ...
      Czeff->SetXTitle("#eta");
      Czeff->SetYTitle("#phi");
      Czeff->SetZTitle("<E>,GeV for 2nd Run - HB Depth1");
	...
	Ceff->Sumw2();
      ...
      Ceff->SetXTitle("#eta");
      Ceff->SetYTitle("#phi");
      Ceff->SetZTitle("<E>,GeV for 1st Run - HB Depth2");
      Ceff->SetMarkerColor(2);
      Ceff->SetLineColor(2);
      Ceff->Draw("COLZ");
	...
	Czeff->Sumw2();
      ...
      Czeff->SetXTitle("#eta");
      Czeff->SetYTitle("#phi");
      Czeff->SetZTitle("<E>,GeV for 2nd Run - HB Depth2");
      Czeff->SetMarkerColor(2);
      Czeff->SetLineColor(2);
      Czeff->Draw("COLZ");
	...
	if(Ceff->GetBinContent(i,j) !=0 && Czeff->GetBinContent(i,j) !=0 ) {
	  double ccc1 =  Ceff->GetBinContent(i,j)   -   Czeff->GetBinContent(i,j)  ;
	  ccc1 = 100.*ccc1/Ceff->GetBinContent(i,j);
	  if(fabs(ccc1) > 0.5 )  Diffe_Depth2_HB->SetBinContent(i,j,fabs(ccc1));
	}
      }
    }
    gPad->SetGridy();
    ...
    Diffe_Depth2_HB->Draw("COLZ");
      ...
      c1->cd(4);
      TH1F* diffAmpl_Depth2_HB = new TH1F("diffAmpl_Depth2_HB","", 100, -7., 7.);
      int nx = Ceff->GetXaxis()->GetNbins();
      int ny = Ceff->GetYaxis()->GetNbins();
      for (int i=1;i<=nx;i++) {
	for (int j=1;j<=ny;j++) {
	...
	Ceff->Sumw2();
      ...
      Ceff->SetXTitle("#eta");
      Ceff->SetYTitle("#phi");
      Ceff->SetZTitle("<E>,GeV for 1st Run - HE Depth1");
      Ceff->SetMarkerColor(2);
      Ceff->SetLineColor(2);
      Ceff->Draw("COLZ");
	...
	Czeff->Sumw2();
      ...
      Czeff->SetXTitle("#eta");
      Czeff->SetYTitle("#phi");
      Czeff->SetZTitle("<E>,GeV for 2nd Run - HE Depth1");
      Czeff->SetMarkerColor(2);
      Czeff->SetLineColor(2);
      Czeff->Draw("COLZ");
	...
	Ceff->Sumw2();
      ...
      Ceff->SetXTitle("#eta");
      Ceff->SetYTitle("#phi");
      Ceff->SetZTitle("<E>,GeV for 1st Run - HE Depth2");
      Ceff->SetMarkerColor(2);
      Ceff->SetLineColor(2);
      Ceff->Draw("COLZ");
	...
	Czeff->Sumw2();
      ...
      Czeff->SetXTitle("#eta");
      Czeff->SetYTitle("#phi");
      Czeff->SetZTitle("<E>,GeV for 2nd Run - HE Depth2");
      Czeff->SetMarkerColor(2);
      Czeff->SetLineColor(2);
      Czeff->Draw("COLZ");
	...
	if(Ceff->GetBinContent(i,j) !=0 && Czeff->GetBinContent(i,j) !=0 ) {
	  double ccc1 =  Ceff->GetBinContent(i,j)   -   Czeff->GetBinContent(i,j)  ;
	  ccc1 = 100.*ccc1/Ceff->GetBinContent(i,j);
	  if(fabs(ccc1) > 0.5 )  Diffe_Depth2_HE->SetBinContent(i,j,fabs(ccc1));
	}
      }
    }
    gPad->SetGridy();
    ...
    Diffe_Depth2_HE->Draw("COLZ");
      ...
      c1->cd(4);
      TH1F* diffAmpl_Depth2_HE = new TH1F("diffAmpl_Depth2_HE","", 100, -7., 7.);
      int nx = Ceff->GetXaxis()->GetNbins();
      int ny = Ceff->GetYaxis()->GetNbins();
      for (int i=1;i<=nx;i++) {
	for (int j=1;j<=ny;j++) {
	...
	Ceff->Sumw2();
      ...
      Ceff->SetXTitle("#eta");
      Ceff->SetYTitle("#phi");
      Ceff->SetZTitle("<E>,GeV for 1st Run - HE Depth3");
      Ceff->SetMarkerColor(2);
      Ceff->SetLineColor(2);
      Ceff->Draw("COLZ");
	...
	Czeff->Sumw2();
      ...
      Czeff->SetXTitle("#eta");
      Czeff->SetYTitle("#phi");
      Czeff->SetZTitle("<E>,GeV for 2nd Run - HE Depth3");
      Czeff->SetMarkerColor(2);
      Czeff->SetLineColor(2);
      Czeff->Draw("COLZ");
	...
	if(Ceff->GetBinContent(i,j) !=0 && Czeff->GetBinContent(i,j) !=0 ) {
	  double ccc1 =  Ceff->GetBinContent(i,j)   -   Czeff->GetBinContent(i,j)  ;
	  ccc1 = 100.*ccc1/Ceff->GetBinContent(i,j);
	  if(fabs(ccc1) > 0.5 )  Diffe_Depth3_HE->SetBinContent(i,j,fabs(ccc1));
	}
      }
    }
    gPad->SetGridy();
    ...
    Diffe_Depth3_HE->Draw("COLZ");
      ...
      c1->cd(4);
      TH1F* diffAmpl_Depth3_HE = new TH1F("diffAmpl_Depth3_HE","", 100, -7., 7.);
      int nx = Ceff->GetXaxis()->GetNbins();
      int ny = Ceff->GetYaxis()->GetNbins();
      for (int i=1;i<=nx;i++) {
	for (int j=1;j<=ny;j++) {
