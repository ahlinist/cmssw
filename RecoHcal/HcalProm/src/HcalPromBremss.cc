...
/**\class HcalProm HcalPromBremss.cc RecoHcal/HcalProm/src/HcalPromBremss.cc
...
void HcalPromBremss::analyze(const edm::Event & iEvent, const edm::EventSetup & iSetup) {
...
void HcalPromBremss::beginJob(const edm::EventSetup & iSetup) {
...
TH1F *HcalPromBremss::book1DHistogram(TFileDirectory & fDir, const std::string & fName, const std::string & fTitle,
...
TH2F *HcalPromBremss::book2DHistogram(TFileDirectory & fDir, const std::string & fName, const std::string & fTitle,
...
TProfile *HcalPromBremss::bookProfileHistogram(TFileDirectory & fDir, const std::string & fName, const std::string & fTitle,
...
void HcalPromBremss::bookHistograms() {
...
void HcalPromBremss::htmlOutput(void) {
...
void HcalPromBremss::JetMetHTMLOutput(string startTime, string htmlDir, string htmlName) {
...
void HcalPromBremss::RecHitHTMLOutput(string startTime, string htmlDir, string htmlName) {
...
void HcalPromBremss::DigiHTMLOutput(string startTime, string htmlDir, string htmlName) {
...
void HcalPromBremss::HPDNoiseHTMLOutput(string startTime, string htmlDir, string htmlName) {
...
void HcalPromBremss::MuonHTMLOutput(string startTime, string htmlDir, string htmlName) {
...
void HcalPromBremss::CaloTowerHTMLOutput(string startTime, string htmlDir, string htmlName) {
...
void HcalPromBremss::histoHTML(TH1F * hist, const char *xlab, const char *ylab, int width, ofstream & htmlFile,
			 string htmlDir) {
...
void HcalPromBremss::histoHTML2(TH2F * hist, const char *xlab, const char *ylab, int width, ofstream & htmlFile,
...
string HcalPromBremss::getIMG(TH1F * hist, int size, string htmlDir, const char *xlab, const char *ylab) {
...
string HcalPromBremss::getIMG2(TH2F * hist, int size, string htmlDir, const char *xlab, const char *ylab, bool color) {
...
void HcalPromBremss::cleanString(string & title) {
...
void HcalPromBremss::parseString(string & title) {
...
float HcalPromBremss::getEnergyEtaPhiDepth(int ieta, int iphi, int depth, const HFRecHitCollection * HFRecHits) {
  float hfenergy = -9999.;
