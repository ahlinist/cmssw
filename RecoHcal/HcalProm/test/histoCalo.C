...
*/
// for one root file
      TFile *hfile = new TFile("Calo.root", "READ");     //open file
...
/////////////////////////////////////////////////
   ...
   //gPad -> SetLogy();
   hNumHB2->Draw();
       //TAxis *axisy = hNumHB2->GetYaxis();
       //TAxis *axis = hNumHB2->GetXaxis();
...
// wait
  c8.WaitPrimitive();
////////////////////////////////////////////////
   TCanvas *c81 = new TCanvas("c81","Number Eta Towers of Muon passes though DT in 2 places, NTowerEta<5");
   c81->Divide(1,2);
   c81->cd(1);
   hIdEtaTopVsE -> Draw();
   c81->cd(2);
   hIdEtaBotVsE -> Draw();
   c81->Print("picGHB81.gif");
// wait
  c81.WaitPrimitive();
////////////////////////////////////////////////
// make histo projection for hIdPhiPlusVsE
   ...
   for(Int_t ik=2; ik<=nbiny-1; ik++){ // make cicle by IdPhiTowers
      ...
      hEmuonGaussVsIdPhiTowersPlus->SetBinContent(ik-1,Emean); 
