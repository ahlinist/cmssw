...
// creat root-file with histo
   ...
   TFile *theFile    =new TFile("Calo.root", "RECREATE");
   theFile->cd();
...
// 2nd (Partner) Muon is good: in one Phi Plane in HB
   ...
   TH1F *hPhiDeltaTowerHB2DT = new TH1F("hPhiDeltaTowerHB2DT","diviation from PhiTower center, 2nd muon in HB several phi plane ", 50, 0., 1.);
   TH1F *hNumHB2 = new TH1F("hNumHB2","number phi Towers crossing by muon in 2nd plane", 15, -0.5, 14.5);
   //Energy
   TH1F *hEmuonHB2DTTopPlus = new TH1F("hEmuonHB2DTTopPlus","Emoun, Top+, 2nd muon in HB several phi plane ", 60, -2., 10.);
   TH1F *hEmuonHB2DTTopMinus = new TH1F("hEmuonHB2DTTopMinus","Emoun, Top-, 2nd muon in HB several phi plane", 60, -2., 10.);
   TH1F *hEmuonHB2DTBotPlus = new TH1F("hEmuonHB2DTBotPlus","Emoun, Bottom+, 2nd muon in HB several phi plane", 60, -2., 10.);
   TH1F *hEmuonHB2DTBotMinus = new TH1F("hEmuonHB2DTBotMinus","Emoun, Bottom-, 2nd muon in HB several phi plane", 60, -2., 10.);
   //Time
   TH1F *hTimeMuonHB2DTTopPlus = new TH1F("hTimeMuonHB2DTTopPlus","TimeMoun, Top+, 2nd muon in HB several phi plane ", 60, -150., 150.);
   TH1F *hTimeMuonHB2DTTopMinus = new TH1F("hTimeMuonHB2DTTopMinus","TimeMoun, Top-, 2nd muon in HB several phi plane ", 60, -150., 150.);
   TH1F *hTimeMuonHB2DTBotPlus = new TH1F("hTimeMuonHB2DTBotPlus","TimeMoun, Bottom+, 2nd muon in HB several phi plane ", 60, -150., 150.);
   TH1F *hTimeMuonHB2DTBotMinus = new TH1F("hTimeMuonHB2DTBotMinus","TimeMoun, Bottom-, 2nd muon in HB several phi plane ", 60, -150., 150.);
   //Number Towers in Eta Plane passing by good muon
   TH1F *hNumTowerMuonHB2DTTopPlus = 
        new TH1F("hNumTowerMuonHB2DTTopPlus","Number Towers of Moun, Top+, 2nd muon in HB several phi plane ", 11, -0.5, 10.5);
   TH1F *hNumTowerMuonHB2DTTopMinus = 
        new TH1F("hNumTowerMuonHB2DTTopMinus","Number Towers of Moun, Top+, 2nd muon in HB several phi plane ", 11, -0.5, 10.5);
   TH1F *hNumTowerMuonHB2DTBotPlus = 
        new TH1F("hNumTowerMuonHB2DTBotPlus","Number Towers of Moun, Bottom+, 2nd muon in HB several phi plane ", 11, -0.5, 10.5);
   TH1F *hNumTowerMuonHB2DTBotMinus = 
        new TH1F("hNumTowerMuonHB2DTBotMinus","Number Towers of Moun, Bottom+, 2nd muon in HB several phi plane ", 11, -0.5, 10.5);
   //idPhiTower for eta+ and eta-
   TH1F *hIdPhiTowerHB2DTMinus = new TH1F("hIdPhiTowerHB2DTMinus", "IdPhiTower for eta-, 2nd muon in HB several phi plane ", 74, -0.5, 73.5);
   TH1F *hIdPhiTowerHB2DTPlus = new TH1F("hIdPhiTowerHB2DTPlus", "IdPhiTower for eta+, 2nd muon in HB several phi plane ", 74, -0.5, 73.5);
   // Muon Track quality in DT
   TH1F *hNumHitsHB2DT = new TH1F("hNumHitsHB2DT", "Number Hits for analysing muon, 2nd muon in HB several phi plane ",61 , -0.5, 60.5);
   TH1F *hLengthMuonDTHB2DT = new TH1F("hLengthMuonDTHB2DT", "Length of analysing muon in DT, 2nd muon in HB several phi plane ",100 , 0, 600);
   // energy for time- and time+
   TH1F *hEmuonHB2DTTopPlusTimePlus = new TH1F("hEmuonHB2DTTopPlusTimePlus","Emoun, Top+, Time+, 2nd muon in HB several phi plane ", 60, -2., 10.);
   TH1F *hEmuonHB2DTTopMinusTimePlus = new TH1F("hEmuonHB2DTTopMinusTimePlus","Emoun, Top-, Time+, 2nd muon in HB several phi plane ", 60, -2., 10.);
   TH1F *hEmuonHB2DTBotPlusTimePlus = new TH1F("hEmuonHB2DTBotPlusTimePlus","Emoun, Bot+, Time+, 2nd muon in HB several phi plane ", 60, -2., 10.);
   TH1F *hEmuonHB2DTBotMinusTimePlus = new TH1F("hEmuonHB2DTBotMinusTimePlus","Emoun, Bot-, Time+, 2nd muon in HB several phi plane ", 60, -2., 10.);
   TH1F *hEmuonHB2DTTopPlusTimeMinus = new TH1F("hEmuonHB2DTTopPlusTimeMinus","Emoun, Top+, Time-, 2nd muon in HB several phi plane ", 60, -2., 10.);
   TH1F *hEmuonHB2DTTopMinusTimeMinus = new TH1F("hEmuonHB2DTTopMinusTimeMinus","Emoun, Top-, Time-, 2nd muon in HB several phi plane ", 60, -2., 10.);
   TH1F *hEmuonHB2DTBotPlusTimeMinus = new TH1F("hEmuonHB2DTBotPlusTimeMinus","Emoun, Bot+, Time-, 2nd muon in HB several phi plane ", 60, -2., 10.);
   TH1F *hEmuonHB2DTBotMinusTimeMinus = new TH1F("hEmuonHB2DTBotMinusTimeMinus","Emoun, Bot-, Time-, 2nd muon in HB several phi plane ", 60, -2., 10.);
   // in different time:
   TH1F *hEmuonHB2DTBotPlusTimePlus1 = new TH1F("hEmuonHB2DTBotPlusTimePlus1","Emoun, Bot+, Time+1, 2nd muon in HB several phi plane ", 60, -2., 10.);
   TH1F *hEmuonHB2DTBotPlusTimePlus2 = new TH1F("hEmuonHB2DTBotPlusTimePlus2","Emoun, Bot+, Time+2, 2nd muon in HB several phi plane ", 60, -2., 10.);
   TH1F *hEmuonHB2DTBotPlusTimePlus3 = new TH1F("hEmuonHB2DTBotPlusTimePlus3","Emoun, Bot+, Time+3, 2nd muon in HB several phi plane ", 60, -2., 10.);
   TH1F *hEmuonHB2DTBotPlusTimePlus4 = new TH1F("hEmuonHB2DTBotPlusTimePlus4","Emoun, Bot+, Time+4, 2nd muon in HB several phi plane ", 60, -2., 10.);
   TH1F *hEmuonHB2DTBotPlusTimeMinus1 = new TH1F("hEmuonHB2DTBotPlusTimeMinus1","Emoun, Bot+, Time-1, 2nd muon in HB several phi plane ", 60, -2., 10.);
   TH1F *hEmuonHB2DTBotPlusTimeMinus2 = new TH1F("hEmuonHB2DTBotPlusTimeMinus2","Emoun, Bot+, Time-2, 2nd muon in HB several phi plane ", 60, -2., 10.);
   TH1F *hEmuonHB2DTBotPlusTimeMinus3 = new TH1F("hEmuonHB2DTBotPlusTimeMinus3","Emoun, Bot+, Time-3, 2nd muon in HB several phi plane ", 60, -2., 10.);
   TH1F *hEmuonHB2DTBotPlusTimeMinus4 = new TH1F("hEmuonHB2DTBotPlusTimeMinus4","Emoun, Bot+, Time-4, 2nd muon in HB several phi plane ", 60, -2., 10.);
   ...
   // contral plots
   TH1F *hImpXYHB2DT = new TH1F("hImpXYHB2DT","ImpXY of analyzing muon, 2nd muon in HB several phi plane ", 50, 0., 50.);
   TH1F *hZImpXYHB2DT = new TH1F("hZImpXYHB2DT","ZImpXY of analyzing muon, 2nd muon in HB several phi plane ", 100, -500., 500.);
   ...
   //energy of second signal in HB
   TH1F *hEmuonHB2 = new TH1F("hEmuonHB2","Emoun in 2nd HB", 60, -2., 6.);
   TH1F *hEmuonHBcut2 = new TH1F("hEmuonHBcut2","Emoun in 2nd HB, cut: ETower > 500 MeV", 60, 0., 3.);
   TH1F *hEmuonHBcutwide2 = new TH1F("hEmuonHBcutwide2","Emoun in 2nd HB +- 1 Tower, cut: ETower > 500 MeV", 60, 0., 3.);
   ...
   // energy for Signal and BG
   TH1F *hEmuonSignal = new TH1F("hEmuonSignal","Emoun HB Signal", 60, -2., 6.);
   //TH1F *hEmuonBG = new TH1F("hEmuonBG","Emoun HB Back ground", 60, -2., 6.);
            ...
            for(Int_t ik = 0; ik<NumMuonHBphiPlane;ik++){
               ...
               if(NumMuonHBnoPhiPlane>0&&IsecondMuonDT==0){
                   for(Int_t jk = 0; jk<NumMuonHBnoPhiPlane;jk++){
                      ...
                      if(R12<600)continue;
                      float num2;
                      num2 = fabs(IdTowerMuonNoPlanePhiIn[jk]-IdTowerMuonNoPlanePhiOut[jk])+1;   
                      if(num2>2)continue; 
                      r1 = pow((XinPosMuonDT[ik]-XoutPosMuonDT[ik]),2)+pow((YinPosMuonDT[ik]-YoutPosMuonDT[ik]),2);
                      r1 = sqrt(r1+pow((ZinPosMuonDT[ik]-ZoutPosMuonDT[ik]),2));
               ...
               // calculatde energy in the 2nd part of HB
               // if IsecondMuonDT exist with good or bad muon than do not make double counting
               if(IsecondMuonDT!=0) continue;
               //calculate quality of Phi crossing:
               float phiR;
               phiR = fabs((PHIinMuonHB[ik]+PHIoutMuonHB[ik])/2-PHIinTowerHB[ik])/(DeltaPhiTower/2);
               int NumHB2;
               NumHB2 = abs(IdTowerPhiMuonIn2[ik]-IdTowerPhiMuonOut2[ik])+1; 
               hNumHB2->Fill(float(NumHB2));
               if(NumHB2>2)continue;
               if(phiR>0.8)continue;
               //if(ImpXYmuonHB[ik]>10)continue;
               float em;
               //fill energy in the 2nd HB crossing
               em = EmuonHBcut2[ik]; 
               hEmuonHBcut2->Fill(em);
               em = EmuonHB2[ik];
               hEmuonHB2->Fill(em);
               em = EmuonHBcutwide2[ik]; 
               hEmuonHBcutwide2->Fill(em);
               if(EmuonHB2[ik]<1.)continue; //make selection with EmuonHBcutwide2
               //if(EmuonHBcutwide2[ik]<1.2)continue; //make selection with EmuonHBcutwide2
               //if(EmuonHBcut2[ik]<1.5)continue; //make selection with EmuonHBcut2
               IsecondMuonDT=1;
                 ...
                 // cout << " *** check *** " << std::endl;
                  if(IdTowerEtaMuonIn[ik]>0&&IdTowerEtaMuonOut[ik]>0){
                     ...
                     if(fabs(tmuon-meanB)<=rmsB){
                        ...
                        hEmuonSignal -> Fill(eHB);
                        hNumTowerMuonHB2DTTopPlus->Fill(float(numTower));
                     }
                  ...
                  if(IdTowerEtaMuonIn[ik]<0&&IdTowerEtaMuonOut[ik]<0){
                     ...
                     if(fabs(tmuon-meanB)<=rmsB){
                        ...
                        hEmuonSignal -> Fill(eHB);
                        hNumTowerMuonHB2DTTopMinus->Fill(float(numTower)); 
                     } 
               ...
               if(IdTowerPhiMuonIn[ik]>36&&IdTowerPhiMuonIn[ik]<73&&numTower<=maxTowerEta&&numTower>=minTowerEta){
                  if(IdTowerEtaMuonIn[ik]>0&&IdTowerEtaMuonOut[ik]>0){
                     ...
                     if(fabs(tmuon-meanB)<=rmsB){
                        ...
                        hEmuonSignal -> Fill(eHB);
                        hNumTowerMuonHB2DTBotPlus->Fill(float(numTower)); 
                     } 
                  ...
                  if(IdTowerEtaMuonIn[ik]<0&&IdTowerEtaMuonOut[ik]<0){
                     ...
                     if(fabs(tmuon-meanB)<=rmsB){
                        ...
                        hEmuonSignal -> Fill(eHB);
                        hNumTowerMuonHB2DTBotMinus->Fill(float(numTower)); 
                     } 
...
// this cut is also means that ower muon belong only to one from 4 HB Parts
               if(fabs(tmuon-meanB)<=rmsB && meanB!=0){
                  ...
                  if(IdTowerEtaMuonIn[ik]<0&&IdTowerEtaMuonOut[ik]<0){
                        hIdPhiTowerHB2DTMinus->Fill(float(idTphi));
                        hIdPhiMinusVsE->Fill(eHB,float(IdTowerPhiMuonIn[ik]));
                  }  
                  if(IdTowerEtaMuonIn[ik]>0&&IdTowerEtaMuonOut[ik]>0){
                        hIdPhiTowerHB2DTPlus->Fill(float(idTphi));
                  ...
                  hNumHitsHB2DT->Fill(float(NumHitsMuonDTall[ik]));
...
////////////////////////////////////////////////
   ...
   hEmuonHBcut2->Draw();
   c8->cd(3);
   hEmuonHBcutwide2->Draw();
   c8->Print("picGHB8.gif");
// wait
  c8.WaitPrimitive();
*/
}
