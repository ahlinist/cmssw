...
#include "TFile.h"
   ...
   TFile *hfile = new TFile("/data/efe/mc_tk_analysis.root", "READ");     //open file 
...
gPad->SetGridx();
gPad->SetGridy();
   c1->Print("/afs/cern.ch/cms/CAF/CMSCOMM/COMM_HCAL/data/prompt_detailed_summary/MC/pic1.gif");
// wait
//   c1->WaitPrimitive();
/////////////////////////////////////////////////
...
gPad->SetGridx();
gPad->SetGridy();
   hEmuonHB2DTTopMinus.Fit("gaus","E","",1.2,2.8);
   c2->cd(2);
gPad->SetGridx();
gPad->SetGridy();
   hEmuonHB2DTTopPlus.Fit("gaus","E","",1.2,2.8);
   c2->cd(3);
gPad->SetGridx();
gPad->SetGridy();
   hEmuonHB2DTBotMinus.Fit("gaus","E","",1.2,2.8);
   c2->cd(4);
gPad->SetGridx();
gPad->SetGridy();
   hEmuonHB2DTBotPlus.Fit("gaus","E","",1.2,2.8);
   c2->Print("/afs/cern.ch/cms/CAF/CMSCOMM/COMM_HCAL/data/prompt_detailed_summary/MC/pic2.gif");
// wait
//   c2.WaitPrimitive();
...
gPad->SetGridx();
gPad->SetGridy();
   c21->Print("/afs/cern.ch/cms/CAF/CMSCOMM/COMM_HCAL/data/prompt_detailed_summary/MC/pic21.gif");
//  c21.WaitPrimitive();
/////////////////////////////////////////////////
...
gPad->SetGridx();
gPad->SetGridy();
   c22->Print("/afs/cern.ch/cms/CAF/CMSCOMM/COMM_HCAL/data/prompt_detailed_summary/MC/pic22.gif");
// wait
//  c22.WaitPrimitive();
/////////////////////////////////////////////////
...
//   hIdPhiTowerHB2DTsevPlus->Draw();
   c4->Print("/afs/cern.ch/cms/CAF/CMSCOMM/COMM_HCAL/data/prompt_detailed_summary/MC/pic4.gif");
// wait
//  c4.WaitPrimitive();
...
gPad->SetGridx();
gPad->SetGridy();
   c51->Print("/afs/cern.ch/cms/CAF/CMSCOMM/COMM_HCAL/data/prompt_detailed_summary/MC/pic51.gif");
// wait
//  c51.WaitPrimitive();
/////////////////////////////////////////////////
...
gPad->SetGridx();
gPad->SetGridy();
   hEmuonHB2DTTopMinusTimeMinus.Fit("gaus","E","",1.2,2.8);
   c61->cd(2);
gPad->SetGridx();
gPad->SetGridy();
   hEmuonHB2DTTopPlusTimeMinus.Fit("gaus","E","",1.2,2.8);
   c61->cd(3);
gPad->SetGridx();
gPad->SetGridy();
   hEmuonHB2DTBotMinusTimeMinus.Fit("gaus","E","",1.2,2.8);
   c61->cd(4);
gPad->SetGridx();
gPad->SetGridy();
   hEmuonHB2DTBotPlusTimeMinus.Fit("gaus","E","",1.2,2.8);
   c61->Print("/afs/cern.ch/cms/CAF/CMSCOMM/COMM_HCAL/data/prompt_detailed_summary/MC/pic61.gif");
// wait
//  c61.WaitPrimitive();
/////////////////////////////////////////////////
...
gPad->SetGridx();
gPad->SetGridy();
   hEmuonHB2DTTopMinusTimePlus->Fit("gaus","E","",1.2,2.8);
   c62->cd(2);
gPad->SetGridx();
gPad->SetGridy();
   hEmuonHB2DTTopPlusTimePlus->Fit("gaus","E","",1.2,2.8);
   c62->cd(3);
gPad->SetGridx();
gPad->SetGridy();
   hEmuonHB2DTBotMinusTimePlus->Fit("gaus","E","",1.2,2.8);
   c62->cd(4);
gPad->SetGridx();
gPad->SetGridy();
   hEmuonHB2DTBotPlusTimePlus->Fit("gaus","E","",1.2,2.8);
   c62->Print("/afs/cern.ch/cms/CAF/CMSCOMM/COMM_HCAL/data/prompt_detailed_summary/MC/pic62.gif");
// wait
//  c62.WaitPrimitive();
/////////////////////////////////////////////////
...
gPad->SetGridx();
gPad->SetGridy();
   hEmuonHB2DTBotPlusTimeMinus1->Fit("gaus","E","",1.2,2.8);
   c63->cd(2);
gPad->SetGridx();
gPad->SetGridy();
   hEmuonHB2DTBotPlusTimeMinus2->Fit("gaus","E","",1.2,2.8);
   c63->cd(3);
gPad->SetGridx();
gPad->SetGridy();
   hEmuonHB2DTBotPlusTimeMinus3->Fit("gaus","E","",1.2,2.8);
   c63->cd(4);
gPad->SetGridx();
gPad->SetGridy();
   hEmuonHB2DTBotPlusTimeMinus4->Fit("gaus","E","",1.2,2.8);
   c63->Print("/afs/cern.ch/cms/CAF/CMSCOMM/COMM_HCAL/data/prompt_detailed_summary/MC/pic63.gif");
// wait
//  c63.WaitPrimitive();
/////////////////////////////////////////////////
...
gPad->SetGridx();
gPad->SetGridy();
   hEmuonHB2DTBotPlusTimePlus1->Fit("gaus","E","",1.2,2.8);
   c64->cd(2);
gPad->SetGridx();
gPad->SetGridy();
   hEmuonHB2DTBotPlusTimePlus2->Fit("gaus","E","",1.2,2.8);
   c64->cd(3);
gPad->SetGridx();
gPad->SetGridy();
   hEmuonHB2DTBotPlusTimePlus3->Fit("gaus","E","",1.2,2.8);
   c64->cd(4);
gPad->SetGridx();
gPad->SetGridy();
   hEmuonHB2DTBotPlusTimePlus4->Fit("gaus","E","",1.2,2.8);
   c64->Print("/afs/cern.ch/cms/CAF/CMSCOMM/COMM_HCAL/data/prompt_detailed_summary/MC/pic64.gif");
// wait
//  c64.WaitPrimitive();
/////////////////////////////////////////////////
...
gPad->SetGridx();
gPad->SetGridy();
   hEmuonPhiDetaTower1->Fit("gaus","E","",1.2,2.8);
   c65->cd(2);
gPad->SetGridx();
gPad->SetGridy();
   hEmuonPhiDetaTower2->Fit("gaus","E","",1.2,2.8);
   c65->cd(3);
gPad->SetGridx();
gPad->SetGridy();
   hEmuonPhiDetaTower3->Fit("gaus","E","",1.2,2.8);
   c65->cd(4);
gPad->SetGridx();
gPad->SetGridy();
   hEmuonPhiDetaTower4->Fit("gaus","E","",1.2,2.8);
   c65->cd(5);
gPad->SetGridx();
gPad->SetGridy();
   hEmuonPhiDetaTower5->Fit("gaus","E","",1.2,2.8);
   c65->cd(6);
gPad->SetGridx();
gPad->SetGridy();
   hEmuonPhiDetaTower6->Fit("gaus","E","",1.2,2.8);
   c65->Print("/afs/cern.ch/cms/CAF/CMSCOMM/COMM_HCAL/data/prompt_detailed_summary/MC/pic65.gif");
// wait
//  c65.WaitPrimitive();
...
gPad->SetGridx();
gPad->SetGridy();
   c7->Print("/afs/cern.ch/cms/CAF/CMSCOMM/COMM_HCAL/data/prompt_detailed_summary/MC/pic7.gif");
// wait
//  c7.WaitPrimitive();
////////////////////////////////////////////////
...
gPad->SetGridx();
gPad->SetGridy();
   c8->Print("/afs/cern.ch/cms/CAF/CMSCOMM/COMM_HCAL/data/prompt_detailed_summary/MC/pic8.gif");
// wait
//  c8.WaitPrimitive();
////////////////////////////////////////////////
...
gPad->SetGridx();
gPad->SetGridy();
   c81->Print("/afs/cern.ch/cms/CAF/CMSCOMM/COMM_HCAL/data/prompt_detailed_summary/MC/pic81.gif");
// wait
  //c81.WaitPrimitive();
...
// make histo projection for hIdPhiPlusVsE
   ...
   TH1F *hEmeanGaussTopPlus = new TH1F("hEmeanGaussTopPlus","Emean Gauss Top HB+, IdPhi: 11-27",40,1.5,5.); 
   TH1F *hEmeanGaussBotPlus = new TH1F("hEmeanGaussBotPlus","Emean Gauss Bottom HB+, IdPhi: 47-62",40,1.5,5.); 
   TH1F *hEmeanGaussTopMinus = new TH1F("hEmeanGaussTopMinus","Emean Gauss Top HB-, IdPhi: 11-27",40,1.5,5.); 
   TH1F *hEmeanGaussBotMinus = new TH1F("hEmeanGaussBotMinus","Emean Gauss Bottom HB-, IdPhi: 47-62",40,1.5,5.); 
   // HB+
...
gPad->SetGridx();
gPad->SetGridy();
   c9->Print("/afs/cern.ch/cms/CAF/CMSCOMM/COMM_HCAL/data/prompt_detailed_summary/MC/EmuonGaussMeanForHB.gif");
//      c9.WaitPrimitive();
/////////////////////////////////////
...
gPad->SetGridx();
gPad->SetGridy();
   c10->Print("/afs/cern.ch/cms/CAF/CMSCOMM/COMM_HCAL/data/prompt_detailed_summary/MC/EmuonGaussSigmaForDiffPhiTower.gif");
//      c10.WaitPrimitive();
/////////////////////////////////////
...
gPad->SetGridy();
   ...
   c11->Print("/afs/cern.ch/cms/CAF/CMSCOMM/COMM_HCAL/data/prompt_detailed_summary/MC/EmuonGaussSigmaForHB.gif");
//      c11.WaitPrimitive();
/////////////////////////////////////
...
gPad->SetGridx();
gPad->SetGridy();
   c12->Print("/afs/cern.ch/cms/CAF/CMSCOMM/COMM_HCAL/data/prompt_detailed_summary/MC/final.gif");
