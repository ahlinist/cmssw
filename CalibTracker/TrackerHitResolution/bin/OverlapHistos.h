...
//const bool allPlots = true;   //// changes from true!!!
const bool allPlots = false;
...
public:
  ...
  int cutflow_total, cutflow_predEDeltaX, cutflow_edge, cutflow_chi2, cutflow_momentum, cutflow_path, cutflow_hitEx, cutflow_acceptDet, cutflow_acceptLayer, cutflow_acceptStero;
...
public:
  OverlapHistos(int _nCut, TTree *tree=0);
   virtual ~OverlapHistos();
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop(int redEntries = -1, int nCut = -1);
...
OverlapHistos::OverlapHistos(int _nCut,TTree *tree)
{
