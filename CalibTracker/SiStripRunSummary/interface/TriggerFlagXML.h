...
*   to declare partner that is used for conversion: TriggerFlagTxt <-> 
*   TriggerFlagXML
*/
...
class TriggerFlagXML: public FlagXML {
  public:
    ...
    * 
    * @param poTRIGGER_FLAGTXT  Txt format flag to be used as source
    */
...
*/
BOOST_CLASS_VERSION( TriggerFlagXML, 0)
