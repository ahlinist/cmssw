...
#ifndef TID_FLAG_TXT_H
#define TID_FLAG_TXT_H
...
*   to declare partner that is used for conversion: TIDFlagTxt <-> TIDFlagXML
*/
class TIDFlagXML;
...
*/
class TIDFlagTxt: public FlagTxt {
  public:
    TIDFlagTxt() {}
    ...
    * 
    * @param poTID_FLAGXML  XML format flag to be used as source
    */
    TIDFlagTxt( const TIDFlagXML *poTID_FLAGXML);
...
*/
BOOST_CLASS_EXPORT_GUID( TIDFlagTxt, "TIDFlagTxt")
...
*/
BOOST_CLASS_VERSION( TIDFlagTxt, 0)

#endif // TID_FLAG_TXT_H
