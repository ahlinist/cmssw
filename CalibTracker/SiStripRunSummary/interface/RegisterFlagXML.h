...
* @brief
*   --[ WARNING ]---------------------------------------------------------------
*    Current file is used by SerializeTxt.cc to register all Txt Flags available
*    in Flags Tree. It is highly not recommended to include it from any other
*    header.
*   ----------------------------------------------------------------------------
*/
#ifndef FLAGS_TEST
...
#include "test/interface/Flag11XML.h"
#include "test/interface/Flag21XML.h"
#include "test/interface/Flag22XML.h"
#include "test/interface/Flag23XML.h"
