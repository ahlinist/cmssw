...
#ifndef TOB_FLAG_TXT_H
#define TOB_FLAG_TXT_H
...
*/
class TOBFlagTxt: public FlagTxt {
  public:
    TOBFlagTxt() {}
    ...
    * 
    * @param poTOB_FLAGXML  XML format flag to be used as source
    */
    TOBFlagTxt( const TOBFlagXML *poTOB_FLAGXML);
...
*/
BOOST_CLASS_EXPORT_GUID( TOBFlagTxt, "TOBFlagTxt")
...
*/
BOOST_CLASS_VERSION( TOBFlagTxt, 0)

#endif // TOB_FLAG_TXT_H
