...
*   to declare partner that is used for conversion: TECFlagTxt <-> TECFlagXML
*/
class TECFlagTxt;
...
class TECFlagXML: public FlagXML {
  public:
    ...
    * 
    * @param poTEC_FLAGTXT  Txt format flag to be used as source
    */
...
*/
BOOST_CLASS_VERSION( TECFlagXML, 0)
