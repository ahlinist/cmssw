...
//input files
const  int       nrFiles  	  		= 1;
const  TString   path     	  		= "../test/JetRejObsProducergenjet_mu.root";
...
const  double   JetCombObsMax[nrJetCombObs]	= { 4,   1.01,  5.5, 50, 50, 50, 50, 1, 0.4, 600, 400, 2.5, 1.1, 5, 50};
...
const  TString  JetCombOutfileName   		= "../data/JetRejCombLRAllObs_genjet.root";
const  TString  JetCombPSfile     		= "../data/JetRejCombLRAllObs_genjet.ps";
...
void doEventloop(){ 
  ...
  cout<<endl<<"       okEvents =   "<<okEvents << " tot evts = "<<totNrEv<<endl;
  cout<<endl<<"******************************************************************"<<endl;
}
