...
//input files
const  int       nrFiles  	  		= 1;
const  TString   path     	  		= "../test/JetRejObsProducerpartonjet_mu.root";
...
//const  double   JetCombObsMin[nrJetCombObs]	= {  0,  -1.01,  0,  0, -3, -3,  0, 0,   0, -10,   0, 0,   0, 0,  0};
//const  double   JetCombObsMax[nrJetCombObs]	= {5.2,   1.01,  250, 50, 50, 50, 50, 1, 0.4, 600, 400, 4, 1.1, 5, 50};
...
const  TString  JetCombOutfileName   		= "../data/JetRejCombLRAllObs_partonjet.root";
const  TString  JetCombPSfile     		= "../data/JetRejCombLRAllObs_partonjet.ps";
