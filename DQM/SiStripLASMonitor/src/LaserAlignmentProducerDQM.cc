#include "DQM/SiStripLASMonitor/interface/LaserAlignmentProducerDQM.h"
//
LaserAlignmentProducerDQM::LaserAlignmentProducerDQM( const edm::ParameterSet& aConfiguration ) {
...
//
LaserAlignmentProducerDQM::~LaserAlignmentProducerDQM() {
}
//
void LaserAlignmentProducerDQM::beginJob() {
...
///
///
void LaserAlignmentProducerDQM::FillFromRawDigis( const edm::DetSetVector<SiStripRawDigi>& aDetSetVector ) {
  ...
  do {
    ...
    if( detSetIter == aDetSetVector.end() ) {
      throw cms::Exception( "[LaserAlignmentProducerDQM::FillFromRawDigis]" ) << " ** ERROR: No raw DetSet found for det: " << detRawId << "." << std::endl;
    }
...
///
///
void LaserAlignmentProducerDQM::FillFromProcessedDigis( const edm::DetSetVector<SiStripDigi>& aDetSetVector ) {
...
/// LATER must make this code somehow common to both LaserAlignment and LaserAlignmentProducerDQM
///
void LaserAlignmentProducerDQM::FillDetectorId( void ) {
...
DEFINE_FWK_MODULE(LaserAlignmentProducerDQM);
