...
#   fileNames = cms.untracked.vstring('//store/data/Commissioning08/Cosmics/RECO/v1/000/066/722/FE445906-729D-DD11-8E47-000423D99EEE.root')
    fileNames = cms.untracked.vstring('file:/tmp/carrillo/My_HLT_Skim_70195.FEECAD77-49C6-DD11-812D-001D0967DB11.root')
)

process.museg = cms.EDFilter("RPCRecHitsMatchingSegment",
