...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('//store/data/Run2010B/MuMonitor/RECO/PromptReco-v2/000/149/442/0C5FDCC0-39E6-DF11-A4B2-000423D987E0.root')
)
...
##  rpcRecHits = cms.InputTag("rpcRecHits"),
    rpcRecHits = cms.InputTag("rpcRecHitAli","RPCRecHitAligned"),
    ...
    EffRootFileName = cms.untracked.string('MuMonitorFAST-149442.0C5FDCC0-39E6-DF11-A4B2-000423D987E0.root'),
    EffSaveRootFileEventsInterval = cms.untracked.int32(100)
)

process.load("RecoLocalMuon.RPCRecHit.rpcRecHitAli_cfi")

process.p = cms.Path(process.rpcPointProducer*process.rpcRecHitAli*process.museg)
