...
class L1TOMDSHelper {
  ...
  public:
    ...
    int                                     getFillNumber            (int runNumber, int ls ,int &error);
    float                                   getHFDeliveredLumi       (int runNumber, int &ls ,int &error);
    float                                   getHFRecordedLumi        (int runNumber, int &ls ,int &error);
