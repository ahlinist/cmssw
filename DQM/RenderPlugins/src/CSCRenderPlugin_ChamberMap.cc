 ...
 * =====================================================================================
 *
 *       Filename:  CSCRenderPlugin_ChamberMap.cc
 *
...
#include "CSCRenderPlugin.h"
    ...
    static float Xmin_local_derived_from_ChamberID(const int side, const int station, const int ring, const int chamber) {
      float x;
    ...
    // Transform chamber ID to local canvas coordinates
    static float Xmax_local_derived_from_ChamberID(int side, int station, int ring, int chamber) {
      float x;
    ...
    // Transform chamber ID to local canvas coordinates
    static float Ymin_local_derived_from_ChamberID(int side, int station, int ring, int chamber) {
      float y = 0;
      float offset = 0.0;
    ...
    // Transform chamber ID to local canvas coordinates
    static float Ymax_local_derived_from_ChamberID(int side, int station, int ring, int chamber) {
      float y = 0;
      float offset = 0.0;
    ...
    void CSCRenderPlugin::ChamberMap(TH2*& me){ 
