...
class PATElectronConversionFinderImp
{
   ...
   private:
      ...
      edm::InputTag tracks_, conversions_, photons_, dcsTag_;
      
      bool doPXBcut_, doMissingHitsCut_, useConversionColl_, useOSPairs_, usePogMethod_, isData_;
	  double cotThetaMax_, docaMax_, dRinMax_, nPairMax_, nPairMin_;
