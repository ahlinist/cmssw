...
selectedLayer1TausForWTauNuTaNCdiscr = copy.deepcopy(selectedLayer1TausTaNCdiscr)
selectedLayer1TausForWTauNuTrkIso = copy.deepcopy(selectedLayer1TausTrkIso)
selectedLayer1TausForWTauNuEcalIso = copy.deepcopy(selectedLayer1TausEcalIso)
...
selectedLayer1TausForWTauNuTaNCdiscrLooseIsolation = copy.deepcopy(selectedLayer1TausForWTauNuTaNCdiscr)
selectedLayer1TausForWTauNuTrkIsoLooseIsolation = copy.deepcopy(selectedLayer1TausForWTauNuTrkIso)
selectedLayer1TausForWTauNuEcalIsoLooseIsolation = copy.deepcopy(selectedLayer1TausForWTauNuEcalIso)
