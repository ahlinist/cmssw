...
selectedLayer1TausForMuTauAntiOverlapWithMuonsVeto = cms.PSet(
    pluginName = cms.string("selectedLayer1TausForMuTauAntiOverlapWithMuonsVeto"),
...
selectedLayer1TausForMuTauEta21.pluginName = cms.string("selectedLayer1TausForMuTauEta21")
...
selectedLayer1TausForMuTauPt20.pluginName = cms.string("selectedLayer1TausForMuTauPt20")
...
selectedLayer1TausForMuTauLeadTrk.pluginName = cms.string("selectedLayer1TausForMuTauLeadTrk")
...
selectedLayer1TausForMuTauLeadTrkPt.pluginName = cms.string("selectedLayer1TausForMuTauLeadTrkPt")
...
selectedLayer1TausForMuTauTrkIso.pluginName = cms.string("selectedLayer1TausForMuTauTrkIso")

# require tau candidate to be isolated
# with respect to energy deposits in ECAL
selectedLayer1TausForMuTauEcalIso = copy.deepcopy(selectedLayer1TausEcalIso)
selectedLayer1TausForMuTauEcalIso.pluginName = cms.string("selectedLayer1TausForMuTauEcalIso")
...
selectedLayer1TausForMuTauProng.pluginName = cms.string("selectedLayer1TausForMuTauProng")

# require tau candidate to pass muon veto
selectedLayer1TausForMuTauMuonVeto = copy.deepcopy(selectedLayer1TausMuonVeto)
selectedLayer1TausForMuTauMuonVeto.pluginName = cms.string("selectedLayer1TausForMuTauMuonVeto")
