...
submitToGrid(configFile = "runZtoElecTau_cfg.py", channel = "ZtoElecTau",
		...
		"maxEvents = -1; inputFileType = " + inputFileType + "; eventsPerJob = 30000; applyFactorization = false; estimateSysUncertainties = false; globalTag = START3X_V26::All",
		type = "mc",
		outputFileNames = [ plotsOutputFileNameZtoElecTau_WplusJets_7TeV ], 
		outputFilePath = outputFilePath, submit = "yes")
...
submitToGrid(configFile = "runZtoElecTau_cfg.py", channel = "ZtoElecTau",
		...
		"maxEvents = -1; inputFileType = " + inputFileType + "; eventsPerJob = 30000; applyFactorization = false; estimateSysUncertainties = false; globalTag = START3X_V26::All",
		type = "mc",
		outputFileNames = [ plotsOutputFileNameZtoElecTau_TTplusJets_7TeV ], 
		outputFilePath = outputFilePath, submit = "yes")
...
submitToGrid(configFile = "runZtoElecTau_cfg.py", channel = "ZtoElecTau",
		...
		"maxEvents = -1; inputFileType = " + inputFileType + "; eventsPerJob = 30000; applyFactorization = false; estimateSysUncertainties = false; globalTag = START3X_V26::All",
		type = "mc",
		outputFileNames = [ plotsOutputFileNameZtoElecTau_ZeePlusJets_7TeV ], 
		outputFilePath = outputFilePath, submit = "yes")
...
submitToGrid(configFile = "runZtoElecTau_cfg.py", channel = "ZtoElecTau",
		...
		"maxEvents = -1; inputFileType = " + inputFileType + "; eventsPerJob = 20000; applyFactorization = false; estimateSysUncertainties = false; globalTag = START3X_V26::All",
		type = "mc",
		outputFileNames = [ plotsOutputFileNameZtoElecTau_ZtautauPlusJets_7TeV ], 
		outputFilePath = outputFilePath, submit = "yes")
...
submitToGrid(configFile = "runZtoElecTau_cfg.py", channel = "ZtoElecTau",
		...
		type = "mc",
		outputFileNames = [ plotsOutputFileNameZtoElecTau_QCD_EMenriched_Pt20to30_7TeV ], 
		outputFilePath = outputFilePath, submit = "yes")
...
submitToGrid(configFile = "runZtoElecTau_cfg.py", channel = "ZtoElecTau",
		...
		"maxEvents = -1; inputFileType = " + inputFileType + "; eventsPerJob = 50000; applyFactorization = true; estimateSysUncertainties = false; globalTag = START3X_V26::All",
		type = "mc",
		outputFileNames = [ plotsOutputFileNameZtoElecTau_QCD_EMenriched_Pt80to170_7TeV ], 
		outputFilePath = outputFilePath, submit = "yes")
...
submitToGrid(configFile = "runZtoElecTau_cfg.py", channel = "ZtoElecTau",
		...
		dbs_url = "http://cmsdbsprod.cern.ch/cms_dbs_ph_analysis_02/servlet/DBSServlet",             
		replFunction = makeReplacementsCrab, replacements =
		"maxEvents = -1; inputFileType = " + inputFileType + "; eventsPerJob = 40000; applyFactorization = true; estimateSysUncertainties = false; globalTag = START3X_V26::All",
		type = "mc",
		outputFileNames = [ plotsOutputFileNameZtoElecTau_QCD_BCtoE_Pt20to30_7TeV ], 
		outputFilePath = outputFilePath, submit = "yes")
...
submitToGrid(configFile = "runZtoElecTau_cfg.py", channel = "ZtoElecTau",
		...
		"maxEvents = -1; inputFileType = " + inputFileType + "; eventsPerJob = 40000; applyFactorization = true; estimateSysUncertainties = false; globalTag = START3X_V26::All",
		type = "mc",
		outputFileNames = [ plotsOutputFileNameZtoElecTau_QCD_BCtoE_Pt30to80_7TeV ], 
		outputFilePath = outputFilePath, submit = "yes")
...
submitToGrid(configFile = "runZtoElecTau_cfg.py", channel = "ZtoElecTau",
		...
		"maxEvents = -1; inputFileType = " + inputFileType + "; eventsPerJob = 40000; applyFactorization = true; estimateSysUncertainties = false; globalTag = START3X_V26::All",
		type = "mc",
		outputFileNames = [ plotsOutputFileNameZtoElecTau_QCD_BCtoE_Pt80to170_7TeV ], 
		outputFilePath = outputFilePath, submit = "yes")
...
submitToGrid(configFile = "runZtoElecTau_cfg.py", channel = "ZtoElecTau",
		...
		type = "mc",
		outputFileNames = [ plotsOutputFileNameZtoElecTau_PhotonPlusJets_Pt15to20_7TeV ], 
		outputFilePath = outputFilePath, submit = "yes")
...
submitToGrid(configFile = "runZtoElecTau_cfg.py", channel = "ZtoElecTau",
		...
		"maxEvents = -1; inputFileType = " + inputFileType + "; eventsPerJob = 20000; applyFactorization = true; estimateSysUncertainties = false; globalTag = START3X_V26::All",
		type = "mc",
		outputFileNames = [ plotsOutputFileNameZtoElecTau_PhotonPlusJets_Pt20to30_7TeV ], 
		outputFilePath = outputFilePath, submit = "yes")
...
submitToGrid(configFile = "runZtoElecTau_cfg.py", channel = "ZtoElecTau",
		...
		"maxEvents = -1; inputFileType = " + inputFileType + "; eventsPerJob = 20000; applyFactorization = true; estimateSysUncertainties = false; globalTag = START3X_V26::All",
		type = "mc",
		outputFileNames = [ plotsOutputFileNameZtoElecTau_PhotonPlusJets_Pt30to50_7TeV ], 
		outputFilePath = outputFilePath, submit = "yes")
...
submitToGrid(configFile = "runZtoElecTau_cfg.py", channel = "ZtoElecTau",
		...
		"maxEvents = -1; inputFileType = " + inputFileType + "; eventsPerJob = 20000; applyFactorization = true; estimateSysUncertainties = false; globalTag = START3X_V26::All",
		type = "mc",
		outputFileNames = [ plotsOutputFileNameZtoElecTau_PhotonPlusJets_Pt50to80_7TeV ], 
		outputFilePath = outputFilePath, submit = "yes")
...
submitToGrid(configFile = "runZtoElecTau_cfg.py", channel = "ZtoElecTau",
		...
		"maxEvents = -1; inputFileType = " + inputFileType + "; eventsPerJob = 20000; applyFactorization = true; estimateSysUncertainties = false; globalTag = START3X_V26::All",
		type = "mc",
		outputFileNames = [ plotsOutputFileNameZtoElecTau_PhotonPlusJets_Pt80to120_7TeV ], 
		outputFilePath = outputFilePath, submit = "yes")
