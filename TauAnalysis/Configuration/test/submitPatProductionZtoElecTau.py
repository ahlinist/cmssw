...
outputFilePath_data = "/castor/cern.ch/user/j/jkolb/elecTauPatTuples/spring10/"
outputFilePath_mc = "/castor/cern.ch/user/j/jkolb/elecTauPatTuples/spring10/"
...
for i in range(15):
	submitToBatch(configFile = "producePatTuple_cfg.py", channel = "ZtoElecTau", 
		...
		replFunction = makeReplacementsPatProduction, replacements = "maxEvents = -1; globalTag = GR_R_35X_V8::All",
