...
outputDirectory = "/castor/cern.ch/user/j/jkolb/elecTauAnalysis/patTuples/"

# small cmsRun job for testing purposes...
#submitToBatch(configFile = "producePatTuple_cfg.py", channel = "ZtoElecTau", sample = "Ztautau_part01",
#              replFunction = makeReplacementsPatProduction, replacements = "maxEvents = 100; applyFactorization = false",
#              job = "PatProduction", queue = "1nh", outputDirectory = outputDirectory)
...
for i in range(10):
	submitToBatch(configFile = "producePatTuple_cfg.py", channel = "ZtoElecTau", 
		...
		job = "PatProduction", queue = "1nd", outputDirectory = outputDirectory)
...
# Photon + jets jobs
submitToBatch(configFile = "producePatTuple_cfg.py", channel = "ZtoElecTau", sample = "PhotonJets_Pt15to20",
	replFunction = makeReplacementsPatProduction, replacements = "maxEvents = -1",
	job = "PatProduction", queue = "8nh", outputDirectory = outputDirectory)
submitToBatch(configFile = "producePatTuple_cfg.py", channel = "ZtoElecTau", sample = "PhotonJets_Pt20to25",
	replFunction = makeReplacementsPatProduction, replacements = "maxEvents = -1",
	job = "PatProduction", queue = "8nh", outputDirectory = outputDirectory)
submitToBatch(configFile = "producePatTuple_cfg.py", channel = "ZtoElecTau", sample = "PhotonJets_Pt25to30",
	replFunction = makeReplacementsPatProduction, replacements = "maxEvents = -1",
	job = "PatProduction", queue = "8nh", outputDirectory = outputDirectory)
submitToBatch(configFile = "producePatTuple_cfg.py", channel = "ZtoElecTau", sample = "PhotonJets_Pt30to35",
	replFunction = makeReplacementsPatProduction, replacements = "maxEvents = -1",
	job = "PatProduction", queue = "8nh", outputDirectory = outputDirectory)
submitToBatch(configFile = "producePatTuple_cfg.py", channel = "ZtoElecTau", sample = "PhotonJets_PtGt35",
	replFunction = makeReplacementsPatProduction, replacements = "maxEvents = -1",
	job = "PatProduction", queue = "8nh", outputDirectory = outputDirectory)
