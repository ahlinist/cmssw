...
process.load("TauAnalysis.RecoTools.pftauPatSelectorForDiTau_cfi")
process.load("TauAnalysis.CandidateTools.diTauPairProducer_cff")

process.load("TauAnalysis.Configuration.analyzeZtoDiTau_cff")

process.DQMStore = cms.Service("DQMStore")

process.saveZtoDiTau = cms.EDAnalyzer("DQMSimpleFileSaver",
...
process.p = cms.Path( process.producePatLayer1ForTauAnalyses
                     +process.selectPFTausForDiTau
                     +process.produceDiTauPairs
                     +process.analyzeZtoDiTau
