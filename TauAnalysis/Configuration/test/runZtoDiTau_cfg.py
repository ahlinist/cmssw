...
process.saveZtoDiTauPatTuple = cms.OutputModule("PoolOutputModule",
  fileName = cms.untracked.string('diTauSkim_patTuple.root')
)
...
#                    +process.saveZtoDiTauPatTuple # uncomment to write-out produced PAT-tuple
