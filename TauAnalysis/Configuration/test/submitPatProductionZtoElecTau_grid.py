...
submitToGrid(configFile = "producePatTuple_cfg.py", channel = "ZtoElecTau",
		sample = "ZtautauPlusJets_7TeV", job = "0",
		dbs_name = "/ZJets-madgraph/akalinow-SkimTauTau_356_pass1-0a3d3891f015a95324f94837322fb8aa-elecTauSkim/USER",
		dbs_url = "http://cmsdbsprod.cern.ch/cms_dbs_ph_analysis_02/servlet/DBSServlet",             
		replFunction = makeReplacementsCrab, replacements =
		"maxEvents = -1; eventsPerJob = 30000; applyFactorization = false; estimateSysUncertainties = false; globalTag = START3X_V26::All",
...
submitToGrid(configFile = "producePatTuple_cfg.py", channel = "ZtoElecTau",
		sample = "QCD_BCtoE_Pt30to80_7TeV", job = "0",
...
submitToGrid(configFile = "producePatTuple_cfg.py", channel = "ZtoElecTau",
		sample = "QCD_BCtoE_Pt80to170_7TeV", job = "0",
...
submitToGrid(configFile = "producePatTuple_cfg.py", channel = "ZtoElecTau",
		sample = "PhotonPlusJets_Pt15to20_7TeV", job = "0",
