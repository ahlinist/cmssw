...
def makeReplacementsAnalysis(channel = None, sample = None, replacements = None):
	...
	# replace genPhaseSpaceCut, plotsOutputFileName and inputFileName parameters
	...
	inputFileNames = "cms.untracked.vstring('rfio:" + inputFilePath + "' + patTupleOutputFileName" + sample
