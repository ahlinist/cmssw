...
#
# NOTE: Function needs to be passed the first nine of the following ten arguments
...
def submitToGrid(configFile = None, channel = None,
    ...
    crabConfigFile_mod = submissionDirectory + "crab" + "_" + configFile.replace("_cfg.py", "_" + sample + ".cfg")
