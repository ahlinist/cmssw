...
#      ZplusJets = copy.deepcopy(drawOption_ZplusJets),
  ...
  drawJobs = cms.PSet(
    ...
    cutFlowControlPlots_dR12_afterMuonTrkIPcut = copy.deepcopy(plots_ZtoElecMu_dR12_afterMuonTrkIPcut),   
    cutFlowControlPlots_diTauCharge_afterAntiOverlapVeto = copy.deepcopy(plots_ZtoElecMu_diTauCharge_afterAntiOverlapVeto),
    cutFlowControlPlots_mtElectronMET_afterZeroCharge = copy.deepcopy(plots_ZtoElecMu_mtElectronMET_afterZeroCharge),
    cutFlowControlPlots_mtMuonMET_aftermtElectronMET = copy.deepcopy(plots_ZtoElecMu_mtMuonMET_aftermtElectronMET),
