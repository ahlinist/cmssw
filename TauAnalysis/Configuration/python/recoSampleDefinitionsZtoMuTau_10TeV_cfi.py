...
corrFactorZtoMuTau_Ztautau_10TeV = float(1.12)
...
corrFactorZtoMuTau_Zmumu_10TeV = float(1.)
...
corrFactorZtoMuTau_WplusJets_10TeV = float(1.)
...
fileNamesZtoMuTau_PPmuXptGt20_10TeV_part50 = cms.untracked.vstring(    
    'rfio:/castor/cern.ch/user/l/lusi_10TeVto/SkimOctober09/IncMu15QCDSkimMT314_1/muTauSkim_245.root',
...
corrFactorZtoMuTau_TTplusJets_10TeV = float(1.)
