...
selectedDiTauPairs1stTauEta21Individual.srcLeg1 = cms.InputTag('selectedPatTausEta21Individual')

selectedDiTauPairs1stTauEta21Cumulative = copy.deepcopy(selectedDiTauPairs1stTauEta21Individual)
selectedDiTauPairs1stTauEta21Cumulative.srcLeg1 = cms.InputTag('selectedPatTausForDiTauEta21Cumulative')
...
selectedDiTauPairs1stTauPt20Individual.srcLeg1 = cms.InputTag('selectedPatTausPt20Individual')

selectedDiTauPairs1stTauPt20Cumulative = copy.deepcopy(selectedDiTauPairs1stTauPt20Individual)
selectedDiTauPairs1stTauPt20Cumulative.srcLeg1 = cms.InputTag('selectedPatTausForDiTauPt20Cumulative')
...
selectedDiTauPairs1stTauLeadTrkIndividual.srcLeg1 = cms.InputTag('selectedPatTausLeadTrkIndividual')

selectedDiTauPairs1stTauLeadTrkCumulative = copy.deepcopy(selectedDiTauPairs1stTauLeadTrkIndividual)
selectedDiTauPairs1stTauLeadTrkCumulative.srcLeg1 = cms.InputTag('selectedPatTausForDiTauLeadTrkCumulative')
...
selectedDiTauPairs1stTauLeadTrkPtIndividual.srcLeg1 = cms.InputTag('selectedPatTausLeadTrkPtIndividual')

selectedDiTauPairs1stTauLeadTrkPtCumulative = copy.deepcopy(selectedDiTauPairs1stTauLeadTrkPtIndividual)
selectedDiTauPairs1stTauLeadTrkPtCumulative.srcLeg1 = cms.InputTag('selectedPatTausForDiTauLeadTrkPtCumulative')
...
selectedDiTauPairs1stTauTrkIsoIndividual.srcLeg1 = cms.InputTag('selectedPatTausTrkIsoIndividual')

selectedDiTauPairs1stTauTrkIsoCumulative = copy.deepcopy(selectedDiTauPairs1stTauTrkIsoIndividual)
selectedDiTauPairs1stTauTrkIsoCumulative.srcLeg1 = cms.InputTag('selectedPatTausForDiTauTrkIsoCumulative')

# require 1st tau candidate to be isolated
# with respect to energy deposits in ECAL
selectedDiTauPairs1stTauEcalIsoIndividual = copy.deepcopy(allDiTauPairs)
selectedDiTauPairs1stTauEcalIsoIndividual.srcLeg1 = cms.InputTag('selectedPatTausEcalIsoIndividual')

selectedDiTauPairs1stTauEcalIsoCumulative = copy.deepcopy(selectedDiTauPairs1stTauEcalIsoIndividual)
selectedDiTauPairs1stTauEcalIsoCumulative.srcLeg1 = cms.InputTag('selectedPatTausForDiTauEcalIsoCumulative')
...
selectedDiTauPairs1stTauProngIndividual.srcLeg1 = cms.InputTag('selectedPatTausProngIndividual')

selectedDiTauPairs1stTauProngCumulative = copy.deepcopy(selectedDiTauPairs1stTauProngIndividual)
selectedDiTauPairs1stTauProngCumulative.srcLeg1 = cms.InputTag('selectedPatTausForDiTauProngCumulative')
...
selectedDiTauPairs1stTauChargeIndividual.srcLeg1 = cms.InputTag('selectedPatTausChargeIndividual')

selectedDiTauPairs1stTauChargeCumulative = copy.deepcopy(selectedDiTauPairs1stTauChargeIndividual)
selectedDiTauPairs1stTauChargeCumulative.srcLeg1 = cms.InputTag('selectedPatTausForDiTauChargeCumulative')
...
selectedDiTauPairs2ndTauEta21Individual.srcLeg2 = cms.InputTag('selectedPatTausEta21Individual')

selectedDiTauPairs2ndTauEta21Cumulative = copy.deepcopy(selectedDiTauPairs2ndTauEta21Individual)
selectedDiTauPairs2ndTauEta21Cumulative.srcLeg2 = cms.InputTag('selectedPatTausForDiTauEta21Cumulative')
...
selectedDiTauPairs2ndTauPt20Individual.srcLeg2 = cms.InputTag('selectedPatTausPt20Individual')

selectedDiTauPairs2ndTauPt20Cumulative = copy.deepcopy(selectedDiTauPairs1stTauPt20Individual)
selectedDiTauPairs2ndTauPt20Cumulative.srcLeg2 = cms.InputTag('selectedPatTausForDiTauPt20Cumulative')
...
selectedDiTauPairs2ndTauLeadTrkIndividual.srcLeg2 = cms.InputTag('selectedPatTausLeadTrkIndividual')

selectedDiTauPairs2ndTauLeadTrkCumulative = copy.deepcopy(selectedDiTauPairs1stTauLeadTrkIndividual)
selectedDiTauPairs2ndTauLeadTrkCumulative.srcLeg2 = cms.InputTag('selectedPatTausForDiTauLeadTrkCumulative')
...
selectedDiTauPairs2ndTauLeadTrkPtIndividual.srcLeg2 = cms.InputTag('selectedPatTausLeadTrkPtIndividual')

selectedDiTauPairs2ndTauLeadTrkPtCumulative = copy.deepcopy(selectedDiTauPairs1stTauLeadTrkPtIndividual)
selectedDiTauPairs2ndTauLeadTrkPtCumulative.srcLeg2 = cms.InputTag('selectedPatTausForDiTauLeadTrkPtCumulative')
...
selectedDiTauPairs2ndTauTrkIsoIndividual.srcLeg2 = cms.InputTag('selectedPatTausTrkIsoIndividual')

selectedDiTauPairs2ndTauTrkIsoCumulative = copy.deepcopy(selectedDiTauPairs1stTauTrkIsoIndividual)
selectedDiTauPairs2ndTauTrkIsoCumulative.srcLeg2 = cms.InputTag('selectedPatTausForDiTauTrkIsoCumulative')
...
selectedDiTauPairs2ndTauEcalIsoIndividual.srcLeg2 = cms.InputTag('selectedPatTausEcalIsoIndividual')

selectedDiTauPairs2ndTauEcalIsoCumulative = copy.deepcopy(selectedDiTauPairs1stTauEcalIsoIndividual)
selectedDiTauPairs2ndTauEcalIsoCumulative.srcLeg2 = cms.InputTag('selectedPatTausForDiTauEcalIsoCumulative')
...
selectedDiTauPairs2ndTauProngIndividual.srcLeg2 = cms.InputTag('selectedPatTausProngIndividual')

selectedDiTauPairs2ndTauProngCumulative = copy.deepcopy(selectedDiTauPairs1stTauProngIndividual)
selectedDiTauPairs2ndTauProngCumulative.srcLeg2 = cms.InputTag('selectedPatTausForDiTauProngCumulative')

# require 1st tau candidate to have charge either +1 or -1
# (computed as sum of charges of tracks within signal cone)
selectedDiTauPairs2ndTauChargeIndividual = copy.deepcopy(selectedDiTauPairs1stTauChargeCumulative)
selectedDiTauPairs2ndTauChargeIndividual.srcLeg2 = cms.InputTag('selectedPatTausChargeIndividual')

selectedDiTauPairs2ndTauChargeCumulative = copy.deepcopy(selectedDiTauPairs1stTauChargeIndividual)
selectedDiTauPairs2ndTauChargeCumulative.srcLeg2 = cms.InputTag('selectedPatTausForDiTauChargeCumulative')
