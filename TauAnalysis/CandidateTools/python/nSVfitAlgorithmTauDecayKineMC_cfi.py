...
##   cms.string('pdf_Electron_Muon_AllMom_leg1VisInvisDeltaRLab_leg1_dR_selected2')
...
##   cms.string('pdf_OneProng0Pi0_AllMom_leg2VisInvisDeltaRLab_leg2_dR_selected2')
...
##   cms.string('pdf_OneProngGt0Pi0_AllMom_leg2VisInvisDeltaRLab_leg2_dR_selected2')
...
##   cms.string('pdf_ThreeProng0Pi0_AllMom_leg2VisInvisDeltaRLab_leg2_dR_selected2')
...
nSVfitTauDecayLikelihoodMC_energy_angle_selected.decayModeParameters.electron.pdfName = \
  cms.string('pdf_Electron_Muon_AllMom_leg1VisInvisAngleLab_leg1_angle_selected2')
...
nSVfitTauDecayLikelihoodMC_energy_angle_selected.decayModeParameters.oneProngZeroPi0s.pdfName = \
  cms.string('pdf_OneProng0Pi0_AllMom_leg2VisInvisAngleLab_leg2_angle_selected2')
...
nSVfitTauDecayLikelihoodMC_energy_angle_selected.decayModeParameters.oneProngGtZeroPi0s.pdfName = \
  cms.string('pdf_OneProngGt0Pi0_AllMom_leg2VisInvisAngleLab_leg2_angle_selected2')
...
nSVfitTauDecayLikelihoodMC_energy_angle_selected.decayModeParameters.threeProngZeroPi0s.pdfName = \
  cms.string('pdf_ThreeProng0Pi0_AllMom_leg2VisInvisAngleLab_leg2_angle_selected2')
