...
process.nSVfitProducerByLikelihoodMaximization.config.event.resonances.A.daughters.leg1.likelihoodFunctions = cms.VPSet(process.nSVfitMuonLikelihoodPhaseSpace)
process.nSVfitProducerByLikelihoodMaximization.config.event.resonances.A.daughters.leg1.builder = process.nSVfitTauToMuonBuilder
