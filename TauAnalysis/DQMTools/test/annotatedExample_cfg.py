...
#
    inputFileNames = cms.vstring('annotatedExample_zMuMu1kEv.root'), # single .root file
    scaleFactor = cms.double(1.),
    dqmDirectory_store = cms.string('zMuMu1kEv')
  ),
  zMuMu9kEv = cms.PSet(
#
# load all histograms contained in files annotatedExample_zMuMu1kEv_01.root, annotatedExample_zMuMu1kEv_02.root,
# annotatedExample_zMuMu1kEv_03.root, annotatedExample_zMuMu1kEv_04.root and annotatedExample_zMuMu5kEv.root;
# store them in directory zMuMu9kEv
# (this defines the dummy "background")    
#    
    inputFileNames = cms.vstring('annotatedExample_zMuMu1kEv_#RANGE01-04#.root', # total of 5 root files
                                 'annotatedExample_zMuMu5kEv.root'),
    scaleFactor = cms.double(1.),
...
#    
    inputFileNames = cms.vstring('annotatedExample_zMuMu10kEv.root'),
    scaleFactor = cms.double(1.),
...
#
# configuration parameters for DQMHistEffProducer class
#--> compute efficiency of different muon selection criteria
#    by computing ratio:
#
#      muons tested & passed
#     -----------------------
...
#
  ...
  outputFileName = cms.string('annotatedExample_zMuMu.ps')
