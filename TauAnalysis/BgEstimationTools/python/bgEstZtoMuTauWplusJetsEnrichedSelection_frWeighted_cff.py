...
diTauCandidateNSVfitHistManagerBgEstWplusJetsEnrichedFRweighted = copy.deepcopy(diTauCandidateNSVfitHistManagerBgEstWplusJetsEnriched)
diTauCandidateNSVfitHistManagerBgEstWplusJetsEnrichedFRweighted.diTauCandidateSource = diTauCandidateHistManagerBgEstWplusJetsEnrichedFRweighted.diTauCandidateSource
diTauCandidateNSVfitHistManagerBgEstWplusJetsEnrichedFRmcWeighted = copy.deepcopy(diTauCandidateNSVfitHistManagerBgEstWplusJetsEnrichedFRweighted)
diTauCandidateNSVfitHistManagerBgEstWplusJetsEnrichedFRmcWeighted.pluginName = cms.string('diTauCandidateNSVfitHistManagerBgEstWplusJetsEnrichedFRmcWeighted')
diTauCandidateNSVfitHistManagerBgEstWplusJetsEnrichedFRmcWeighted.diTauLeg2WeightSource = cms.vstring('bgEstFakeRateJetWeight_WplusJetsSim')
diTauCandidateNSVfitHistManagerBgEstWplusJetsEnrichedFRdataWeighted = copy.deepcopy(diTauCandidateNSVfitHistManagerBgEstWplusJetsEnrichedFRweighted)
diTauCandidateNSVfitHistManagerBgEstWplusJetsEnrichedFRdataWeighted.pluginName = cms.string('diTauCandidateNSVfitHistManagerBgEstWplusJetsEnrichedFRdataWeighted')
diTauCandidateNSVfitHistManagerBgEstWplusJetsEnrichedFRdataWeighted.diTauLeg2WeightSource = cms.vstring('bgEstFakeRateJetWeight_WplusJetsData')
...
analyzerModuleReplacementsWplusJetsEnrichedFRdataWeighted.extend([
    ...
    [ diTauCandidateNSVfitHistManagerBgEstWplusJetsEnriched, diTauCandidateNSVfitHistManagerBgEstWplusJetsEnrichedFRdataWeighted ]
])
