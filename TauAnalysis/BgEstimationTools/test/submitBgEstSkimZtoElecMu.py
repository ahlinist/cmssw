...
outputDirectory = "/castor/cern.ch/user/s/sunil/bgEstSkim/ZtoElecMu/"
...
# Z --> tau tau jobs
for i in range(3):
    submitToBatch(configFile = "skimZtoElecMu_cfg.py", channel = "ZtoElecMu", sample = "Ztautau_part%(i)02d" % {"i" : (i + 1)},
...
# Z --> mu mu jobs
for i in range(2):
    submitToBatch(configFile = "skimZtoElecMu_cfg.py", channel = "ZtoElecMu", sample = "Zmumu_part%(i)02d" % {"i" : (i + 1)},
              replFunction = makeReplacementsBgEstSkim, replacements = "maxEvents = -1",
              job = "bgEstSkim", queue = "1nd", outputDirectory = outputDirectory)
...
for i in range(5):
    submitToBatch(configFile = "skimZtoElecMu_cfg.py", channel = "ZtoElecMu", sample = "WplusJets_part%(i)02d" % {"i" : (i + 1)},
                  ...
                  job = "bgEstSkim", queue = "1nd", outputDirectory = outputDirectory)
for i in range(2):
    submitToBatch(configFile = "skimZtoElecMu_cfg.py", channel = "ZtoElecMu", sample = "ZeePlusJets_part%(i)02d" % {"i" : (i + 1)},
              replFunction = makeReplacementsBgEstSkim, replacements = "maxEvents = -1",
              job = "bgEstSkim", queue = "1nd", outputDirectory = outputDirectory)
for i in range(2):
   submitToBatch(configFile = "skimZtoElecMu_cfg.py", channel = "ZtoElecMu", sample = "ZmumuPlusJets_part%(i)02d" % {"i" : (i + 1)},
              replFunction = makeReplacementsBgEstSkim, replacements = "maxEvents = -1",
              job = "bgEstSkim", queue = "1nw", outputDirectory = outputDirectory)
for i in range(2):
   submitToBatch(configFile = "skimZtoElecMu_cfg.py", channel = "ZtoElecMu", sample = "ZtautauPlusJets_part%(i)02d" % {"i" : (i + 1)},
              replFunction = makeReplacementsBgEstSkim, replacements = "maxEvents = -1",
              job = "bgEstSkim", queue = "1nd", outputDirectory = outputDirectory)
