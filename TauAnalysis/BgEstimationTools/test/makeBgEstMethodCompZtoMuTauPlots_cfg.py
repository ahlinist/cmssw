...
##    meName_scaleFactor = cms.string('methodBgEstTemplateFit/fitBgEstTemplateZtoMuTau/fitResults/Ztautau/norm/value#a1#s1'),
...
process.scaleBgEstTemplateFitZtoMuTau_ZmumuJetMisId = cms.EDAnalyzer("DQMHistScaler",
    ...
    meName_scaleFactor = cms.string('methodBgEstTemplateFit/fitBgEstTemplateZtoMuTau/fitResults/ZmumuJetMisId/norm/value#a1#s1'),
    meType = cms.string("real")                                                            
)
...
process.scaleBgEstTemplateFitZtoMuTau_ZmumuMuonMisId = cms.EDAnalyzer("DQMHistScaler",
    ...
    meName_scaleFactor = cms.string('methodBgEstTemplateFit/fitBgEstTemplateZtoMuTau/fitResults/ZmumuMuonMisId/norm/value#a1#s1'),
    meType = cms.string("real")                                                            
)
...
process.scaleBgEstTemplateFitZtoMuTau_WplusJets = cms.EDAnalyzer("DQMHistScaler",
    ...
    meName_scaleFactor = cms.string('methodBgEstTemplateFit/fitBgEstTemplateZtoMuTau/fitResults/WplusJets/norm/value#a1#s1'),
    meType = cms.string("real")                                                            
)
...
process.scaleBgEstTemplateFitZtoMuTau_TTplusJets = cms.EDAnalyzer("DQMHistScaler",
    ...
    meName_scaleFactor = cms.string('methodBgEstTemplateFit/fitBgEstTemplateZtoMuTau/fitResults/TTplusJets/norm/value#a1#s1'),
    meType = cms.string("real")                                                            
)
...
process.scaleBgEstTemplateFitZtoMuTau_QCD = cms.EDAnalyzer("DQMHistScaler",
    ...
    meName_scaleFactor = cms.string('methodBgEstTemplateFit/fitBgEstTemplateZtoMuTau/fitResults/QCD/norm/value#a1#s1'),
    meType = cms.string("real")                                                            
)
