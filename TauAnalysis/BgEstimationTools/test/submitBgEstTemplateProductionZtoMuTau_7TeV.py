...
outputFilePath = "/castor/cern.ch/user/v/veelken/CMSSW_3_6_x/bgEstPlots/ZtoMuTau_bgEstTemplates/7TeV/"
...
for i in range(16):
    submitToBatch(configFile = "runBgEstTemplateProductionZtoMuTau_cfg.py", channel = "ZtoMuTau",
                  ...
                  job = "bgEstTemplateProduction", queue = "1nw", outputFilePath = outputFilePath)
