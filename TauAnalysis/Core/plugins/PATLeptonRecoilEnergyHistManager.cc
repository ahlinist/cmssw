...
typedef PATLeptonRecoilEnergyHistManager<pat::Tau, CaloTower> TauRecoilEnergyFromForwardCaloTowersHistManager;
typedef PATLeptonRecoilEnergyHistManager<pat::Tau, CaloTower> TauRecoilEnergyFromCentralCaloTowersHistManager;
...
DEFINE_EDM_PLUGIN(AnalyzerPluginFactory, TauRecoilEnergyFromForwardCaloTowersHistManager, "TauRecoilEnergyFromForwardCaloTowersHistManager");
DEFINE_EDM_PLUGIN(HistManagerPluginFactory, TauRecoilEnergyFromForwardCaloTowersHistManager, "TauRecoilEnergyFromForwardCaloTowersHistManager");

DEFINE_EDM_PLUGIN(AnalyzerPluginFactory, TauRecoilEnergyFromCentralCaloTowersHistManager, "TauRecoilEnergyFromCentralCaloTowersHistManager");
DEFINE_EDM_PLUGIN(HistManagerPluginFactory, TauRecoilEnergyFromCentralCaloTowersHistManager, "TauRecoilEnergyFromCentralCaloTowersHistManager");
...
typedef HistManagerAdapter<TauRecoilEnergyFromCaloTowersHistManager> TauRecoilEnergyFromForwardCaloTowersAnalyzer;
