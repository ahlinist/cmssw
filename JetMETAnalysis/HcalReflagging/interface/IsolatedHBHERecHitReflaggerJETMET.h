#ifndef __ISOLATED_HBHERECHIT_REFLAGGER_JETMET_H__
#define __ISOLATED_HBHERECHIT_REFLAGGER_JETMET_H__
...
//
// Actually does the reflagging
//////////////////////////////////////////////////////////////////////////////

class IsolatedHBHERecHitReflaggerJETMET : public edm::EDProducer {
 public:
  explicit IsolatedHBHERecHitReflaggerJETMET(const edm::ParameterSet&);
  ~IsolatedHBHERecHitReflaggerJETMET();
