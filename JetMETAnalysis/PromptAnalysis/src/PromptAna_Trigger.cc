...
produce(edm::Event& iEvent, const edm::EventSetup& iSetup) {
  ...
  if(l1GtReadoutRecord.isValid()) {
    edm::LogInfo("PromptAna_TriggerInfo") << "Successfully obtained " << l1InputTag;
    ...
    edm::LogError("PromptAna_TriggerError") << "Error! Can't get the product " << l1InputTag;
  }
  ...
  if(triggerResults.isValid()) {
    edm::LogInfo("PromptAna_TriggerInfo") << "Successfully obtained " << hltInputTag;
    ...
    edm::LogError("PromptAna_TriggerError") << "Error! Can't get the product " << hltInputTag;
  }
