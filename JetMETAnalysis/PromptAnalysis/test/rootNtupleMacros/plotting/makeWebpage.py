...
<head> 
 ...
 document.getElementById("thumb_l").width = " 500 "   
 document.getElementById("thumb_l").height = " 500 "    
...
if( document.layers) document.all[''+id+''].visibility = "show" 
 ...
 <style type="text/css">   
 #thumb_gen {position: absolute; position: fixed; left: 720; top:120; text-align: center;}   
