...
file_directory = "/ciet3b/data4/Summer10_10invpb_AODSIM/WmunuPLUS"
#file_directory = "/ciet3b/data4/Summer10_All_MinimalAOD/WmunuPLUS"
...
process.wmnOutputModule = cms.OutputModule("PoolOutputModule"
      ...
      , fileName = cms.untracked.string('EdmWmnTreeMCPLUSShort.root')
)
