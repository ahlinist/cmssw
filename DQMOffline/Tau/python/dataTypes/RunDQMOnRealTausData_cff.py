...
from DQMOffline.Tau.RecoTauDQMGeneral_cfi import *
import copy
...
helpers.massSearchReplaceAnyInputTag(proc.TauValNumeratorAndDenominatorRealTausData, 'kinematicSelectedTauValDenominator',  cms.InputTag("TauZLegs","theProbeLeg")) #sets the correct input tag
