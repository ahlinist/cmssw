...
// -*- C++ -*-
//
#ifndef HepCombinedMatcher_H_INCLUDED
#define HepCombinedMatcher_H_INCLUDED
//
...
class HepCombinedMatcher: public HepParticleMatcher {

public:

  inline HepCombinedMatcher(const HepString &);
 // The constructor.

  inline virtual ~HepCombinedMatcher();
  // The destructor.
...
#include "SimGeneral/HepPDT/interface/HepCombinedMatcher.icc"
