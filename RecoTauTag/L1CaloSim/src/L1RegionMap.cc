...
L1RegionMap* L1RegionMap::theInstance = 0;

L1RegionMap*
L1RegionMap::getL1RegionMap()
{
  if(theInstance == 0)
    {
      theInstance = new L1RegionMap();
    }
  return theInstance;
}
...
std::pair<int, int> 
L1RegionMap::getRegionEtaPhiIndex(CaloTowerDetId tower)
{

  return L1RegionMap::getRegionEtaPhiIndex(std::pair<int, int>(tower.ieta(), tower.iphi()));
}

// Region-Tower ID from DetId
int 
L1RegionMap::getRegionTowerIndex(CaloTowerDetId tower)
{
  return L1RegionMap::getRegionTowerIndex(std::pair<int, int>(tower.ieta(), tower.iphi()));
}
...
std::pair<int, int> 
L1RegionMap::getRegionEtaPhiIndex(std::pair<int, int> EtaPhi)
{
  //// *** TDR ***
...
int 
L1RegionMap::getRegionTowerIndex(std::pair<int, int> EtaPhi)
{
  int iTwrEta = EtaPhi.first;
  int iTwrPhi = EtaPhi.second;
...
int 
L1RegionMap::getRegionTowerIndex(int iEta, int iPhi)
{
  return L1RegionMap::getRegionTowerIndex(std::pair<int, int>(iEta,iPhi));
}

std::pair<int, int>
L1RegionMap::getRegionEtaPhiIndex(int regionId)
{
...
int
L1RegionMap::getRegionIndex(int ieta, int iphi)
{
...
int
L1RegionMap::getRegionIndex(CaloTowerDetId tower)
{
...
L1RegionMap::getRegionCenterEtaPhi(int iRgn)
{
...
int
L1RegionMap::convertFromECal_to_HCal_iphi(int iphi_ecal)
{
  int iphi = 999;
  if (iphi_ecal>=3)
    iphi = iphi_ecal - 2;
...
// which is shifted by 2 towers down
int
L1RegionMap::convertFromHCal_to_ECal_iphi(int iphi_hcal)
{
  int iphi = 999;
...
std::pair<int, int> 
L1RegionMap::GetTowerNorthEtaPhi(int ieta, int iphi) 
{ 
  if (iphi < 72) 
...
std::pair<int, int> 
L1RegionMap::GetTowerSouthEtaPhi(int ieta, int iphi) 
{ 
  if (iphi > 1) 
    return std::pair<int, int>(ieta, iphi-1); 
  else 
...
std::pair<int, int> 
L1RegionMap::GetTowerWestEtaPhi(int ieta, int iphi) 
{ 
...
std::pair<int, int> 
L1RegionMap::GetTowerEastEtaPhi(int ieta, int iphi) 
{ 
  if (ieta == -1) return std::pair<int, int>(1, iphi);
...
std::pair<int, int> 
L1RegionMap::GetTowerNWEtaPhi(int ieta, int iphi) 
{ 
  int iEta = ieta - 1;
  int iPhi = iphi + 1;
  if (ieta <= -32) 
...
std::pair<int, int> 
L1RegionMap::GetTowerNEEtaPhi(int ieta, int iphi) 
{ 
  int iEta = ieta + 1;
  int iPhi = iphi + 1;
  if (ieta >= 32) 
...
std::pair<int, int> 
L1RegionMap::GetTowerSWEtaPhi(int ieta, int iphi) 
{ 
  int iEta = ieta - 1;
  int iPhi = iphi - 1;
  if (ieta <= -32) 
...
std::pair<int, int> 
L1RegionMap::GetTowerSEEtaPhi(int ieta, int iphi) 
{ 
  int iEta = ieta + 1;
  int iPhi = iphi - 1;
  if (ieta >= 32) 
