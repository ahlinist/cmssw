#ifndef RecoTauTag_L1GlobalAlgo_h
#define RecoTauTag_L1GlobalAlgo_h
// -*- C++ -*-
//
// Package:    L1CaloSim
// Class:      L1GlobalAlgo
...
class L1GlobalAlgo {
   public:
      explicit L1GlobalAlgo(const edm::ParameterSet&);
      ~L1GlobalAlgo();
     ...
     // ------------ Methods using Towers and RecHits ------------
      ...
      std::vector<L1Region> GetCaloRegions(){return m_Regions;}//KP
