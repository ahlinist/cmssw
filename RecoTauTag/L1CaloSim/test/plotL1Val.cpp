void plotL1Val(bool printCanvas = false, bool printIndividual = false, bool normHists = true)
{
  ...
  TString dir = "";
  TString l1branch = "l1tauAna/histos/";
  TString fl1branch = "l1simtauAna/histos/";
  ...
  TString l1str = l1branch+lstr;TString fl1str = fl1branch+lstr;
  ...
  hl1->SetMaximum(1.1*TMath::Max(hl1->GetMaximum(),hl2->GetMaximum()));
  ...
  if (normHists) {
    double integ1 = (double)hl1->Integral();
    if (integ1>0.) hl1->Scale(1./integ1);
    double integ2 = (double)hl2->Integral();
    if (integ2>0.) hl2->Scale(1./integ2);
  }
  hl1->SetMaximum(1.1*TMath::Max(hl1->GetMaximum(),hl2->GetMaximum()));
  ...
  //hl1->SetMaximum(1.05*TMath::Max(hl1->GetMaximum(),hl2->GetMaximum()));
  hl1->SetMaximum(1.01);
  hl1->SetMinimum(0.);
