...
process.source = cms.Source("PoolSource",
    ...
    #'file:/home/chinhan/cms/cmssw/tteff_forNote/CMSSW_2_2_13/src/ElectroWeakAnalysis/TauTriggerEfficiency/test/rootfiles/minbias_summer08_reco_01.root'
    )
)
...
process.TFileService = cms.Service("TFileService", 
    ...
    #fileName = cms.string('mb_l1val.root')
)
