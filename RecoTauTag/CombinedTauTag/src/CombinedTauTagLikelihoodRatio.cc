...
void CombinedTauTagLikelihoodRatio::setCandidateCategoryParameterValues(int signaltks_n,double TauCandidate_et){
  m_signaltks_n=signaltks_n;
  m_TauCandidate_et=TauCandidate_et;
}
void CombinedTauTagLikelihoodRatio::setCandidateTaggingVariableList(TaggingVariableList x){
  m_TaggingVariableList=x;
}
double CombinedTauTagLikelihoodRatio::value(){
  ...
  if(m_signaltks_n==1) minnumbercandidates_inpdf_byrecjetEtslice=minnumbercandidates_inpdf_byrecjetEtslice_case1signaltk_;
  if(m_signaltks_n==3) minnumbercandidates_inpdf_byrecjetEtslice=minnumbercandidates_inpdf_byrecjetEtslice_case3signaltks_;
...
int CombinedTauTagLikelihoodRatio::getTagVarNumber(TaggingVariable x){
  int TagVarNumber=-1;
  switch (x.first){
