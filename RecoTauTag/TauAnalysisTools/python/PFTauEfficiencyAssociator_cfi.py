...
shrinkingConeMuEnrichedQCDAssociator.efficiencySources = cms.PSet(
        ...
        filename=cms.string("/afs/cern.ch/user/f/friis/public/TauFakeRateFeb21/ppmux_histograms.root")
)
...
shrinkingConeDiJetHighPt.efficiencySources = cms.PSet(
        ...
        filename=cms.string("/afs/cern.ch/user/f/friis/public/TauFakeRateFeb21/dijet_highpt_histograms.root")
)
...
shrinkingConeDiJetSecondPt.efficiencySources = cms.PSet(
        ...
        filename=cms.string("/afs/cern.ch/user/f/friis/public/TauFakeRateFeb21/dijet_secondpt_histograms.root")
)
...
shrinkingConeWJets.efficiencySources = cms.PSet(
        WJetsEffSources,
        filename=cms.string("/afs/cern.ch/user/f/friis/public/TauFakeRateFeb21/wjets_histograms.root")
)
...
shrinkingConeZTTEffSimAssociator.efficiencySources = cms.PSet(
        ZTTEffSimSources,
        filename=cms.string("/afs/cern.ch/user/f/friis/public/TauFakeRateFeb21/ztt_histograms.root")
)
