...
shrinkingConeMuEnrichedQCDAssociator.efficiencySources = cms.PSet(
        ...
        filename=cms.string("/afs/cern.ch/user/f/friis/public/TauFakeRateMar1/ppmux_histograms.root")
)
...
shrinkingConeDiJetHighPt.efficiencySources = cms.PSet(
        ...
        filename=cms.string("/afs/cern.ch/user/f/friis/public/TauFakeRateMar1/dijet_highpt_histograms.root")
)
...
shrinkingConeDiJetSecondPt.efficiencySources = cms.PSet(
        ...
        filename=cms.string("/afs/cern.ch/user/f/friis/public/TauFakeRateMar1/dijet_secondpt_histograms.root")
)
...
shrinkingConeWJets.efficiencySources = cms.PSet(
        WJetsEffSources,
        filename=cms.string("/afs/cern.ch/user/f/friis/public/TauFakeRateMar1/wjets_histograms.root")
)
...
shrinkingConeZTTEffSimAssociator.efficiencySources = cms.PSet(
        ZTTEffSimSources,
        filename=cms.string("/afs/cern.ch/user/f/friis/public/TauFakeRateMar1/ztt_histograms.root")
)
