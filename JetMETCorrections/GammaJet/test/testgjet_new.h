...
#ifndef testgjet_new_h
#define testgjet_new_h
...
public :
   ...
   testgjet_new(TTree *tree=0, char * outputname = "test.root");
   virtual ~testgjet_new();
...
#ifdef testgjet_new_cxx
testgjet_new::testgjet_new(TTree *tree, char * outputname)
{
...
Int_t testgjet_new::GetEntry(Long64_t entry)
{
...
Long64_t testgjet_new::LoadTree(Long64_t entry)
{
...
void testgjet_new::Init(TTree *tree)
{
...
void testgjet_new::Show(Long64_t entry)
{
