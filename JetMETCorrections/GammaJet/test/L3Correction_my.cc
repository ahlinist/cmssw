...
void L3Correction_my()
{
 ...
 int i,auxi;
 TFile *inf2;
 inf2 = new TFile("/afs/cern.ch/user/d/delre/scratch0/CMSSW/CMSSW_2_0_7/src/test_input_tree.root");
 TH1F *h2;
 sprintf(name,"biassum_sig");
 h2 = (TH1F*)inf2->Get(name);
 TFile *inf;
 inf = new TFile("/afs/cern.ch/user/d/delre/scratch0/CMSSW/CMSSW_1_6_7/src/testoneall_newbin2.root");
 TH1F *h;
 sprintf(name,"biassum_sig");
 h = (TH1F*)inf->Get(name);
