...
############ HLT filter:
process.hltPhoton15 = cms.EDFilter("HLTHighLevel",
...
process.p = cms.Path(process.monster*process.ecalCleanClustering*process.hltPhoton15*process.recoJPTJets*process.myanalysis)
