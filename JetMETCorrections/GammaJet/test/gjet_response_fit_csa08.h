...
#ifndef gjet_response_fit_csa08_h
#define gjet_response_fit_csa08_h
...
public :
   ...
   gjet_response_fit_csa08(TTree *tree=0, char * outputname = "test.root", int xbin = 100, int ybin = 100);
   virtual ~gjet_response_fit_csa08();
...
#ifdef gjet_response_fit_csa08_cxx
gjet_response_fit_csa08::gjet_response_fit_csa08(TTree *tree, char * outputname, int xbin, int ybin)
{
...
gjet_response_fit_csa08::~gjet_response_fit_csa08()
{
   if (!fChain) return;
...
Int_t gjet_response_fit_csa08::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t gjet_response_fit_csa08::LoadTree(Long64_t entry)
{
...
void gjet_response_fit_csa08::Init(TTree *tree)
{
...
Bool_t gjet_response_fit_csa08::Notify()
{
...
void gjet_response_fit_csa08::Show(Long64_t entry)
{
...
#endif // #ifdef gjet_response_fit_csa08_cxx
