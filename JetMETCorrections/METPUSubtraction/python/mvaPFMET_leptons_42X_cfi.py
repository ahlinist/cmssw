...
#muons1stStep.fillGlobalTrackRefits = cms.bool(False)
#muons1stStep.fillCaloCompatability = cms.bool(False)
#muons1stStep.runArbitrationCleaner = cms.bool(False)
#muons1stStep.fillTrackerKink       = cms.bool(False)

#muons1stStep.inputCollectionTypes  = cms.vstring  ('inner tracks')
#muons1stStep.inputCollectionLabels = cms.VInputTag(cms.InputTag("generalTracks"))
