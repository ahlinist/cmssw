...
int main(int argc, char ** argv) {
  ...
  TCPDistributor *lTCPDistributorShort = 0;
  TCPDistributor *lTCPDistributorLong = 0;
  ...
  delete lTCPDistributorShort;
  delete lTCPDistributorLong;
