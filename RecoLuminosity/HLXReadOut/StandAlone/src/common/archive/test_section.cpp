...
int main(int argc, char ** argv) {
  ...
  try {
    ...
    //SectionCollector lSectionCollector(3564, // Num bunches
    //				       200,   // Num nibbles per lumi section
    //			       80,   // Num orbits in lumi nibble
    //			       1);   // Num HLXs
    TestSectionCollector lSectionCollector(3,300); //200 //1600
    NibbleCollector lNibbleCollector(3);
	...
	cout << "Good test data count:" << lSectionCollector.GetNumGoodNibbles() << endl;
	cout << "Bad test data count: " << lSectionCollector.GetNumBadNibbles () << endl;
