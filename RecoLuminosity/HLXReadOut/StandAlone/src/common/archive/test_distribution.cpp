...
int main(int argc, char ** argv) {
  ...
  try {
    ...
    SectionCollector lSectionCollector(200, //3564, // Num bunches
				       2,  // Num nibbles per section
				       300, //280,  // Num orbits in lumi nibble
				       1);   // Num HLXs
    ...
    TestDistributor lTestDistributor;
    lSectionCollector.AttachDistributor(reinterpret_cast<AbstractDistributor *>(&lTestDistributor));
