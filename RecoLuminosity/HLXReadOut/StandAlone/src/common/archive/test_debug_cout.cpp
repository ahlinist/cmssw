...
int main(int argc, char ** argv) {
  ...
  try {
    ...
    SectionCollector lSectionCollector(200, // Num bunches
				       ...
				       300, // Num orbits in lumi section
				       3);  // Num HLXs
    ...
    DebugCoutDistributor lDebugCoutDistributor;
    lSectionCollector.AttachDistributor(reinterpret_cast<AbstractDistributor *>(&lDebugCoutDistributor));
