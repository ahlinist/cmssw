...
//   synchOn = SimpleConfigurable<bool>(true,"ProductionPhysics:SynchrotronRadiation");
//   gammNucOn = SimpleConfigurable<bool>(true,"ProductionPhysics:ElectroNuclearProcess");
  
//   G4LossTableManager::Instance()->SetBuildPreciseRange
//       (SimpleConfigurable<bool>(false,"ProductionPhysics:BuildPreciseRangeTables"));

//   static SimpleConfigurable<double> thresholdForElectronRebirthing
//       (500*MeV,"ProductionPhysics:ThresholdForElectron");    
  synchOn = true;
  gammNucOn = true;
  double thresholdForElectronRebirthing = 500*MeV;
  
  G4cout << " Setting the Threshold for eBrem (CMS modificatios) to " 
	 << thresholdForElectronRebirthing << " MeV" << G4endl;    
  theElectronBremsStrahlung.SetGammaThreshold(thresholdForElectronRebirthing);
  thePositronBremsStrahlung.SetGammaThreshold(thresholdForElectronRebirthing);
}
