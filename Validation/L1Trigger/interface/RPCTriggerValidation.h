...
// $Id: RPCTriggerValidation.h,v 1.9 2010/04/14 16:53:59 dbart Exp $
//
//
...
class RPCTriggerValidation : public edm::EDAnalyzer {
   ...
   private:
      ...
      MonitorElement * nomEta, * denomEta, * ghost, * unassigned,* nomPt, * denomPt,*alltrig,*trig,* unassignedVsRef;
