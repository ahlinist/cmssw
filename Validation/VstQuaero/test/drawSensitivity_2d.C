...
ifstream fin1((logLdirectory+exp+"_"+example+exampleSuffix+"_sensitivity.txt").c_str());
string s;
int N = 0;
while(fin1 >> s)
{ N++; fin1 >> s >> s; }
fin1.close();
cout << "N = " << N << endl;
ifstream fin2((logLdirectory+exp+"_"+example+exampleSuffix+"_sensitivity.txt").c_str());
