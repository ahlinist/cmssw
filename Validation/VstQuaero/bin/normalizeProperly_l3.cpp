...
void normalizeProperly_l3(string infilename, vector<Luminosity> inLumi, string outfilename, vector<Luminosity> outLumi)
{
...
int main(int argc, char* argv[])
{
  if((argc!=19))
    {
      cout << "normalizeProperly_l3 <inputFile> <inlumi_183,189,192,196,200,202,205,207> <outputFile> <outlumi_183,189,192,196,200,202,205,207>" << endl;
      exit(1);
    }
  ...
  cout << "      normalizeProperly_l3" << endl;
  for(int i=0; i<8; i++)
    {
  ...
  normalizeProperly_l3(infilename, inLumi, outfilename, outLumi);
  return 0;
}
