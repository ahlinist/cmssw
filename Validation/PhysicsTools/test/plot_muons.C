...
//  string outdir = "Jets";
  ...
  //////////// monitoring of eta parameter
   ...
   comp.SetAxis(1, -6,6);
   TCanvas *c1 = new TCanvas("c1", "Glb eta benchmark");
   FormatPad( c1, false ); 
   ...
   comp.SetAxis(1, -6,6);
   TCanvas *c2 = new TCanvas("c2", "Tk eta benchmark");
   FormatPad( c2, false );
   ...
   comp.SetAxis(1, -6,6);
   TCanvas *c3 = new TCanvas("c3", " Res Glb Sta eta benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1, -6,6);
   TCanvas *c3 = new TCanvas("c3", "Res TkSta eta benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1, -6,6);
   TCanvas *c3 = new TCanvas("c3", "ResVsEta TkGlb eta benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1, -6,6);
   TCanvas *c3 = new TCanvas("c3", "ResVsEta GlbSta eta benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1, -6,6);
   TCanvas *c3 = new TCanvas("c3", "ResVsEta TkSta eta benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1, -6,6);
   TCanvas *c3 = new TCanvas("c3", "TkMuon eta benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1, -6,6);
   TCanvas *c3 = new TCanvas("c3", "StaMuon eta benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1, -6,6);
   TCanvas *c3 = new TCanvas("c3", " StaEta ifCombinedAlso benchmark");
   FormatPad( c3, false );
  ...
  // monitoring of theta parameter
   ...
   comp.SetAxis(1, 0,4);
   TCanvas *c1 = new TCanvas("c1", "Glb theta benchmark");
   FormatPad( c1, false ); 
   ...
   comp.SetAxis(1, 0,4);
   TCanvas *c2 = new TCanvas("c2", "Tk theta benchmark");
   FormatPad( c2, false );
   ...
   comp.SetAxis(1, 0,4);
   TCanvas *c3 = new TCanvas("c3", "Sta theta benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1, 0,4);
   TCanvas *c3 = new TCanvas("c3", "Res TkGlb theta benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1, 0,4);
   TCanvas *c3 = new TCanvas("c3", " Res Glb Tk Sta eta benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1, 0,4);
   TCanvas *c3 = new TCanvas("c3", "ResVsTheta TkGlb theta benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1, 0,4);
   TCanvas *c3 = new TCanvas("c3", "ResVsTheta GlbSta theta benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1, 0,4);
   TCanvas *c3 = new TCanvas("c3", "ResVsTheta_TkSta_theta benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1, 0,4);
   TCanvas *c3 = new TCanvas("c3", "TkMuon theta benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1, 0,4);
   TCanvas *c3 = new TCanvas("c3", "StaMuon theta benchmark");
   FormatPad( c3, false );
  ...
  // monitoring of phi paramater  
   ...
   comp.SetAxis(1, -4,4);
   TCanvas *c1 = new TCanvas("c1", "Glb phi benchmark");
   FormatPad( c1, false ); 
   ...
   comp.SetAxis(1, -4,4);
   TCanvas *c2 = new TCanvas("c2", "Tk phi benchmark");
   FormatPad( c2, false );
   ...
   comp.SetAxis(1, -4,4);
   TCanvas *c3 = new TCanvas("c3", "Sta phi benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1, -4,4);
   TCanvas *c3 = new TCanvas("c3", "Res TkGlb phi benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1, -4,4);
   TCanvas *c3 = new TCanvas("c3", " Res Glb Sta phi benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1, -4,4);
   TCanvas *c3 = new TCanvas("c3", "Res TkSta phi benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1, -4,4);
   TCanvas *c3 = new TCanvas("c3", "ResVsEta TkGlb phi benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1, -4,4);
   TCanvas *c3 = new TCanvas("c3", "ResVsEta GlbSta phi benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1, -4,4);
   TCanvas *c3 = new TCanvas("c3", "ResVsEta TkSta phi benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1, -4,4);
   TCanvas *c3 = new TCanvas("c3", "TkMuon phi benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1, -4,4);
   TCanvas *c3 = new TCanvas("c3", "StaMuon phi benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1, -4,4);
   TCanvas *c3 = new TCanvas("c3", " StaPhi ifCombinedAlso benchmark");
   FormatPad( c3, false );
...
// monitoring of the chi2 parameter
   comp.SetAxis(1, 0,50);
   TCanvas *c3 = new TCanvas("c3", " GlbMuon Glb chi2OverDf benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1, 0,50);
   TCanvas *c3 = new TCanvas("c3", "  GlbMuon Sta chi2OverDf benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1, 0,50);
   TCanvas *c3 = new TCanvas("c3", "TkMuon chi2OverDf");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1, 0,50);
   TCanvas *c3 = new TCanvas("c3", "StaMuon_chi2OverDf benchmark");
   FormatPad( c3, false );
...
// monitoring of the momentum
   ...
   TCanvas *c3 = new TCanvas("c3", " Glb p benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,0,500);
   TCanvas *c3 = new TCanvas("c3", "  Tk p benchmark");
   FormatPad( c3, false );  
   ...
   comp.SetAxis(1,0,500);
   TCanvas *c3 = new TCanvas("c3", " Sta p benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,0,500);
   TCanvas *c3 = new TCanvas("c3", "TkMuon p benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,0,500);
   TCanvas *c3 = new TCanvas("c3", " StaMuon p benchmark");
   FormatPad( c3, false );
...
// monitoring of the transverse momentum
   ...
   TCanvas *c3 = new TCanvas("c3", "GlbMuon Glp pt benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,0,200);
   TCanvas *c3 = new TCanvas("c3", " GlbMuon Tk q benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,0,200);
   TCanvas *c3 = new TCanvas("c3", " Sta q benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,0,200);
   TCanvas *c3 = new TCanvas("c3", "TkMuon pt benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,0,200);
   TCanvas *c3 = new TCanvas("c3", " StaMuon pt benchmark");
   FormatPad( c3, false );
...
// monitoring of the muon charge
   ...
   TCanvas *c3 = new TCanvas("c3", "Glb q benchmark");
   FormatPad( c3, false );  
   ...
   comp.SetAxis(1,-2.5,2.5);
   TCanvas *c3 = new TCanvas("c3", " Tk q benchmark");
   FormatPad( c3, false );
   comp.Draw("GlbMuon_Tk_q", mode);
   SavePlot("GlbMuon_Tk_q", outdir.c_str() );
   comp.SetAxis(5);
   ...
   comp.SetAxis(1,-2.5,2.5);
   TCanvas *c3 = new TCanvas("c3", " Sta qbenchmark");
   FormatPad( c3, false );
   comp.Draw("GlbMuon_Sta_q", mode);
   SavePlot("GlbMuon_Sta_q", outdir.c_str() );
   comp.SetAxis(5);
   ...
   comp.SetAxis(1,-2.5,2.5);
   TCanvas *c3 = new TCanvas("c3", " TkMuon q benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,-2.5,2.5);
   TCanvas *c3 = new TCanvas("c3", " StaMuon q benchmark");
   FormatPad( c3, false );
...
// monitoring of the momentum resolution
   ...
   TCanvas *c3 = new TCanvas("c3", " Res_TkGlb_qOverp benchmark");
   FormatPad( c3, false );
   ...
   TCanvas *c3 = new TCanvas("c3", "  Res_GlbSta_qOverp benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,-0.01,0.01);
   TCanvas *c3 = new TCanvas("c3", "  Res_TkSta_qOverp benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,-0.001,0.001);
   TCanvas *c3 = new TCanvas("c3", "  Res_TkGlb_oneOverp benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,-0.01,0.01);
   TCanvas *c3 = new TCanvas("c3", " Res_GlbSta_oneOverp  benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,-0.01,0.01);
   TCanvas *c3 = new TCanvas("c3", "Res_TkSta_oneOverp  benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,-0.001,0.001);
   TCanvas *c3 = new TCanvas("c3", " Res_TkGlb_qOverpt benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,-0.01,0.01);
   TCanvas *c3 = new TCanvas("c3", " Res_GlbSta_qOverpt benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,-0.01,0.01);
   TCanvas *c3 = new TCanvas("c3", " Res_TkSta_qOverpt benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,-0.001,0.001);
   TCanvas *c3 = new TCanvas("c3", " Res_TkGlb_oneOverpt  benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,-0.01,0.01);
   TCanvas *c3 = new TCanvas("c3", " Res_GlbSta_oneOverpt benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,-0.01,0.01);
   TCanvas *c3 = new TCanvas("c3", " Res_TkSta_oneOverpt benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,-3,3);
   TCanvas *c3 = new TCanvas("c3", " ResVsEta_TkGlb_oneOverpt  benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,-3,3);
   TCanvas *c3 = new TCanvas("c3", " ResVsEta_GlbSta_oneOverpt  benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,-3,3);
   TCanvas *c3 = new TCanvas("c3", " ResVsEta_TkSta_oneOverpt benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,-3,3);
   TCanvas *c3 = new TCanvas("c3", " ResVsPhi_TkGlb_oneOverpt benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,-3,3);
   TCanvas *c3 = new TCanvas("c3", "ResVsPhi_GlbSta_oneOverpt  benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,-3,3);
   TCanvas *c3 = new TCanvas("c3", "ResVsPhi_TkSta_oneOverpt  benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,0,2);
   TCanvas *c3 = new TCanvas("c3", "ResVsPt_TkGlb_oneOverpt  benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,0,2);
   TCanvas *c3 = new TCanvas("c3", " ResVsPt_GlbSta_oneOverpt benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,0,2);
   TCanvas *c3 = new TCanvas("c3", "ResVsPt_TkSta_oneOverpt  benchmark");
   FormatPad( c3, false );
...
// monitoring of the recHits provenance
   ...
   comp.SetAxis(1,0,1);
   TCanvas *c3 = new TCanvas("c3", " StaRh_Frac_inGlb benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,0,1);
   TCanvas *c3 = new TCanvas("c3", " TkRh_Frac_inGlb benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,0,1);
   TCanvas *c3 = new TCanvas("c3", " StaRh_inGlb_Div_RhAssoSta benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,0,1);
   TCanvas *c3 = new TCanvas("c3", " TkRh_inGlb_Div_RhAssoTk benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,0,1);
   TCanvas *c3 = new TCanvas("c3", "GlbRh_Div_RhAssoStaTk  benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,0,1);
   TCanvas *c3 = new TCanvas("c3", "invalidRh_Frac_inTk  benchmark");
   FormatPad( c3, false );
