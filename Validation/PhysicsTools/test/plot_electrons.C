...
//  string outdir = "Jets";
  ...
  comp.SetStyles(style1, style2, "RECO Objetcs", "PAT Objects");
   ...
   TCanvas *c1 = new TCanvas("c1", "pt benchmark");
   FormatPad( c1, false ); 
   comp.Draw("pt", mode);
   ...
   comp.SetAxis(1, -6,6);
   TCanvas *c2 = new TCanvas("c2", "eta benchmark");
   FormatPad( c2, false );
   comp.Draw("eta", mode);
   ...
   comp.SetAxis(1, -4,4);
   TCanvas *c3 = new TCanvas("c3", "phi benchmark");
   FormatPad( c3, false );
   comp.Draw("phi", mode);
   ...
   TCanvas *c3 = new TCanvas("c3", "DiElectronMass benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,0,10); 
   TCanvas *c3 = new TCanvas("c3", " TrackIso benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,0,10); 
   TCanvas *c3 = new TCanvas("c3", " CaloIso benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,-5,5); 
   TCanvas *c3 = new TCanvas("c3", "ele_matchingObjectEta benchmark");
   FormatPad( c3, false );
   ...
   TCanvas *c3 = new TCanvas("c3", "ele_matchingObjectPt benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,-4,4);
   TCanvas *c3 = new TCanvas("c3", "ele_matchingObjectPhi benchmark");
   FormatPad( c3, false );
   ...
   TCanvas *c3 = new TCanvas("c3", "ele_matchingObjectZ benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,-2,2);
   TCanvas *c3 = new TCanvas("c3", "ele_charge benchmark");
   FormatPad( c3, false );
   ...
   TCanvas *c3 = new TCanvas("c3", "ele_vertexP benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,0,100);
   TCanvas *c3 = new TCanvas("c3", "ele_vertexPt benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,-5,5);
   TCanvas *c3 = new TCanvas("c3", "ele_vertexEta benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,-4,4);
   TCanvas *c3 = new TCanvas("c3", "ele_vertexPhi benchmark");
   FormatPad( c3, false );
   ...
   TCanvas *c3 = new TCanvas("c3", "ele_vertexX benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,-0.1,0.1);
   TCanvas *c3 = new TCanvas("c3", "ele_vertexY benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,-25,25);
   TCanvas *c3 = new TCanvas("c3", "ele_vertexZ benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,0,5);
   TCanvas *c3 = new TCanvas("c3", "ele_EoverP_all benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,0,5);
   TCanvas *c3 = new TCanvas("c3", "ele_EoPout benchmark");
   FormatPad( c3, false );
   ...
   TCanvas *c3 = new TCanvas("c3", "ele_dEtaSc_propVtx benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,-0.05,0.05);
   TCanvas *c3 = new TCanvas("c3", "ele_dPhiSc_propVtx benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,-0.05,0.05);
   TCanvas *c3 = new TCanvas("c3", "ele_dPhiCl_propOut benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,-0.05,0.05);
   TCanvas *c3 = new TCanvas("c3", "ele_HoE benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,0,150);
   TCanvas *c3 = new TCanvas("c3", "ele_classes benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,0,3);
   TCanvas *c3 = new TCanvas("c3", "ele_eta benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,0,3);
   TCanvas *c3 = new TCanvas("c3", "ele_eta_golden benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,0,3);
   TCanvas *c3 = new TCanvas("c3", "ele_eta_show benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,0,30);
   TCanvas *c3 = new TCanvas("c3", "ele_foundHits benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,0,15);
   TCanvas *c3 = new TCanvas("c3", "ele_chi2 benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,0,100);
   TCanvas *c3 = new TCanvas("c3", "ele_PinMnPout_mode benchmark");
   FormatPad( c3, false );
