...
//  string outdir = "Jets";
  ...
  comp.SetStyles(style1, style2, "RECO Objetcs", "PAT Objects");
   ...
   comp.SetAxis(1, 1,5);
   TCanvas *c3 = new TCanvas("c3", "met benchmark");
   FormatPad( c3, false );
   comp.Draw("met", mode);
   ...
   comp.SetAxis(1,0,1);
   TCanvas *c3 = new TCanvas("c3", "METTask_Nevents");
   FormatPad( c3, false );
   ...
   TCanvas *c3 = new TCanvas("c3", "METTask_CaloMEx");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,-500,500); 
   TCanvas *c3 = new TCanvas("c3", "METTask_CaloMEy");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,-500,500);
   TCanvas *c3 = new TCanvas("c3", "METTask_CaloEz");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,0,51);
   TCanvas *c3 = new TCanvas("c3", "METTask_CaloMETSig");
   FormatPad( c3, false );
   ...
   TCanvas *c3 = new TCanvas("c3", "METTask_CaloMET");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,-4,4);
   TCanvas *c3 = new TCanvas("c3", "METTask_CaloMETPhi");
   FormatPad( c3, false );
   ...
   TCanvas *c3 = new TCanvas("c3", "METTask_CaloSumET");
   FormatPad( c3, false );
   ...
   TCanvas *c3 = new TCanvas("c3", "METTask_CaloMEx_LS");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,-200,200);
   TCanvas *c3 = new TCanvas("c3", "METTask_CaloMEy_LS");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,0,2000);
   TCanvas *c3 = new TCanvas("c3", "METTask_CaloMaxEtInEmTowers");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,0,2000);
   TCanvas *c3 = new TCanvas("c3", "METTask_CaloMaxEtInHadTowers");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,0,1);
   TCanvas *c3 = new TCanvas("c3", "METTask_CaloEtFractionHadronic");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,0,1);
   TCanvas *c3 = new TCanvas("c3", "METTask_CaloEmEtFraction");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,0,2000);
   TCanvas *c3 = new TCanvas("c3", "METTask_CaloHadEtInHB");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,0,2000);
   TCanvas *c3 = new TCanvas("c3", "METTask_CaloHadEtInHO");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,0,2000);
   TCanvas *c3 = new TCanvas("c3", "METTask_CaloHadEtInHE");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,0,2000);
   TCanvas *c3 = new TCanvas("c3", "METTask_CaloHadEtInHF");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,0,2000);
   TCanvas *c3 = new TCanvas("c3", "METTask_CaloEmEtInHF");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,0,2000);
   TCanvas *c3 = new TCanvas("c3", "METTask_CaloEmEtInEE");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,0,2000);
   TCanvas *c3 = new TCanvas("c3", "METTask_CaloEmEtInEB");
   FormatPad( c3, false );
