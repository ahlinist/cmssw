...
//  string outdir = "Jets";
  ...
  comp.SetStyles(style1, style2, "RECO Objetcs", "PAT Objects");
   ...
   TCanvas *c3 = new TCanvas("c3", "METTask_MEx");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,-500,500); 
   TCanvas *c3 = new TCanvas("c3", "METTask_MEy");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,-500,500);
   TCanvas *c3 = new TCanvas("c3", "METTask_Ez");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,0,51);
   TCanvas *c3 = new TCanvas("c3", "METTask_METSig");
   FormatPad( c3, false );
   ...
   TCanvas *c3 = new TCanvas("c3", "METTask_MET");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1,-4,4);
   TCanvas *c3 = new TCanvas("c3", "METTask_METPhi");
   FormatPad( c3, false );
   ...
   TCanvas *c3 = new TCanvas("c3", "METTask_SumET");
   FormatPad( c3, false );
