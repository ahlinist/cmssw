...
//  string outdir = "Jets";
  ...
  comp.SetStyles(style1, style2, "RECO Objetcs", "PAT Objects");
   ...
   TCanvas *c0 = new TCanvas("c0", "legend", 400, 200);    
   FormatPad( c0, false ); 
   comp.Legend().Draw();
   SavePlot("legend", outdir.c_str() );
    
   comp.SetAxis(1,-0.5,9);
   TCanvas *c1 = new TCanvas("c1", " nPhoAll benchmark");
   FormatPad( c1, false ); 
   ...
   comp.SetAxis(1,-0.5,9);       
   TCanvas *c1 = new TCanvas("c1", " nPhoBarrel benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,-0.5,9);       
   TCanvas *c1 = new TCanvas("c1", " nPhoEndcap  benchmark");
   FormatPad( c1, false );
   ...
   TCanvas *c1 = new TCanvas("c1", " scEAll benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,500);  
   TCanvas *c1 = new TCanvas("c1", " scEBarrel benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,500);
   TCanvas *c1 = new TCanvas("c1", " scEEndcap benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,500);
   TCanvas *c1 = new TCanvas("c1", " scEtAll benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,500);  
   TCanvas *c1 = new TCanvas("c1", "scEtBarrel benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,500);
   TCanvas *c1 = new TCanvas("c1", " scEtEndcap benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0 ,500);
   TCanvas *c1 = new TCanvas("c1", " r9All benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,500);  
   TCanvas *c1 = new TCanvas("c1", " r9Barrel benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,500);
   TCanvas *c1 = new TCanvas("c1", " r9Endcap benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,-4,4);
   TCanvas *c1 = new TCanvas("c1", " scEta benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,-4 ,4);  
   TCanvas *c1 = new TCanvas("c1", " benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0 ,500);
   TCanvas *c1 = new TCanvas("c1", " phoEAll benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,500);
   TCanvas *c1 = new TCanvas("c1", " phoEBarrel benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,500);  
   TCanvas *c1 = new TCanvas("c1", " phoEEndcap benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0 ,500); 
   TCanvas *c1 = new TCanvas("c1", " phoEtAll benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,500);  
   TCanvas *c1 = new TCanvas("c1", " phoEtBarrel benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,500);  
   TCanvas *c1 = new TCanvas("c1", " phoEtEndcap benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,-4,4);
   TCanvas *c1 = new TCanvas("c1", " phoEta benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,-4 ,4);
   TCanvas *c1 = new TCanvas("c1", " phoPhi benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,-5 ,5);
   TCanvas *c1 = new TCanvas("c1", " nConvAll benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,-5 ,5);
   TCanvas *c1 = new TCanvas("c1", " nConvBarrel benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,-5,5);
   TCanvas *c1 = new TCanvas("c1", " convEta benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,-4 ,4);
   TCanvas *c1 = new TCanvas("c1", " convPhi benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,5);
   TCanvas *c1 = new TCanvas("c1", " EoverPTracksAll benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,5);
   TCanvas *c1 = new TCanvas("c1", " EoverPTracksBarrel benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,5);  
   TCanvas *c1 = new TCanvas("c1", " EoverPTracksEndcap benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,1);
   TCanvas *c1 = new TCanvas("c1", " DPhiTracksAtVtxAll benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,1);
   TCanvas *c1 = new TCanvas("c1", " DPhiTracksAtVtxBarrel benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,1);  
   TCanvas *c1 = new TCanvas("c1", " DPhiTracksAtVtxEndcap benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,1);
   TCanvas *c1 = new TCanvas("c1", "DCotTracksxAll benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,1);
   TCanvas *c1 = new TCanvas("c1", "DCotTracksxBarrel benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,1);  
   TCanvas *c1 = new TCanvas("c1", "DCotTracksxEndcap benchmark");
   FormatPad( c1, false );
   ...
   TCanvas *c1 = new TCanvas("c1", " InvMassAll benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,1.5);
   TCanvas *c1 = new TCanvas("c1", " InvMassBarrel benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,1.5);  
   TCanvas *c1 = new TCanvas("c1", " InvMassEndcap benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,1);
   TCanvas *c1 = new TCanvas("c1", "DPhiTracksAtEcalAll benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,1);
   TCanvas *c1 = new TCanvas("c1", "DPhiTracksAtEcalBarrel benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,1);  
   TCanvas *c1 = new TCanvas("c1", "DPhiTracksAtEcalEndcap benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,1);
   TCanvas *c1 = new TCanvas("c1", "DEtaTracksAtEcalAll benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,1);
   TCanvas *c1 = new TCanvas("c1", "DEtaTracksAtEcalBarrel benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,1);
   TCanvas *c1 = new TCanvas("c1", "DEtaTracksAtEcalEndcap benchmark");
   FormatPad( c1, false );
   ...
   TCanvas *c1 = new TCanvas("c1", " zPVFromTracks benchmark");
   FormatPad( c1, false );
...
////////////Non Iso Photons
   ...
   comp.SetAxis(1,-0.5,9);
   TCanvas *c1 = new TCanvas("c1", " nPhoNoIsoAll benchmark");
   FormatPad( c1, false ); 
   ...
   comp.SetAxis(1,-0.5,9);       
   TCanvas *c1 = new TCanvas("c1", " nPhoNoIsoBarrel benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,-0.5,9);       
   TCanvas *c1 = new TCanvas("c1", " nPhoNoIsoEndcap  benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0 ,500);
   TCanvas *c1 = new TCanvas("c1", " scENoIsoAll benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,500);  
   TCanvas *c1 = new TCanvas("c1", " scENoIsoBarrel benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,500);
   TCanvas *c1 = new TCanvas("c1", " scENoIsoEndcap benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,500);
   TCanvas *c1 = new TCanvas("c1", " scEtNoIsoAll benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,500);  
   TCanvas *c1 = new TCanvas("c1", "scEtNoIsoBarrel benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,500);
   TCanvas *c1 = new TCanvas("c1", " scEtNoIsoEndcap benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0 ,500);
   TCanvas *c1 = new TCanvas("c1", " r9NoIsoAll benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,500);  
   TCanvas *c1 = new TCanvas("c1", " r9NoIsoBarrel benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,500);
   TCanvas *c1 = new TCanvas("c1", " r9NoIsoEndcap benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,-4,4);
   TCanvas *c1 = new TCanvas("c1", " scEtaNoIso benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,-4 ,4);  
   TCanvas *c1 = new TCanvas("c1", " scPhiNoIso benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0 ,500);
   TCanvas *c1 = new TCanvas("c1", " phoENoIsoAll benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,500);
   TCanvas *c1 = new TCanvas("c1", " phoENoIsoBarrel benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,500);  
   TCanvas *c1 = new TCanvas("c1", " phoENoIsoEndcap benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0 ,500); 
   TCanvas *c1 = new TCanvas("c1", " phoEtNoIsoAll benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,500);  
   TCanvas *c1 = new TCanvas("c1", " phoEtNoIsoBarrel benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,500);  
   TCanvas *c1 = new TCanvas("c1", " phoEtNoIsoEndcap benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,-4,4);
   TCanvas *c1 = new TCanvas("c1", " phoEtaNoIso benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,-4 ,4);
   TCanvas *c1 = new TCanvas("c1", " phoPhiNoIso benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,-5 ,5);
   TCanvas *c1 = new TCanvas("c1", " nConvNoIsoAll benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,-5 ,5);
   TCanvas *c1 = new TCanvas("c1", " nConvNoIsoBarrel benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,-5,5);
   TCanvas *c1 = new TCanvas("c1", " convEtaNoIso benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,-4 ,4);
   TCanvas *c1 = new TCanvas("c1", " convPhiNoIso benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,5);
   TCanvas *c1 = new TCanvas("c1", " EoverPTracksNoIsoAll benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,5);
   TCanvas *c1 = new TCanvas("c1", " EoverPTracksNoIsoBarrel benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,5);  
   TCanvas *c1 = new TCanvas("c1", " EoverPTracksNoIsoEndcap benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,1);
   TCanvas *c1 = new TCanvas("c1", " DPhiTracksAtVtxNoIsoAll benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,1);
   TCanvas *c1 = new TCanvas("c1", " DPhiTracksAtVtxNoIsoBarrel benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,1);  
   TCanvas *c1 = new TCanvas("c1", " DPhiTracksAtVtxNoIsoEndcap benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,1);
   TCanvas *c1 = new TCanvas("c1", "DCotTracksNoIsoAll benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,1);
   TCanvas *c1 = new TCanvas("c1", "DCotTracksxNoIsoBarrel benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,1);  
   TCanvas *c1 = new TCanvas("c1", "DCotTracksNoIsoEndcap benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,1.5);
   TCanvas *c1 = new TCanvas("c1", " InvMassNoIsoAll benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,1.5);
   TCanvas *c1 = new TCanvas("c1", " InvMassNoIsoBarrel benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,1.5);  
   TCanvas *c1 = new TCanvas("c1", " InvMassNoIsoEndcap benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,1);
   TCanvas *c1 = new TCanvas("c1", "DPhiTracksAtEcalNoIsoAll benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,1);
   TCanvas *c1 = new TCanvas("c1", "DPhiTracksAtEcalNoIsoBarrel benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,1);  
   TCanvas *c1 = new TCanvas("c1", "DPhiTracksAtEcalNoIsoEndcap benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,1);
   TCanvas *c1 = new TCanvas("c1", "DEtaTracksAtEcalNoIsoAll benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,1);
   TCanvas *c1 = new TCanvas("c1", "DEtaTracksAtEcalNoIsoBarrel benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,0,1);
   TCanvas *c1 = new TCanvas("c1", "DEtaTracksAtEcalNoIsoEndcap benchmark");
   FormatPad( c1, false );
   ...
   comp.SetAxis(1,-25,25);  
   TCanvas *c1 = new TCanvas("c1", " zPVFromTracksNoIso benchmark");
   FormatPad( c1, false );
