...
//  string outdir = "Jets";
  ...
  comp.SetStyles(style1, style2, "RECO Objects", "PAT Objects");
   ...
   TCanvas *c3 = new TCanvas("c3", "energy benchmark");
   FormatPad( c3, false );
   ...
   TCanvas *c3 = new TCanvas("c3", "PF Pt of Highest Pt charged particle within the tau-jet benchmark");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1, 0,500);
   TCanvas *c3 = new TCanvas("c3", "PF Pt of the highest Pt photon within the tau-jet");
   FormatPad( c3, false );
   ...
   comp.SetAxis(1, 0,500);
   TCanvas *c3 = new TCanvas("c3", "PF Pt of the highest Pt particle (of any type) within the tau-jet");
   FormatPad( c3, false );
