...
# with command line options: Configuration/GenProduction/python/CompHEP_cmsDriver_cff.py -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT --eventcontent RAWSIM --datatier GEN-SIM-RAW --conditions FrontierConditions_GlobalTag,IDEAL_V11::All -n 1000 –no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/GenProduction/python/CompHEP_cmsDriver_cff.py nevts:1000'),
...
process.source = cms.Source("ComphepSource",
    ...
    PythiaParameters = cms.PSet(
        pythiaUESettings = cms.vstring('MSTJ(11)=3     ! Choice of the fragmentation function', 
            ...
            'PARP(93)=15.0  ! '),
        pythiaCMSDefaults = cms.vstring('MSEL=0         ! User defined processes/Full user control'),
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('CompHEP_cmsDriver_cff_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root'),
