...
C...Set massless particle masses to Pythia default. Adjust energy. 
     ...
     $             PUP(3,I)**2)
           ...
           ESUM=ESUM+PUP(4,I)
           PSUM=PSUM+PUP(3,I)
C...Set mother resonance energies
           MOTH=MOTHUP(1,I)
           DO WHILE (MOTH.GT.2)
             PUP(4,MOTH)=PUP(4,MOTH)+PUP(4,I)
             MOTH=MOTHUP(1,MOTH)
           ENDDO
        ENDIF
  120 CONTINUE
