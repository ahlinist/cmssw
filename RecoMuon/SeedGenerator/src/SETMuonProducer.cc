...
SETMuonProducer::~SETMuonProducer(){

  LogTrace("Muon|RecoMuon|SETMuonProducer") 
    << "SETMuonProducer destructor called" << endl;
...
SETMuonProducer::clusterHits( MuonRecHitContainer muonRecHits,  
					      MuonRecHitContainer muonRecHits_DT2D_hasPhi, 
					      MuonRecHitContainer muonRecHits_DT2D_hasZed, 
					      MuonRecHitContainer muonRecHits_RPC) {
...
std::vector <MuonRecHitContainer> SETMuonProducer::
...
std::pair <int, int> SETMuonProducer::// or <bool, bool>
...
std::vector <seedSet> SETMuonProducer::
...
void SETMuonProducer::setEvent(const edm::Event& event){
