  ...
  throw(std::runtime_error)
{
  ...
  try {
    ...
    throw(runtime_error("RunModeDef::fetchID:  "+e.getMessage()));
  }
  ...
  throw(runtime_error)
{
  ...
  try {
   ...
   throw(runtime_error("RunModeDef::setByID:  "+e.getMessage()));
  }
}
  ...
  throw(std::runtime_error)
{
  ...
  try {
    ...
    throw(runtime_error("RunModeDef::fetchAllDefs:  "+e.getMessage()));
  }
}
