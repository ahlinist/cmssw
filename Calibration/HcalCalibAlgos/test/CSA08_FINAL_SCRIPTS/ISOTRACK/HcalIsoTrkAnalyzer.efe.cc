...
//         Updated: Efe Y., Radek O., Anton A., Grigory S.
//         The output txt file is the input to the L3 code.    
...
private:
  ...
  TH1F* h_mip_resp_20GeV_eta_0_03;
  TH1F* h_mip_resp_20GeV_eta_03_06;
  TH1F* h_mip_resp_20GeV_eta_06_1;

  TH1F* h_mip_resp_50GeV_eta_0_03;
  TH1F* h_mip_resp_50GeV_eta_03_06;
  TH1F* h_mip_resp_50GeV_eta_06_1;

  TH1F* Validation_50GeV_eta_lt_1point1;
  TH1F* Validation_50GeV_eta_gt_1point1_lt_1point6;
  TH1F* Validation_50GeV_eta_gt_1point6_lt_2point2;
...
// rof end
  ...
  for (reco::TrackCollection::const_iterator it = isoTrack.begin(); it!=isoTrack.end(); it++)
	...
	if (calEnergy > 15. && calEnergy < 25. && abs(trackEta) < 1.0) h_mip_resp_eta_lt_1_20->Fill(HcalAxBxDepthEnergy/calEnergy);
        ...
        if (calEnergy > 15. && calEnergy < 25. && abs(trackEta) < 0.3) h_mip_resp_20GeV_eta_0_03->Fill(HcalAxBxDepthEnergy/calEnergy);
	if (calEnergy > 15. && calEnergy < 25. && abs(trackEta) > 0.3 && abs(trackEta) < 0.6) h_mip_resp_20GeV_eta_03_06->Fill(HcalAxBxDepthEnergy/calEnergy);
	if (calEnergy > 15. && calEnergy < 25. && abs(trackEta) > 0.6 && abs(trackEta) < 1.0) h_mip_resp_20GeV_eta_06_1->Fill(HcalAxBxDepthEnergy/calEnergy);
	if (calEnergy > 40. && calEnergy < 60. && abs(trackEta) < 0.3) h_mip_resp_50GeV_eta_0_03->Fill(HcalAxBxDepthEnergy/calEnergy);
	if (calEnergy > 40. && calEnergy < 60. && abs(trackEta) > 0.3 && abs(trackEta) < 0.6) h_mip_resp_50GeV_eta_03_06->Fill(HcalAxBxDepthEnergy/calEnergy);
	if (calEnergy > 40. && calEnergy < 60. && abs(trackEta) > 0.6  && abs(trackEta) < 1.0) h_mip_resp_50GeV_eta_06_1->Fill(HcalAxBxDepthEnergy/calEnergy);

	/////////
        if (calEnergy > 40. && calEnergy < 60. && abs(trackEta) < 1.1) Validation_50GeV_eta_lt_1point1->Fill(HcalAxBxDepthEnergy/calEnergy);
        if (calEnergy > 40. && calEnergy < 60. && abs(trackEta) > 1.1 && abs(trackEta)<1.6) Validation_50GeV_eta_gt_1point1_lt_1point6->Fill(HcalAxBxDepthEnergy/calEnergy);
	if (calEnergy > 40. && calEnergy < 60. && abs(trackEta) > 1.6 && abs(trackEta)<2.2) Validation_50GeV_eta_gt_1point6_lt_2point2->Fill(HcalAxBxDepthEnergy/calEnergy);
...
HcalIsoTrkAnalyzer::beginJob(const edm::EventSetup&)
{
  ...
  h_mip_resp_20GeV_eta_0_03 = new TH1F(" h_mip_resp_20GeV_eta_0_03","MIP RESP Barrel 15<P_{trk}<25 GeV/c, 0.0<|#eta|<0.3", 100,0.,4.);
  h_mip_resp_20GeV_eta_03_06 = new TH1F("h_mip_resp_20GeV_eta_03_06","MIP RESP Barrel 15<P_{trk}<25 GeV/c, 0.3<|#eta|<0.6", 100,0.,4.);
  h_mip_resp_20GeV_eta_06_1 = new TH1F("h_mip_resp_20GeV_eta_06_1","MIP RESP Barrel 15<P_{trk}<25 GeV/c, 0.6<|#eta|<1.0", 100,0.,4.);

  h_mip_resp_50GeV_eta_0_03 = new TH1F("h_mip_resp_50GeV_eta_0_03","MIP RESP Barrel 40<P_{trk}<60 GeV/c, 0.0<|#eta|<0.3", 100,0.,4.);
  h_mip_resp_50GeV_eta_03_06 = new TH1F("h_mip_resp_50GeV_eta_03_06","MIP RESP Barrel 40<P_{trk}<60 GeV/c, 0.3<|#eta|<0.6", 100,0.,4.);
  h_mip_resp_50GeV_eta_06_1 = new TH1F("h_mip_resp_50GeV_eta_06_1","MIP RESP Barrel 40<P_{trk}<60 GeV/c, 0.6<|#eta|<1.0", 100,0.,4.);
  ...
  Validation_50GeV_eta_lt_1point1 = new TH1F("","MIP RESP |#eta|<1.1 & 40<p_{trk}<50 GeV/c",100,0.,4.);
  Validation_50GeV_eta_gt_1point1_lt_1point6 = new TH1F("","MIP RESP 1.1<|#eta|<1.6 & 40<p_{trk}<50 GeV/c",100,0.,4.);
  Validation_50GeV_eta_gt_1point6_lt_2point2 = new TH1F("","MIP RESP 1.6<|#eta|<2.2 & 40<p_{trk}<50 GeV/c",100,0.,4.);
...
HcalIsoTrkAnalyzer::endJob() {
  ...
  */
  ...
  h_mip_resp_20GeV_eta_0_03->Write();
  h_mip_resp_20GeV_eta_03_06->Write();
  h_mip_resp_20GeV_eta_06_1->Write();

  h_mip_resp_50GeV_eta_0_03->Write();
  h_mip_resp_50GeV_eta_03_06->Write();
  h_mip_resp_50GeV_eta_06_1->Write();

  Validation_50GeV_eta_lt_1point1->Write();
  Validation_50GeV_eta_gt_1point1_lt_1point6->Write();
  Validation_50GeV_eta_gt_1point6_lt_2point2->Write();
