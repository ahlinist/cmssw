...
gStyle->SetOptFit(111);
   ...
   FILE *Out2 = fopen("coef_without_noise_10mln.txt", "w+");
...
//   if( eta == 1) cout<<"Noise subd "<<subd<<" "<<eta<<" "<<phi<<" "<<dep<<" "<<plnoise[eta][phi][dep][subd]<<endl;   
   ...
   std::ifstream in21( "MINBIAS/var_minbias_10mln.txt" );
...
//   if( eta == 1) cout<<"Minbias subd "<<subd<<" "<<eta<<" "<<phi<<" "<<dep<<" "<<plmeang_nn[eta][phi][dep][subd]<<endl;   
