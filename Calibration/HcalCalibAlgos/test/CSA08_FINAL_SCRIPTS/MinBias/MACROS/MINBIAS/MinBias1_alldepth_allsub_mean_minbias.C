...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   FILE *Out1 = fopen("coef_mean_10mln_1pb.txt", "w+");  
   FILE *Out2 = fopen("mean_minbias_10mln_1pb.txt", "w+");
...
// Calculation of dispersion ===============================
	 ...
	 minmeang[abs(ieta)][iphi][depth][mysubd]=minmeang[abs(ieta)][iphi][depth][mysubd] + (float)mean;
         minmeang_nn[abs(ieta)][iphi][depth][mysubd]=minmeang_nn[abs(ieta)][iphi][depth][mysubd] + (float)mean - minnoise[abs(ieta)][iphi][depth][mysubd];         
	 minmean[abs(ieta)][depth][mysubd]=minmean[abs(ieta)][depth][mysubd] + (float)mean;
	 minmean_nn[abs(ieta)][depth][mysubd]=minmean_nn[abs(ieta)][depth][mysubd] + (float)mean - minnoise[abs(ieta)][iphi][depth][mysubd];
...
// Calculation of dispersion ===============================
	  ...
	  plmeang[ieta][iphi][depth][mysubd]=plmeang[ieta][iphi][depth][mysubd] + (float)mean;
          plmeang_nn[ieta][iphi][depth][mysubd]=plmeang_nn[ieta][iphi][depth][mysubd] + (float)mean - plnoise[abs(ieta)][iphi][depth][mysubd];
	  plmean[ieta][depth][mysubd]=plmean[ieta][depth][mysubd] + (float)mean;
          plmean_nn[abs(ieta)][depth][mysubd]=plmean_nn[abs(ieta)][depth][mysubd] + (float)mean - plnoise[abs(ieta)][iphi][depth][mysubd];
