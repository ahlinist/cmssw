...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   FILE *Out1 = fopen("coef_10mln.txt", "w+");  
   FILE *Out2 = fopen("var_minbias_10mln.txt", "w+");
...
// for all readouts (eta, depth) 1 (-ieta), 2 (+ieta)
   ...
   std::ifstream in20( "../NOISE/var_noise_2mln.txt" );
   string line;
