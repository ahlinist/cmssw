...
gStyle->SetOptFit(111);
   Float_t plmeang_nn[80][80][5][5],plnoise[80][80][5][5];
   Float_t minmeang_nn[80][80][5][5],minnoise[80][80][5][5];
   
   FILE *Out1 = fopen("coef_with_noise_mean.txt", "w+");  
   FILE *Out2 = fopen("coef_without_noise_10mln_mean.txt", "w+");
   std::string line;
/*
   cout<<" Read "<<endl;
...
*/   
   std::ifstream in21( "MINBIAS/mean_minbias_10mln_1pb.txt" );
...
//    if( k == 2 && j == 1 && i == 16 ) cout<<plmeang_nn[i][j][idep][k]<<endl;
   ...
   TH2F  *h12mlnetameanpl1 = new TH2F("h12mlnetameanpl1", "h12mlnetameanpl1", 42, 0.5, 42.5, 100, 0.0000001, 2.);   
   TH2F  *h12mlnetameanmin1 = new TH2F("h12mlnetameanmin1", "h12mlnetameanmin1", 42, 0.5, 42.5, 100, 0.0000001, 2.);
...
//    
    ...
    TH1F  *h12mlnetacoefpl30 = new TH1F("h12mlnetacoefpl30", "h12mlnetacoefpl30", 100, 0., 2.);
    TH1F  *h12mlnetacoefpl30_noise = new TH1F("h12mlnetacoefpl30_noise", "h12mlnetacoefpl30_noise", 100, 0., 2.);
    TH1F  *h12mlnetacoefpl31 = new TH1F("h12mlnetacoefpl31", "h12mlnetacoefpl31", 100, 0., 2.);
    TH1F  *h12mlnetacoefpl31_noise = new TH1F("h12mlnetacoefpl31_noise", "h12mlnetacoefpl31_noise", 100, 0., 2.);
    TH1F  *h12mlnetacoefpl32 = new TH1F("h12mlnetacoefpl32", "h12mlnetacoefpl32", 100, 0., 2.);
    TH1F  *h12mlnetacoefpl32_noise = new TH1F("h12mlnetacoefpl32_noise", "h12mlnetacoefpl32_noise", 100, 0., 2.);
    TH1F  *h12mlnetacoefpl33 = new TH1F("h12mlnetacoefpl33", "h12mlnetacoefpl33", 100, 0., 2.);
    TH1F  *h12mlnetacoefpl33_noise = new TH1F("h12mlnetacoefpl33_noise", "h12mlnetacoefpl33_noise", 100, 0., 2.);
    TH1F  *h12mlnetacoefpl34 = new TH1F("h12mlnetacoefpl34", "h12mlnetacoefpl34", 100, 0., 2.);
    TH1F  *h12mlnetacoefpl34_noise = new TH1F("h12mlnetacoefpl34_noise", "h12mlnetacoefpl34_noise", 100, 0., 2.);
    TH1F  *h12mlnetacoefpl35 = new TH1F("h12mlnetacoefpl35", "h12mlnetacoefpl35", 100, 0., 2.);
    TH1F  *h12mlnetacoefpl35_noise = new TH1F("h12mlnetacoefpl35_noise", "h12mlnetacoefpl35_noise", 100, 0., 2.);
    TH1F  *h12mlnetacoefpl36 = new TH1F("h12mlnetacoefpl36", "h12mlnetacoefpl36", 100, 0., 2.);
    TH1F  *h12mlnetacoefpl36_noise = new TH1F("h12mlnetacoefpl36_noise", "h12mlnetacoefpl36_noise", 100, 0., 2.);
    TH1F  *h12mlnetacoefpl37 = new TH1F("h12mlnetacoefpl37", "h12mlnetacoefpl37", 100, 0., 2.);
    TH1F  *h12mlnetacoefpl37_noise = new TH1F("h12mlnetacoefpl37_noise", "h12mlnetacoefpl37_noise", 100, 0., 2.);
    TH1F  *h12mlnetacoefpl38 = new TH1F("h12mlnetacoefpl38", "h12mlnetacoefpl38", 100, 0., 2.);
    TH1F  *h12mlnetacoefpl38_noise = new TH1F("h12mlnetacoefpl38_noise", "h12mlnetacoefpl38_noise", 100, 0., 2.);
    TH1F  *h12mlnetacoefpl39 = new TH1F("h12mlnetacoefpl39", "h12mlnetacoefpl39", 100, 0., 2.);
    TH1F  *h12mlnetacoefpl39_noise = new TH1F("h12mlnetacoefpl39_noise", "h12mlnetacoefpl39_noise", 100, 0., 2.);
    TH1F  *h12mlnetacoefpl40 = new TH1F("h12mlnetacoefpl40", "h12mlnetacoefpl40", 100, 0., 2.);
    TH1F  *h12mlnetacoefpl40_noise = new TH1F("h12mlnetacoefpl40_noise", "h12mlnetacoefpl40_noise", 100, 0., 2.);
    TH1F  *h12mlnetacoefpl41 = new TH1F("h12mlnetacoefpl41", "h12mlnetacoefpl41", 100, 0., 2.);
    TH1F  *h12mlnetacoefpl41_noise = new TH1F("h12mlnetacoefpl41_noise", "h12mlnetacoefpl41_noise", 100, 0., 2.);
...
*/
    ...
    {
       if( k == 1 && i>16) continue;
       if(k == 2 && (i<17 || i>29)) continue;
       if(k == 4 && i<29) continue;
//    for (Int_t j=1; j<73; j++)
//    {
        cout<<" i "<<i<<" "<<plmean1[i][idep][k]<<" "<<minmean1[i][idep][k]<<endl;
        h12mlnetameanpl1->Fill((float)i,plmean1[i][idep][k]);
	h12mlnetameanmin1->Fill((float)i,minmean1[i][idep][k]);
    /*
...
//    h12mlnetacoefdist->Fit("gaus","","",0.8,1.1);
     h12mlnetameanpl1->Draw();

     TFile efile("coefficients_12mln.root","recreate");
     h12mlnetameanpl1->Write();
     h12mlnetameanmin1->Write();
     /*
