#ifndef MBUEAnalysisRootpleProducer_H
#define MBUEAnalysisRootpleProducer_H
...
class MBUEAnalysisRootpleProducer : public edm::EDAnalyzer
{
  
public:
  
  //
  explicit MBUEAnalysisRootpleProducer( const edm::ParameterSet& ) ;
  virtual ~MBUEAnalysisRootpleProducer() {} // no need to delete ROOT stuff
