#ifndef MBUEAnalysisRootpleProducerOnlyMC_H
#define MBUEAnalysisRootpleProducerOnlyMC_H
...
class MBUEAnalysisRootpleProducerOnlyMC : public edm::EDAnalyzer
{
  
public:
  
  //
  explicit MBUEAnalysisRootpleProducerOnlyMC( const edm::ParameterSet& ) ;
  virtual ~MBUEAnalysisRootpleProducerOnlyMC() {} // no need to delete ROOT stuff
