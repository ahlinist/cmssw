cat > CSA07Egamma_DiElectrons_pt$1_GEN_SIM.cfg <<EOF
process Sim  = {
   ...
   untracked PSet configurationMetadata = {
           ...
           untracked string annotation = "back-to-back e+e-; fixed pt=$1 GeV"
   }
  ...
  include "Configuration/EventContent/data/EventContent.cff"
   ...
   module GEN-SIM = PoolOutputModule
   {
        ...
        untracked string fileName = "file:DiElectrons_pt$1.root"
