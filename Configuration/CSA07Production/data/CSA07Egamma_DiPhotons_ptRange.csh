cat > CSA07Egamma_DiPhotons_pt$1to$2_GEN_SIM.cfg <<EOF
process Sim  = {

   untracked PSet maxEvents = {untracked int32 input = 250000}
   ...
   untracked PSet configurationMetadata = {
           ...
           untracked string annotation = "back-to-back photons; flat pt spectrum between $1 and $2 GeV"
   }
...
#   replace MessageLogger.cerr.default.limit = 10
  ...
  include "Configuration/EventContent/data/EventContent.cff"
   ...
   module GEN-SIM = PoolOutputModule
   {
        ...
        untracked string fileName = "file:DiPhotons_pt$1to$2.root"
