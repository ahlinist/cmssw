...
mixWithPileUp = cms.EDFilter("MixingModule",
    input = cms.SecSource("PoolRASource",
        seed = cms.int32(1234567),
        type = cms.string('poisson'),
        fileNames = cms.untracked.vstring('/store/MC/2006/10/23/MC-110-os-minbias/2076379F-6B63-DB11-AC13-001731AF685B.root', 
...
mixWithPileUpTest = cms.EDFilter("MixingModule",
    input = cms.SecSource("PoolRASource",
        seed = cms.int32(1234567),
...
mixNoPileup = cms.EDFilter("MixingModule",
    bunchspace = cms.int32(25),
    maxBunch = cms.int32(3),
    minBunch = cms.int32(-5),
    Label = cms.string('')
