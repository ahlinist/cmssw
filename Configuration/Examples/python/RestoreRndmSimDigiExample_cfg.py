...
process.source = cms.Source("PoolSource",
    skipEvents = cms.untracked.uint32(3), ## skip the first 3 events,  ## skip the first 3 events, 
...
process.RandomNumberGeneratorService = cms.Service("RandomNumberGeneratorService",
    restoreStateLabel = cms.untracked.string('rndmStore'), ## this label MUST correspond ## this label MUST correspond
