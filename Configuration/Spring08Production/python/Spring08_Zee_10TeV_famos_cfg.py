...
#SOURCE#########################
process.load("Configuration.Spring08Production.Spring08_Zee_10TeV_cfi")
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/Spring08Production/data/Spring08_Zee_10TeV_famos.cfg,v $'),
    annotation = cms.untracked.string('Z/gamma* to ee sample, M(ee) gt40 GeV')
)
...
process.MCfilter = cms.Sequence(process.genParticles*process.eegenfilter)
