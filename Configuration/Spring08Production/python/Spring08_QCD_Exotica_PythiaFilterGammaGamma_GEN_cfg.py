...
#  
process.load("Configuration.Spring08Production.Spring08_QCD_Exotica_Pythia_cfi")
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/Spring08Production/data/Spring08_QCD_Exotica_PythiaFilterGammaGamma_GEN.cfg,v $'),
...
process.GEN = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('PythiaQCDExoticaFilterGG.root')
)
