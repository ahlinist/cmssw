...
#SOURCE#########################
process.load("Configuration.Spring08Production.Spring08_JetMET_PhotonJetsBkg_EtGamma_27_33_10TeV_cfi")
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/Spring08Production/data/Spring08_JetMET_PhotonJetsBkg_EtGamma_27_33_10TeV_famos.cfg,v $'),
    annotation = cms.untracked.string('JetMET_PhotonJetsBkg_EtGamma_27_33')
)
