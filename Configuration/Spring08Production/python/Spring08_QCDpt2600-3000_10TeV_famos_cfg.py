...
process.load("Configuration.Spring08Production.Spring08_QCDpt2600_3000_10TeV_cfi")
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/Spring08Production/data/Spring08_QCDpt2600-3000_10TeV_famos.cfg,v $'),
    annotation = cms.untracked.string('QCDpt2600-3000')
)
