...
#  
process.load("Configuration.Spring08Production.Spring08_Gamma_Jets_Exotica_Pythia_cfi")
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/Spring08Production/data/Spring08_Gamma_Jets_Exotica_PythiaFilterGammaGamma_GEN.cfg,v $'),
...
process.filter = cms.EDFilter("PythiaFilterGammaGamma",
    ...
    NTkConeSum = cms.untracked.int32(1),
    ...
    InvMassWide = cms.untracked.double(500.0),
    EtaTkThr = cms.untracked.double(2.2),
    PtElThr = cms.untracked.double(2.0),
    NTkConeMax = cms.untracked.int32(1),
    ...
    PtMinCandidate1 = cms.untracked.double(80.0),
...
process.GEN = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('PythiaGammaJetsExoticaFilterGG.root')
)
