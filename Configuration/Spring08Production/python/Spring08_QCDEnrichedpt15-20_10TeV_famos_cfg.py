...
process.load("Configuration.Spring08Production.Spring08_QCDEnrichedpt15_20_10TeV_cfi")
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/Spring08Production/data/Spring08_QCDEnrichedpt15-20_10TeV_famos.cfg,v $'),
    annotation = cms.untracked.string('QCDEnrichedpt15-20')
)
