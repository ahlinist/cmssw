...
process.load("Configuration.Spring08Production.Spring08_BCToEFilter_QCD_Pt_80_170_10TeV_cfi")
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('generation of QCD pthat 80-170, with bctoe filter applied')
)
