...
process.load("Configuration.Spring08Production.Spring08_HcalIsoTrack_QCDpt50_inf_10TeV_cfi")
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/Spring08Production/data/Spring08_HcalIsoTrack_QCDpt50-inf_10TeV_famos.cfg,v $'),
    annotation = cms.untracked.string('HcalIsoTrack_QCDpt50-inf')
)
