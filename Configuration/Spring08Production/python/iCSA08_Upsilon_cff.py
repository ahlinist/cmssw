...
source = cms.Source("PythiaSource",
    ...
    filterEfficiency = cms.untracked.double(0.0988),
    pythiaHepMCVerbosity = cms.untracked.bool(False),
    crossSection = cms.untracked.double(19067.0),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/Spring08Production/data/iCSA08_Upsilon.cff,v $'),
