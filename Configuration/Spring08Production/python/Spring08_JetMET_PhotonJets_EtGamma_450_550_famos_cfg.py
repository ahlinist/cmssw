...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/Spring08Production/data/Spring08_JetMET_PhotonJets_EtGamma_450_550_famos.cfg,v $'),
