...
#SOURCE#########################
process.load("Configuration.Spring08Production.Spring08_Zmumu_10TeV_cfi")
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/Spring08Production/data/Spring08_Zmumu_10TeV_famos.cfg,v $'),
    annotation = cms.untracked.string('Z/gamma* to mumu sample, M(mumu) gt40 GeV')
)
...
process.MCfilter = cms.Sequence(process.genParticles*process.mumugenfilter)
