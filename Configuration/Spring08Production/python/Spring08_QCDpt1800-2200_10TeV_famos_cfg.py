...
process.load("Configuration.Spring08Production.Spring08_QCDpt1800_2200_10TeV_cfi")
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/Spring08Production/data/Spring08_QCDpt1800-2200_10TeV_famos.cfg,v $'),
    annotation = cms.untracked.string('QCDpt1800-2200')
)
