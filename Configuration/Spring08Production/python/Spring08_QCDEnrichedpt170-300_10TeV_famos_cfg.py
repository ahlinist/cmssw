...
process.load("Configuration.Spring08Production.Spring08_QCDEnrichedpt170_300_10TeV_cfi")
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/Spring08Production/data/Spring08_QCDEnrichedpt170-300_10TeV_famos.cfg,v $'),
    annotation = cms.untracked.string('QCDEnrichedpt170-300')
)
