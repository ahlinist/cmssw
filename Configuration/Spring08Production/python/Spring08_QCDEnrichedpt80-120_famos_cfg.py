...
process.load("Configuration.Spring08Production.Spring08_QCDEnrichedpt80_120_cfi")
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/Spring08Production/data/Spring08_QCDEnrichedpt80-120_famos.cfg,v $'),
