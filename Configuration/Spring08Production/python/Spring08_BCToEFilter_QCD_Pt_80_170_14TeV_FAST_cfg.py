...
#SOURCE#########################
process.load("Configuration.Spring08Production.Spring08_BCToEFilter_QCD_Pt_80_170_14TeV_cfi")
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('b/c->e filtered QCD Pthat 80-170')
)
