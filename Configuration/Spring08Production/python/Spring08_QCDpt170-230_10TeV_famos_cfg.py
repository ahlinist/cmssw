...
process.load("Configuration.Spring08Production.Spring08_QCDpt170_230_10TeV_cfi")
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/Spring08Production/data/Spring08_QCDpt170-230_10TeV_famos.cfg,v $'),
    annotation = cms.untracked.string('QCDpt170-230')
)
