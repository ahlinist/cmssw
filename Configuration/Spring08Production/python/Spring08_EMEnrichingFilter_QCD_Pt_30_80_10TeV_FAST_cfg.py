...
#SOURCE#########################
process.load("Configuration.Spring08Production.Spring08_EMEnrichingFilter_QCD_Pt_30_80_10TeV_cfi")
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('em-enriched QCD Pthat 30-80')
)
