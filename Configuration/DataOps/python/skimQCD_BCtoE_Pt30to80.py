...
process.MessageLogger = cms.Service("MessageLogger",
    destinations = cms.untracked.vstring('log/skimQCD_BCtoE_Pt30to80.log')
    )
...
process.maxEvents = cms.untracked.PSet(
    input = cms.untracked.int32(192000000)
)
...
'file:/data/rossin/CMS/Triggers/Summer09/QCD_BCtoE_Pt30to80/GEN-SIM-RECO/MC_31X_V3-v1/0015/0A55777F-FF83-DE11-927E-001D096B0E9F.root',
#'file:/data/rossin/CMS/Triggers/Summer09/QCD_BCtoE_Pt30to80/GEN-SIM-RECO/MC_31X_V3-v1/0015/0A98842A-CA81-DE11-A6E7-0015178C4B08.root',
#'file:/data/rossin/CMS/Triggers/Summer09/QCD_BCtoE_Pt30to80/GEN-SIM-RECO/MC_31X_V3-v1/0015/0CB81A90-CA81-DE11-A43E-0015178C18F0.root',
#'file:/data/rossin/CMS/Triggers/Summer09/QCD_BCtoE_Pt30to80/GEN-SIM-RECO/MC_31X_V3-v1/0015/0E7BB8CC-F282-DE11-A979-001D0967D2E7.root',
#'file:/data/rossin/CMS/Triggers/Summer09/QCD_BCtoE_Pt30to80/GEN-SIM-RECO/MC_31X_V3-v1/0015/24BF5577-CA81-DE11-82FF-001D0967D25B.root',
#'file:/data/rossin/CMS/Triggers/Summer09/QCD_BCtoE_Pt30to80/GEN-SIM-RECO/MC_31X_V3-v1/0015/284C260B-D581-DE11-866E-00151796C1D0.root',
#'file:/data/rossin/CMS/Triggers/Summer09/QCD_BCtoE_Pt30to80/GEN-SIM-RECO/MC_31X_V3-v1/0015/28BA3ECE-C781-DE11-A3AE-0015178C6A34.root',
#'file:/data/rossin/CMS/Triggers/Summer09/QCD_BCtoE_Pt30to80/GEN-SIM-RECO/MC_31X_V3-v1/0015/3448B52E-CA81-DE11-9AF4-0015178C49A4.root',
#'file:/data/rossin/CMS/Triggers/Summer09/QCD_BCtoE_Pt30to80/GEN-SIM-RECO/MC_31X_V3-v1/0015/42889271-7D83-DE11-BFF0-001D0967DDC3.root',
#'file:/data/rossin/CMS/Triggers/Summer09/QCD_BCtoE_Pt30to80/GEN-SIM-RECO/MC_31X_V3-v1/0015/58771781-FC83-DE11-AE63-0015178C6728.root',
#'file:/data/rossin/CMS/Triggers/Summer09/QCD_BCtoE_Pt30to80/GEN-SIM-RECO/MC_31X_V3-v1/0015/58C545F3-C481-DE11-9E6D-00151796D6EC.root',
#'file:/data/rossin/CMS/Triggers/Summer09/QCD_BCtoE_Pt30to80/GEN-SIM-RECO/MC_31X_V3-v1/0015/82602634-F281-DE11-BBB8-00151796D538.root',
#'file:/data/rossin/CMS/Triggers/Summer09/QCD_BCtoE_Pt30to80/GEN-SIM-RECO/MC_31X_V3-v1/0015/A0B01AD4-C781-DE11-99BE-0015178C674C.root',
#'file:/data/rossin/CMS/Triggers/Summer09/QCD_BCtoE_Pt30to80/GEN-SIM-RECO/MC_31X_V3-v1/0015/B48A2C0B-FD83-DE11-BB2F-001D0967D567.root',
#'file:/data/rossin/CMS/Triggers/Summer09/QCD_BCtoE_Pt30to80/GEN-SIM-RECO/MC_31X_V3-v1/0015/E49D4ED3-C781-DE11-B39F-001D096B0C83.root'
    )
)
...
process.output1 = cms.OutputModule("PoolOutputModule",
                                   ...
                                   fileName = cms.untracked.string('/data/rossin/CMS/Triggers/SDexercise/SD_Ele10_QCD_BCtoE_Pt30to80.root'),
...
process.output2 = cms.OutputModule("PoolOutputModule",
                                   splitLevel = cms.untracked.int32(0),
                                   outputCommands = cms.untracked.vstring('keep *'),
                                   fileName = cms.untracked.string('/data/rossin/CMS/Triggers/SDexercise/SD_Ele10_EleId_QCD_BCtoE_Pt30to80.root'),
                                   dataset = cms.untracked.PSet(
                                      dataTier = cms.untracked.string('GEN-SIM-RECO'),
...
process.output3 = cms.OutputModule("PoolOutputModule",
                                   splitLevel = cms.untracked.int32(0),
                                   outputCommands = cms.untracked.vstring('keep *'),
                                   fileName = cms.untracked.string('/data/rossin/CMS/Triggers/SDexercise/SD_Ele15_QCD_BCtoE_Pt30to80.root'),
                                   dataset = cms.untracked.PSet(
                                      dataTier = cms.untracked.string('GEN-SIM-RECO'),
...
process.output4 = cms.OutputModule("PoolOutputModule",
                                   splitLevel = cms.untracked.int32(0),
                                   outputCommands = cms.untracked.vstring('keep *'),
                                   fileName = cms.untracked.string('/data/rossin/CMS/Triggers/SDexercise/SD_Photon15_QCD_BCtoE_Pt30to80.root'),
                                   dataset = cms.untracked.PSet(
                                      dataTier = cms.untracked.string('GEN-SIM-RECO'),
...
process.output5 = cms.OutputModule("PoolOutputModule",
                                   splitLevel = cms.untracked.int32(0),
                                   outputCommands = cms.untracked.vstring('keep *'),
                                   fileName = cms.untracked.string('/data/rossin/CMS/Triggers/SDexercise/SD_Photon20_QCD_BCtoE_Pt30to80.root'),
                                   dataset = cms.untracked.PSet(
                                      dataTier = cms.untracked.string('GEN-SIM-RECO'),
...
process.output6 = cms.OutputModule("PoolOutputModule",
                                   splitLevel = cms.untracked.int32(0),
                                   outputCommands = cms.untracked.vstring('keep *'),
                                   fileName = cms.untracked.string('/data/rossin/CMS/Triggers/SDexercise/SD_SingleLooseTau20_QCD_BCtoE_Pt30to80.root'),
                                   dataset = cms.untracked.PSet(
                                      dataTier = cms.untracked.string('GEN-SIM-RECO'),
...
process.output7 = cms.OutputModule("PoolOutputModule",
                                   splitLevel = cms.untracked.int32(0),
                                   outputCommands = cms.untracked.vstring('keep *'),
                                   fileName = cms.untracked.string('/data/rossin/CMS/Triggers/SDexercise/SD_DoubleLooseTau15_QCD_BCtoE_Pt30to80.root'),
                                   dataset = cms.untracked.PSet(
                                      dataTier = cms.untracked.string('GEN-SIM-RECO'),
