...
# with command line options: step2 -s RAW2DIGI,RECO,ALCA:MuAlCalIsolatedMu+RpcCalHLT+EcalCalPi0Calib+EcalCalEtaCalib,DQM --datatier RECO --eventcontent RECO --conditions FrontierConditions_GlobalTag,MC_31X_V1::All --no_exec
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/backfill/2/data/IansMagicMushroomSoup-T0Test-AnalyzeThisAndGetAFreePhD/JetMonitor/RAW/v9_14_pre14replaythingy_v2/000/000/003/40AB907C-ADA1-DE11-AFB1-001617E30CD4.root')
)
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('step2_RAW2DIGI_RECO_ALCA_DQM.root'),
