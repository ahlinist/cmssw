...
# with command line options: reco -s RAW2DIGI,L1Reco,RECO,DQM,ALCA:SiStripCalZeroBias --data --magField AutoFromDBCurrent --scenario pp --datatier RECO --eventcontent RECO,DQM --customise Configuration/GlobalRuns/reco_TLR_38X.py --cust_function customisePPData --no_exec --python_filename=rereco_2PD_ZeroBias_Collision_38X.py --conditions GR_R_38X_V7::All
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('reco_RAW2DIGI_L1Reco_RECO_DQM_ALCA.root'),
...
# Schedule definition
process.schedule = cms.Schedule(process.raw2digi_step,process.L1Reco_step,process.reconstruction_step,process.dqmoffline_step,process.pathALCARECOSiStripCalZeroBias,process.endjob_step,process.out_step,process.ALCARECOStreamSiStripCalZeroBiasOutPath,process.DQMStreamOutPath)
