...
# with command line options: step2 -s RAW2DIGI,RECO,ALCA:MuAlCalIsolatedMu+RpcCalHLT+EcalCalPi0Calib+EcalCalEtaCalib,DQM --datatier RECO --eventcontent RECO --conditions FrontierConditions_GlobalTag,STARTUP31X_V7::All --data --no_exec
