...
process.hltHighLevelDev.HLTPaths = ("HLT_Ele10_LW_EleId_L1R",)
...
process.hltHighLevelDev3.HLTOverallPrescale = cms.uint32(20)
...
process.hltHighLevelDev4.HLTOverallPrescale = cms.uint32(20)

# Once the hltHighLevelDev filter has been defined I can clone it and configure as needed
process.hltHighLevelDev5 = process.hltHighLevelDev.clone(andOr = True)
process.hltHighLevelDev5.HLTPaths = ("HLT_Ele10_LW_L1R",)
process.hltHighLevelDev5.andOr = True # True = OR, False = AND
process.hltHighLevelDev5.HLTPathsPrescales  = cms.vuint32(10,)
process.hltHighLevelDev5.HLTOverallPrescale = cms.uint32(20)
...
process.MessageLogger = cms.Service("MessageLogger",
    destinations = cms.untracked.vstring('log/skimWenu.log')
    )
...
'file:/data/rossin/CMS/Triggers/Summer09/Wenu/GEN-SIM-RECO/MC_31X_V3-v1/0023/586D5190-0F87-DE11-8C05-003048C56D0C.root',
#'file:/data/rossin/CMS/Triggers/Summer09/Wenu/GEN-SIM-RECO/MC_31X_V3-v1/0023/E631DE0F-1A87-DE11-B553-001F29C99550.root'
    )
)
...
process.output1 = cms.OutputModule("PoolOutputModule",
                                   ...
                                   fileName = cms.untracked.string('/data/rossin/CMS/Triggers/SDexercise/SD_Ele10_EleId_Wenu.root'),
...
process.output2 = cms.OutputModule("PoolOutputModule",
                                   splitLevel = cms.untracked.int32(0),
                                   outputCommands = cms.untracked.vstring('keep *'),
                                   fileName = cms.untracked.string('/data/rossin/CMS/Triggers/SDexercise/SD_Ele15_Wenu.root'),
                                   dataset = cms.untracked.PSet(
                                      dataTier = cms.untracked.string('GEN-SIM-RECO'),
...
process.output3 = cms.OutputModule("PoolOutputModule",
                                   splitLevel = cms.untracked.int32(0),
                                   outputCommands = cms.untracked.vstring('keep *'),
                                   fileName = cms.untracked.string('/data/rossin/CMS/Triggers/SDexercise/SD_Photon15_Wenu.root'),
                                   dataset = cms.untracked.PSet(
                                      dataTier = cms.untracked.string('GEN-SIM-RECO'),
...
process.output4 = cms.OutputModule("PoolOutputModule",
                                   splitLevel = cms.untracked.int32(0),
                                   outputCommands = cms.untracked.vstring('keep *'),
                                   fileName = cms.untracked.string('/data/rossin/CMS/Triggers/SDexercise/SD_Photon20_Wenu.root'),
                                   dataset = cms.untracked.PSet(
                                      dataTier = cms.untracked.string('GEN-SIM-RECO'),
...
process.output5 = cms.OutputModule("PoolOutputModule",
                                   splitLevel = cms.untracked.int32(0),
                                   outputCommands = cms.untracked.vstring('keep *'),
                                   fileName = cms.untracked.string('/data/rossin/CMS/Triggers/SDexercise/SD_Ele10_Wenu.root'),
                                   dataset = cms.untracked.PSet(
                                      dataTier = cms.untracked.string('GEN-SIM-RECO'),
