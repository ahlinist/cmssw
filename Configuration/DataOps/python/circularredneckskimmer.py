...
#        '/store/data/Commissioning09/Test/RECO/v1/000/084/127/6CE9285A-A33A-DE11-8219-001D09F24600.root'
        '/store/data/BeamCommissioning09/MinimumBias/RECO/v2/000/123/592/E609699F-2BE2-DE11-A59D-003048D2C108.root'
...
process.fakeSkimOut1 = cms.OutputModule("PoolOutputModule",
    ...
    dataset = cms.untracked.PSet(
        filterName = cms.untracked.string('LoopyCircularPapaRedneckPreScaleThingy5'),
        dataTier = cms.untracked.string('AOD')
    ),
    parentOutputModule = cms.untracked.string('fakeSkimOut4'),
...
process.fakeSkimOut2 = cms.OutputModule("PoolOutputModule",
    ...
    dataset = cms.untracked.PSet(
    filterName = cms.untracked.string('CircularRedneckPreScaleThingy1'),
    dataTier = cms.untracked.string('AOD')
    ),
    parentOutputModule = cms.untracked.string('fakeSkimOut1'), 
...
process.fakeSkimOut3 = cms.OutputModule("PoolOutputModule",
    ...
    dataset = cms.untracked.PSet(
        filterName = cms.untracked.string('LoopyCircularGrampaRedneckPreScaleThingy10'),
        dataTier = cms.untracked.string('AOD')
    ),
    parentOutputModule = cms.untracked.string('fakeSkimOut4'),
...
process.fakeSkimOut4 = cms.OutputModule("PoolOutputModule",
    ...
    dataset = cms.untracked.PSet(
        filterName = cms.untracked.string('CircularPapaRedneckPreScaleThingy50'),
        dataTier = cms.untracked.string('AOD')
    ),
    parentOutputModule = cms.untracked.string('fakeSkimOut3'),
...
process.fakeSkimOut5 = cms.OutputModule("PoolOutputModule",
    ...
    dataset = cms.untracked.PSet(
        filterName = cms.untracked.string('CircularBabyRedneckPreScaleThingy200'),
