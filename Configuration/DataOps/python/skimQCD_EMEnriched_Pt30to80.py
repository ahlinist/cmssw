...
process.MessageLogger = cms.Service("MessageLogger",
    destinations = cms.untracked.vstring('log/skimQCD_EMEnriched_Pt30to80.log')
    )
...
process.maxEvents = cms.untracked.PSet(
    input = cms.untracked.int32(376000000)
)
...
'file:/data/rossin/CMS/Triggers/Summer09/QCD_EMEnriched_Pt30to80/GEN-SIM-RECO/0451F956-2082-DE11-BE5E-0015C5E59E7F.root',
#'file:/data/rossin/CMS/Triggers/Summer09/QCD_EMEnriched_Pt30to80/GEN-SIM-RECO/082DDFAB-5082-DE11-BA60-00145EDD76E9.root',
#'file:/data/rossin/CMS/Triggers/Summer09/QCD_EMEnriched_Pt30to80/GEN-SIM-RECO/12F712BC-3882-DE11-9264-0015C5E5B288.root',
#'file:/data/rossin/CMS/Triggers/Summer09/QCD_EMEnriched_Pt30to80/GEN-SIM-RECO/14BC04BB-0382-DE11-8E33-00215A491956.root',
#'file:/data/rossin/CMS/Triggers/Summer09/QCD_EMEnriched_Pt30to80/GEN-SIM-RECO/166C6E02-2882-DE11-A066-0015C5E5B961.root',
#'file:/data/rossin/CMS/Triggers/Summer09/QCD_EMEnriched_Pt30to80/GEN-SIM-RECO/26878817-1482-DE11-92C6-00215AA64960.root',
#'file:/data/rossin/CMS/Triggers/Summer09/QCD_EMEnriched_Pt30to80/GEN-SIM-RECO/2AB79C9A-0282-DE11-A843-00215AA62C2A.root',
#'file:/data/rossin/CMS/Triggers/Summer09/QCD_EMEnriched_Pt30to80/GEN-SIM-RECO/2C904DAE-1282-DE11-964A-00215AA62C86.root'
    )
)
...
process.output1 = cms.OutputModule("PoolOutputModule",
                                   ...
                                   fileName = cms.untracked.string('/data/rossin/CMS/Triggers/SDexercise/SD_Ele10_QCD_EMEnriched_Pt30to80.root'),
...
process.output2 = cms.OutputModule("PoolOutputModule",
                                   splitLevel = cms.untracked.int32(0),
                                   outputCommands = cms.untracked.vstring('keep *'),
                                   fileName = cms.untracked.string('/data/rossin/CMS/Triggers/SDexercise/SD_Ele10_EleId_QCD_EMEnriched_Pt30to80.root'),
                                   dataset = cms.untracked.PSet(
                                      dataTier = cms.untracked.string('GEN-SIM-RECO'),
...
process.output3 = cms.OutputModule("PoolOutputModule",
                                   splitLevel = cms.untracked.int32(0),
                                   outputCommands = cms.untracked.vstring('keep *'),
                                   fileName = cms.untracked.string('/data/rossin/CMS/Triggers/SDexercise/SD_Ele15_QCD_EMEnriched_Pt30to80.root'),
                                   dataset = cms.untracked.PSet(
                                      dataTier = cms.untracked.string('GEN-SIM-RECO'),
...
process.output4 = cms.OutputModule("PoolOutputModule",
                                   splitLevel = cms.untracked.int32(0),
                                   outputCommands = cms.untracked.vstring('keep *'),
                                   fileName = cms.untracked.string('/data/rossin/CMS/Triggers/SDexercise/SD_Photon15_QCD_EMEnriched_Pt30to80.root'),
                                   dataset = cms.untracked.PSet(
                                      dataTier = cms.untracked.string('GEN-SIM-RECO'),
...
process.output5 = cms.OutputModule("PoolOutputModule",
                                   splitLevel = cms.untracked.int32(0),
                                   outputCommands = cms.untracked.vstring('keep *'),
                                   fileName = cms.untracked.string('/data/rossin/CMS/Triggers/SDexercise/SD_Photon20_QCD_EMEnriched_Pt30to80.root'),
                                   dataset = cms.untracked.PSet(
                                      dataTier = cms.untracked.string('GEN-SIM-RECO'),
...
process.output6 = cms.OutputModule("PoolOutputModule",
                                   splitLevel = cms.untracked.int32(0),
                                   outputCommands = cms.untracked.vstring('keep *'),
                                   fileName = cms.untracked.string('/data/rossin/CMS/Triggers/SDexercise/SD_SingleLooseTau20_QCD_EMEnriched_Pt30to80.root'),
                                   dataset = cms.untracked.PSet(
                                      dataTier = cms.untracked.string('GEN-SIM-RECO'),
...
process.output7 = cms.OutputModule("PoolOutputModule",
                                   splitLevel = cms.untracked.int32(0),
                                   outputCommands = cms.untracked.vstring('keep *'),
                                   fileName = cms.untracked.string('/data/rossin/CMS/Triggers/SDexercise/SD_DoubleLooseTau15_QCD_EMEnriched_Pt30to80.root'),
                                   dataset = cms.untracked.PSet(
                                      dataTier = cms.untracked.string('GEN-SIM-RECO'),
