...
# with command line options: reco -s RAW2DIGI,L1Reco,RECO,DQM,ALCA:EcalCalElectron --data --magField AutoFromDBCurrent --scenario pp --datatier RECO --eventcontent RECO,DQM --customise Configuration/GlobalRuns/reco_TLR_38X.py --cust_function customisePPData --no_exec --python_filename=rereco_8PD_EG_Collision_38X.py --conditions GR_R_38X_V7::All
...
# Schedule definition
process.schedule = cms.Schedule(process.raw2digi_step,process.L1Reco_step,process.reconstruction_step,process.dqmoffline_step,process.pathALCARECOEcalCalElectron,process.endjob_step,process.out_step,process.ALCARECOStreamEcalCalElectronOutPath,process.DQMStreamOutPath)
