#ifndef CSCRecHitB_CSCRecHitBBuilder_h 
#define CSCRecHitB_CSCRecHitBBuilder_h 
 ...
 * required by CSCRecHitBProducer.
 *
...
class CSCRecHitBBuilder
{
 public:
   ...
   */
  explicit CSCRecHitBBuilder( const edm::ParameterSet& ps);
