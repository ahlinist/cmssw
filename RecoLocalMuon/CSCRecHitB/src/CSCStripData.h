...
{	
 public:	
   ...
   */
  CSCStripData() : x_(-1.), y0_( 0. ), y_( 0. ), y2_( 0. ), t_(-1), tpk_(-1.) {};
  CSCStripData(float x, float y0, float y, float y2, int t, float tpk) : 
                 x_(x),  y0_(y0),   y_(y),  y2_(y2), t_(t),  tpk_(tpk) {};
