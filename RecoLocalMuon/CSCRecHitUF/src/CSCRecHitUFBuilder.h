#ifndef CSCRecHitUF_CSCRecHitUFBuilder_h 
#define CSCRecHitUF_CSCRecHitUFBuilder_h 
 ...
 * required by CSCRecHitUFProducer.
 *
...
class CSCRecHitUFBuilder
{
 public:
   ...
   */
  explicit CSCRecHitUFBuilder( const edm::ParameterSet& ps);  
  ~CSCRecHitUFBuilder();
