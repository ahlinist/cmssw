 ...
 *
 */
bool CSCFindPeakingTime::FindPeakTime( const int& tmax, const float* adc, float& t_zero, float& t_peak ) {
 ...
 *
 */
void CSCFindPeakingTime::FitCharge( const int& tmax, const float* adc, const float& t_zero, const float& t_peak, std::vector<float>& adcsFit ) {
