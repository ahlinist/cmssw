...
// Created:     13.1.2005
//
// $Id: CSCTFTBFrontHeader.cc,v 1.1 2005/02/14 21:01:32 lgray Exp $
...
static const char* const kIdString  = "$Id: CSCTFTBFrontHeader.cc,v 1.1 2005/02/14 21:01:32 lgray Exp $";
