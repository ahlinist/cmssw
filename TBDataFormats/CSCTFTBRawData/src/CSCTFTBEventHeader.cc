...
// Created:     13.1.2005
//
// $Id: CSCTFTBEventHeader.cc,v 1.2 2005/05/13 08:29:59 lgray Exp $
//
// Revision History
...
static const char* const kIdString  = "$Id: CSCTFTBEventHeader.cc,v 1.2 2005/05/13 08:29:59 lgray Exp $";
