...
//load the analysed histo file for dimuon BKG
  TFile *fil1 = new TFile("/home/cms/CMSSW_2_1_0_pre5/src/Test/CMSSW214/DiMuon/DiMuonBkg1.root"); 
  ...
  fHist2muMassRecb->Fit("pol4","R","",7.0,12.0);
  fHist2muMassRecb->Draw("E");
  //get this polinomial parameters
  TF1* fitPoly = (TF1*) fHist2muMassRecb->GetFunction("pol4");
  Double_t * param = fitPoly->GetParameters();

//load the analysed histo file for upsilon signal 
 TFile *fil2 = new TFile("/home/cms/CMSSW_2_1_0_pre5/src/Test/CMSSW214/DiMuon/DiMuonSig.root"); 
...
//add signal+Bkg
 ...
 signal_background->SetParLimits(1,9.3,9.5);
 ...
 signal_background->SetParLimits(4,9.9,10.1);
 ...
 signal_background->SetParLimits(7,10.3,10.5);
 ...
 signal_background->SetParLimits(11,param[2]-5e7,param[2]+5e7);//x*x
 signal_background->SetParLimits(12,param[3]-5e7,param[3]+5e7);//x*x*x
 signal_background->SetParLimits(13,param[4]-5e7,param[4]+5e7);//x*x*x*x
 
 hurec_minv->Fit("signal_background","RI","",7.00,12);
 hurec_minv->Draw("E"); 
 
 TF1* background = new TF1("background","pol4",7,12);
...
//Gaussian parameters
 ...
 signal_background_sub->SetParLimits(1,9.4,9.55);
 ...
 //new TCanvas;
 // signal->Fit("signal_background_sub","RI","",7.0,12.0);
 // signal->Draw("E");  
