// -*- C++ -*-
//
// Package:    DimuonUpRecoSt34
// Class:      DimuonUpRecoSt34
// 
/**\class DimuonUpRecoSt34 DimuonUpRecoSt34.cc UserCode/DimuonUpRecoSt34/src/DimuonUpRecoSt34.cc
...
class DimuonUpRecoSt34 : public edm::EDAnalyzer {
   public:
      explicit DimuonUpRecoSt34(const edm::ParameterSet&);
      ~DimuonUpRecoSt34();
...
//
DimuonUpRecoSt34::DimuonUpRecoSt34(const edm::ParameterSet& iConfig):
...
DimuonUpRecoSt34::~DimuonUpRecoSt34()
{
...
void DimuonUpRecoSt34::beginJob(const edm::EventSetup&){
		...
		h_st3dimuon_eta    = new TH1F( "st3_dimuon_eta", "", 120, -6, 6); 
		//h_st3dimuon_eta    = new TH1F( "st3_dimuon_eta", "St 3 #Upsilon", 120, -6, 6); 
		h_st3dimuon_pt     = new TH1F( "st3_dimuon_pt" , "", 80, 0., 40.); 
		//h_st3dimuon_pt     = new TH1F( "st3_dimuon_pt" , "St3 #Upsilon", 80, 0., 40.); 
		h_st3dimuon_p      = new TH1F( "st3_dimuon_p" , "St3 #Upsilon momentum", 80, 0., 40.);
        h_st3dimuon_mass   = new TH1F( "st3_dimuon_mass", "St3 #Upsilon mass" , 100, 6, 12);
		...
		h_st4dimuon_eta    = new TH1F( "st4_dimuon_eta", "", 120, -6, 6);
		//h_st4dimuon_eta    = new TH1F( "st4_dimuon_eta", "St4 #Upsilon", 120, -6, 6);
		h_st4dimuon_pt     = new TH1F( "st4_dimuon_pt" , "", 80, 0., 40.);
		//h_st4dimuon_pt     = new TH1F( "st4_dimuon_pt" , "St4 #Upsilon", 80, 0., 40.);
        h_st4dimuon_p      = new TH1F( "st4_dimuon_p" , "St4 #Upsilon momentum", 80, 0., 40.);
		h_st4dimuon_mass   = new TH1F( "st4_dimuon_mass", "St4 #Upsilon mass" , 100, 6, 12);

		h_st3dimuon_eta_pt = new TH2F("st3_dimuon_eta_pt","St3 #Upsilon #eta - p_{T}", 100, -8, 8, 100, 0, 40);
		h_st4dimuon_eta_pt = new TH2F("st4_dimuon_eta_pt","St4 #Upsilon #eta - p_{T}", 100, -8, 8, 100, 0, 40);
		
}

									  
void
DimuonUpRecoSt34::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace edm;
...
DEFINE_FWK_MODULE(DimuonUpRecoSt34);
