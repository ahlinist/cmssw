// -*- C++ -*-
//
// Package:    DimuonUpRecoSt12
// Class:      DimuonUpRecoSt12
// 
/**\class DimuonUpRecoSt12 DimuonUpRecoSt12.cc UserCode/DimuonUpRecoSt12/src/DimuonUpRecoSt12.cc
...
class DimuonUpRecoSt12 : public edm::EDAnalyzer {
   public:
      explicit DimuonUpRecoSt12(const edm::ParameterSet&);
      ~DimuonUpRecoSt12();
...
//
DimuonUpRecoSt12::DimuonUpRecoSt12(const edm::ParameterSet& iConfig):
...
DimuonUpRecoSt12::~DimuonUpRecoSt12()
{
...
void DimuonUpRecoSt12::beginJob(const edm::EventSetup&){
		...
		h_st1l1dimuon_mass = new TH1F( "h_st1l1dimuon_mass", "st1 l1dimuon mass" , 100, 6, 12);
	    ...
	    h_st1l1dimuon_eta = new TH1F("h_st1l1dimuon_eta", "", 120, -6.0, 6.0);
	    //h_st1l1dimuon_eta = new TH1F("h_st1l1dimuon_eta", "St 1 #Upsilon", 120, -6.0, 6.0);
	    h_st1l1dimuon_pt = new TH1F("h_st1l1dimuon_pt", "", 80, 0, 40);
	    //h_st1l1dimuon_pt = new TH1F("h_st1l1dimuon_pt", "St 1 #Upsilon", 80, 0, 40);
	    h_st1l1dimuon_DeltaR = new TH1F("h_st1l1dimuon_DeltaR","st1 l1dimuon DeltaR", 100, 0, 2);

		h_st2l2dimuon_mass = new TH1F( "h_st2l2dimuon_mass", "st2 l2dimuon mass" , 100, 6, 12);
		...
		h_st2l2dimuon_eta = new TH1F("h_st2l2dimuon_eta", "", 120, -6.0, 6.0);
		//h_st2l2dimuon_eta = new TH1F("h_st2l2dimuon_eta", "St 2 #Upsilon", 120, -6.0, 6.0);
		h_st2l2dimuon_pt = new TH1F("h_st2l2dimuon_pt", "", 80, 0, 40);
		//h_st2l2dimuon_pt = new TH1F("h_st2l2dimuon_pt", "St 2 #Upsilon", 80, 0, 40);
		h_st2l2dimuon_DeltaR = new TH1F("h_st2l2dimuon_DeltaR","st2 l2dimuon DeltaR", 100, 0, 2);
		
		h_st1dimuon_eta_pt = new TH2F("st1_dimuon_eta_pt","St1 #Upsilon #eta - p_{T}", 100, -8, 8, 100, 0, 40);
		h_st2dimuon_eta_pt = new TH2F("st2_dimuon_eta_pt","St2 #Upsilon #eta - p_{T}", 100, -8, 8, 100, 0, 40);

}

									  
void
DimuonUpRecoSt12::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace edm;
...
DEFINE_FWK_MODULE(DimuonUpRecoSt12);
