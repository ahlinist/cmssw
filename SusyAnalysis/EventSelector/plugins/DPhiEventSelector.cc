...
DPhiEventSelector::DPhiEventSelector(const edm::ParameterSet& pset) :
   SusyEventSelector(pset), jetTag_(pset.getParameter<edm::InputTag> ("jetTag")), maxDPhi_(pset.getParameter<double> (
            "maxDPhi")) {
...
//________________________________________________________________________________________
bool DPhiEventSelector::select(const edm::Event& event) const {
