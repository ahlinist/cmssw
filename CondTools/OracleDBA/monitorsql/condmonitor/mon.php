...
<head>
  ...
  <title>
    <?php print(($title = "Monitor tool for ".strtoupper($svr)." developers objects")."\n"); ?>
  </title>
...
<script language="php">
  ...
  ociexecute($stmt = ociparse($conn, "select * from $usr.cond_occupancy"));
  ...
  for($i = 0; $i < $nrows; $i++) {
    print("  <tr>\n");
    print("    <td class=\"p2k\">\n      <a href=\"javascript:see('detdetails.php?svr=$svr&det=".($t = $results['USERNAME'][$i])."');\" class=\"p2k\">$t</a>\n    </td>\n");
    print("    <td class=\"md\">\n      ".(ereg("_R$", $t)? "-": "<a href=\"javascript:see('detactivity.php?svr=$svr&det=$t');\" class=\"p2k\"><img src=\"show.gif\" border=\"0\"></a>")."\n    </td>\n");
...
<p class="bo">
  ...
  Created on August 3<sup>rd</sup>, 2007, its source code has been last updated on October 23<sup>rd</sup>, 2008.
  <br>
