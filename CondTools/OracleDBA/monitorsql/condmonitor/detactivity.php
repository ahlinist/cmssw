...
<script language="php">
  ...
  ociexecute($stmt = ociparse($conn, "select what as statement, to_char(when, 'FMDay DD Month YYYY') || to_char(when, ' HH24:MI') as \"DATE & TIME\" from $usr.server_workload where who = '$det'"));
...
<p class="bo">
  Here you will find only recently executed SQL statements, still present in the server memory.
  <br>
