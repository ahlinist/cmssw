#include "CondTools/CSC/interface/CSCDDUMapHandler.h"
#include "FWCore/ParameterSet/interface/ParameterSetfwd.h"
#include<iostream>

#include "CondFormats/CSCObjects/interface/CSCDDUMap.h"
#include "CondTools/CSC/interface/CSCDDUMapValues.h"

popcon::CSCDDUMapImpl::CSCDDUMapImpl(const edm::ParameterSet& pset): m_name(pset.getUntrackedParameter<std::string>("name","CSCDDUMapImpl"))
{}
