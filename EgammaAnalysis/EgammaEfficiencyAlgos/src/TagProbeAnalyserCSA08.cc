...
// -*- C++ -*-
//
// Package:    TagProbeAnalyserCSA08
// Class:      TagProbeAnalyserCSA08
// 
/**\class TagProbeAnalyserCSA08 TagProbeAnalyserCSA08.cc 
   EgammaAnalysis/EgammaEfficiencyAlgos/src/TagProbeAnalyserCSA08.cc
...
#include "EgammaAnalysis/EgammaEfficiencyAlgos/interface/TagProbeAnalyserCSA08.h" 
// this is included for the CalcDR_Val function
#include <cmath>
#include "HLTrigger/HLTcore/interface/TriggerSummaryAnalyzerAOD.h"
#include "DataFormats/HLTReco/interface/TriggerEvent.h"

TagProbeAnalyserCSA08::TagProbeAnalyserCSA08(const edm::ParameterSet& ps)
...
TagProbeAnalyserCSA08::~TagProbeAnalyserCSA08()
{
   histofile->Close();
...
void TagProbeAnalyserCSA08::analyze(const edm::Event& evt, const edm::EventSetup& es)
{
  edm::LogInfo("") << "Analyse";
  //get MC collection
...
void 
TagProbeAnalyserCSA08::beginJob(const edm::EventSetup&)
{
...
double TagProbeAnalyserCSA08::CalcDR_Val(double eta1, double eta2
...
DEFINE_FWK_MODULE(TagProbeAnalyserCSA08);
