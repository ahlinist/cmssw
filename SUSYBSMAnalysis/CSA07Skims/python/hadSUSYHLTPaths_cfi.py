...
hadSUSYHLTQCDPath.HLTPaths = ['HLT1jet', 'HLT2jet', 'HLT1jetPE1', 'HLT1jetPE3', 'HLT1jetPE5', 
    'HLT1Tau']
hadSUSYHLTdiMuonPath.HLTPaths = ['HLT2MuonNonIso']
hadSUSYHLTdiElecPath.HLTPaths = ['HLT2ElectronRelaxed']
hadSUSYHLTJetMETPath.HLTPaths = ['HLT3jet', 'HLT1MET1HT', 'HLT2jetAco', 'HLT1jet1METAco', 'HLTS2jet1METNV', 
