...
print ("neutral_fastsim.py with options:")
...
process.options = cms.untracked.PSet(
	 SkipEvent=cms.untracked.vstring("ScheduleExecutionFailure"),
	 FailModule=cms.untracked.vstring("V0Producer/generalV0Candidates", "generalV0Candidates", "vertexreco")
)
