...
computeBarrelCoefficients(const char* calibFile) {
	...
	cout << "//Matlab equivalent: fa: " << paramFa[0] << "+ (" << paramFa[1] << " + " << paramFa[2] << "/sqrt(x))*exp(-x/"
			<< paramFa[3] << ") - exp(-x^2/" << paramFa[5] << ")* " << paramFa[4] << "\n";
	cout << "//Matlab equivalent: fb: " << paramFb[0] << "+ (" << paramFb[1] << " + " << paramFb[2] << "/sqrt(x))*exp(-x/"
			<< paramFb[3] << ") - exp(-x^2/" << paramFb[5] << ")* " << paramFb[4] << "\n";
	cout << "//Matlab equivalent: fc: " << paramFc[0] << "+ (" << paramFc[1] << " + " << paramFc[2] << "/sqrt(x))*exp(-x/"
...
void tbCalib() {
	...
	isEndcaps = false;
	computeBarrelCoefficients("../../PFClusterTools/test/TBPions_slackCalib.csv");

	//	isEndcaps = true;
	//	computeBarrelCoefficients("../../PFClusterTools/test/TBPions_endcap_noExcesses.csv");
