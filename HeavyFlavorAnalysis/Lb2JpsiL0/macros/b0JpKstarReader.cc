...
// ----------------------------------------------------------------------
// Run with: ./runTreeReaders -c chains/bg-test -D root -C cuts/b0JpKstarReader.default.cuts
//           ./runTreeReaders -f test.root
// ----------------------------------------------------------------------

//==========================================================================

b0JpKstarReader::b0JpKstarReader(TChain *tree, TString evtClassName): lifetimeReader(tree, evtClassName)
{
    cout << "==> b0JpKstarReader: constructor..." << endl;
    fanatype = at_LbJpL0;
}

// ----------------------------------------------------------------------
b0JpKstarReader::~b0JpKstarReader()
{
    cout << "==> b0JpKstarReader: destructor..." << endl;
}

// ----------------------------------------------------------------------
void b0JpKstarReader::endAnalysis()
{
...
bool b0JpKstarReader::compareCands(const CheckedCand clc1, const CheckedCand clc2)
{
...
lifetimeReader::CheckedCand b0JpKstarReader::getCheckedCand(const TAnaCand *tac)
{
    CheckedCand ret;
    ret.isOk = false;
    ret.bc = tac->fIndex;
...
// ----------------------------------------------------------------------
bool b0JpKstarReader::doCandFitStuff(const CheckedCand &clc)
{
...
// ----------------------------------------------------------------------
bool b0JpKstarReader::doTruthMatching(const TAnaTrack *Mu1, const TAnaTrack *Mu2, const TAnaTrack *Ha1, const TAnaTrack *Ha2, const TVector3 &vtx)
{
    bool ret(false);
...
// ----------------------------------------------------------------------
void b0JpKstarReader::doGenLevelStuff()
{
...
void b0JpKstarReader::doCheckEffCands()
{
...
// ----------------------------------------------------------------------
bool b0JpKstarReader::checkCuts()
{
...
// ----------------------------------------------------------------------
void b0JpKstarReader::initVariables()
{
    lifetimeReader::initVariables();
}

// ----------------------------------------------------------------------
void b0JpKstarReader::fillHist()
{
...
// ----------------------------------------------------------------------
void b0JpKstarReader::bookHist()
{
    cout << "==> b0JpKstarReader: bookHist " << endl;
...
// ----------------------------------------------------------------------
void b0JpKstarReader::bookReducedTree()
{
    cout << "==> b0JpKstarReader: bookReducedTree" << endl;
