...
// %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
// %% Usage: ./runTNPReaders -f test.root
// %%        ./runTNPReaders -c chains/bg-test -D root
// %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
int main(int argc, char *argv[]) {
  ...
  treeReaderTNP *a = NULL;
  if (readerName == "tnpReader") a = new tnpReader(chain, TString(evtClassName));
  else if (readerName == "tnpReader2") a = new tnpReader2(chain, TString(evtClassName));
  else {
