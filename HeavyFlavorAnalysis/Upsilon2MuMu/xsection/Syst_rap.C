...
void XSSigPDF_1S(){
  ...
  TFile *f = new TFile("SigPDF_10ptbins_1Srho_rap_v2.root", "RECREATE");
  S12->Write();
...
void XSBgPDF_1S(){
  ...
  TFile *f = new TFile("BgPDF_10ptbins_1Srho_rap_v2.root", "RECREATE");
  S12->Write();
...
void XSSigPDF_2S(){
  ...
  TFile *f = new TFile("SigPDF_10ptbins_2Srho_rap_v2.root", "RECREATE");
  S12->Write();
...
void XSBgPDF_2S(){
  ...
  TFile *f = new TFile("BgPDF_10ptbins_2Srho_rap_v2.root", "RECREATE");
  S12->Write();
...
void XSSigPDF_3S(){
  ...
  TFile *f = new TFile("SigPDF_10ptbins_3Srho_rap_v2.root", "RECREATE");
  S12->Write();
...
void XSBgPDF_3S(){
  ...
  TFile *f = new TFile("BgPDF_10ptbins_3Srho_rap_v2.root", "RECREATE");
  S12->Write();
