...
void Fit_2S(){
  ...
  legg->SetFillStyle(0); legg->SetBorderSize(0); legg->SetTextSize(0.05); legg->SetTextFont(132); 
  legg->SetHeader("");
  legge = legg->AddEntry(S1, "#Upsilon(2S)" ,"p"); legge->SetTextColor(kBlack);
  legg->Draw();
  c1->SaveAs("Fit_2S.pdf");
...
void Fit_3S(){
  ...
  legg->SetFillStyle(0); legg->SetBorderSize(0); legg->SetTextSize(0.05); legg->SetTextFont(132); 
  legg->SetHeader("");
  legge = legg->AddEntry(S1, "#Upsilon(3S)" ,"p"); legge->SetTextColor(kBlack);
  legg->Draw();
  c1->SaveAs("Fit_3S.pdf");
