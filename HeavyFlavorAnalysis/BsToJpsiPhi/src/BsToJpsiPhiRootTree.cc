...
bsTree_->Branch( "lumiSection"   ,       &lumiSection_   ,       "lumiSection/I"   ); 
 ...
 bsTree_->Branch( "MuRecoPt1"                   ,&MuRecoPt1_ ,                      "MuRecoPt1[15]/D");          
 bsTree_->Branch( "MuRecoChg1"                   ,&MuRecoChg1_ ,                      "MuRecoChg1[15]/I");                         
 bsTree_->Branch( "MuRecoEta1"                   ,&MuRecoEta1_ ,                      "MuRecoEta1[15]/D");                                     
 bsTree_->Branch( "MuRecoPhi1"                   ,&MuRecoPhi1_ ,                      "MuRecoPhi1[15]/D");                                    
...
bsTree_->Branch( "RecoMuListSize", &RecoMuListSize_, "RecoMuListSize/I");
...
bsTree_->Branch(  "JpsiEta_alone"		  , &JpsiEta_alone_,                    "JpsiEta_alone/D");                                             
 ...
 bsTree_->Branch(  "JpsiP_alone"		  , &JpsiP_alone_,                     "JpsiP_alone/D");                                            
...
bsTree_->Branch(  "JpsiMu1P_alone"		  , &JpsiMu1P_alone_,                  "JpsiMu1P_alone/D");                                           
bsTree_->Branch(  "JpsiMu2P_alone"		  , &JpsiMu2P_alone_,                  "JpsiMu2P_alone/D");                                          
...
void BsToJpsiPhiRootTree::resetEntries()
{
  ...
  for(int i=0; i<15; i++){
    MuRecoPt1_[i] = -9999999;
    MuRecoPt2_[i] = -9999999;
    MuRecoChg1_[i] = -9999999;
    MuRecoChg2_[i] = -9999999;
    MuRecoEta1_[i] = -9999999;
    MuRecoEta2_[i] = -9999999;
    MuRecoPhi1_[i] = -9999999;
    MuRecoPhi2_[i] = -9999999;
  }
  ...
  JpsiP_alone_ = -9999999;
  JpsiMu1P_alone_ = -9999999;
  JpsiMu2P_alone_ = -9999999;
...
bsTree_->SetBranchAddress(  "MuRecoPt1"                         , &MuRecoPt1_  );
bsTree_->SetBranchAddress(  "MuRecoPt2"                         , &MuRecoPt2_  );
bsTree_->SetBranchAddress(  "MuRecoEta1"                         , &MuRecoEta1_  );
bsTree_->SetBranchAddress(  "MuRecoEta2"                         , &MuRecoEta2_  );
bsTree_->SetBranchAddress(  "MuRecoChg1"                         , &MuRecoChg1_  );
...
bsTree_->SetBranchAddress( "RecoMuListSize", &RecoMuListSize_ );
 ...
 bsTree_->SetBranchAddress(  "JpsiP_alone"		  , &JpsiP_alone_  );                                         
 bsTree_->SetBranchAddress(  "JpsiMu1P_alone"		  , &JpsiMu1P_alone_  );                                      
 bsTree_->SetBranchAddress(  "JpsiMu2P_alone"		  , &JpsiMu2P_alone_  );  
