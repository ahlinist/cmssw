...
int iBdAna_BsJPsiPhiSignalEventsPreKinFit = 0;
int iBdAna_BsJPsiKKSignalEventsPreKinFit = 0;
int iBdAna_BdJPsiKstarSignalEventsPreKinFit = 0;
int iBdAna_BsOtherEventsPreKinFit = 0;
int iBdAna_BdOtherEventsPreKinFit = 0;
int iBdAna_OtherEventsPreKinFit = 0;
int iBdAna_BsJpsiEtaEventsPreKinFit= 0;
int iBdAna_BdJpsiK10EventsPreKinFit= 0;
int iBdAna_BdJpsiK0EventsPreKinFit= 0;
int iBdAna_BpJpsiKpEventsPreKinFit= 0;
  
int iBdAna_BsJPsiPhiSignalEventsOfflineSel1 = 0;
int iBdAna_BsJPsiKKSignalEventsOfflineSel1 = 0;
int iBdAna_BdJPsiKstarSignalEventsOfflineSel1 = 0;
int iBdAna_BsOtherEventsOfflineSel1 = 0;
int iBdAna_BdOtherEventsOfflineSel1 = 0;
int iBdAna_OtherEventsOfflineSel1 = 0;
int iBdAna_BsJpsiEtaEventsOfflineSel1 = 0;
int iBdAna_BdJpsiK10EventsOfflineSel1 = 0;
int iBdAna_BdJpsiK0EventsOfflineSel1 = 0;
int iBdAna_BpJpsiKpEventsOfflineSel1 = 0;

int iBdAna_BsJPsiPhiSignalEventsProbVertex = 0;
int iBdAna_BsJPsiKKSignalEventsProbVertex = 0;
int iBdAna_BdJPsiKstarSignalEventsProbVertex = 0;
int iBdAna_BsOtherEventsProbVertex = 0;
int iBdAna_BdOtherEventsProbVertex = 0;
int iBdAna_OtherEventsProbVertex = 0;
int iBdAna_BsJpsiEtaEventsProbVertex = 0;
int iBdAna_BdJpsiK10EventsProbVertex = 0;
int iBdAna_BdJpsiK0EventsProbVertex = 0;
int iBdAna_BpJpsiKpEventsProbVertex = 0;

int iBdAna_BsJPsiPhiSignalEventsKaonPtCut = 0;
int iBdAna_BsJPsiKKSignalEventsKaonPtCut = 0;
int iBdAna_BdJPsiKstarSignalEventsKaonPtCut = 0;
int iBdAna_BsOtherEventsKaonPtCut = 0;
int iBdAna_BdOtherEventsKaonPtCut = 0;
int iBdAna_OtherEventsKaonPtCut = 0;
int iBdAna_BsJpsiEtaEventsKaonPtCut = 0;
int iBdAna_BdJpsiK10EventsKaonPtCut = 0;
int iBdAna_BdJpsiK0EventsKaonPtCut = 0;
int iBdAna_BpJpsiKpEventsKaonPtCut = 0;

int iBdAna_BsJPsiPhiSignalEventsPhiMassCut = 0;
int iBdAna_BsJPsiKKSignalEventsPhiMassCut = 0;
int iBdAna_BdJPsiKstarSignalEventsPhiMassCut = 0;
int iBdAna_BsOtherEventsPhiMassCut = 0;
int iBdAna_BdOtherEventsPhiMassCut = 0;
int iBdAna_OtherEventsPhiMassCut = 0;
int iBdAna_BsJpsiEtaEventsPhiMassCut = 0;
int iBdAna_BdJpsiK10EventsPhiMassCut = 0;
int iBdAna_BdJpsiK0EventsPhiMassCut = 0;
int iBdAna_BpJpsiKpEventsPhiMassCut = 0;

int iBdAna_BsJPsiPhiSignalEventsDecayLengthCut = 0;
int iBdAna_BsJPsiKKSignalEventsDecayLengthCut = 0;
int iBdAna_BdJPsiKstarSignalEventsDecayLengthCut = 0;
int iBdAna_BsOtherEventsDecayLengthCut = 0;
int iBdAna_BdOtherEventsDecayLengthCut = 0;
int iBdAna_OtherEventsDecayLengthCut = 0;
int iBdAna_BsJpsiEtaEventsDecayLengthCut = 0;
int iBdAna_BdJpsiK10EventsDecayLengthCut = 0;
int iBdAna_BdJpsiK0EventsDecayLengthCut = 0;
int iBdAna_BpJpsiKpEventsDecayLengthCut = 0;

int iBdAna_BsJPsiPhiSignalEventsPointingCut = 0;
int iBdAna_BsJPsiKKSignalEventsPointingCut = 0;
int iBdAna_BdJPsiKstarSignalEventsPointingCut = 0;
int iBdAna_BsOtherEventsPointingCut = 0;
int iBdAna_BdOtherEventsPointingCut = 0;
int iBdAna_OtherEventsPointingCut = 0;
int iBdAna_BsJpsiEtaEventsPointingCut = 0;
int iBdAna_BdJpsiK10EventsPointingCut = 0;
int iBdAna_BdJpsiK0EventsPointingCut = 0;
int iBdAna_BpJpsiKpEventsPointingCut = 0;
