...
triggerDump = cms.EDFilter("HFDumpTrigger",
    ...
    hltLabel = cms.InputTag("TriggerResults","","REDIGI"),
    hltobjectLabel = cms.InputTag("hltTriggerSummaryAOD","","REDIGI"),                     
    ...
    HLTfiltObj2 = cms.untracked.string('hltL2MuonCandidates::REDIGI'),
    HLTfiltObj3 = cms.untracked.string('hltL3MuonCandidates::REDIGI'),
