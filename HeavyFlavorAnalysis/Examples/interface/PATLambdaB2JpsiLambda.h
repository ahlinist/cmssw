...
// $Id: PATLambdaB2JpsiLambda.h,v 1.3 2009/12/18 22:19:50 kaulmer Exp $
//
//

#ifndef _PATLambdaB2JpsiLambda_h
#define _PATLambdaB2JpsiLambda_h
...
class PATLambdaB2JpsiLambda : public edm::EDAnalyzer {
public:
  explicit PATLambdaB2JpsiLambda(const edm::ParameterSet&);
  ~PATLambdaB2JpsiLambda();
...
private:
  ...
  int         trueBResTrkChg;
  vector<int> truthMatch, truthLambda, truthPsi;
  int         prompt;
