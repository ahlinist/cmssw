...
process.generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    ExternalDecays = cms.PSet(
        EvtGen = cms.untracked.PSet(
             ...
             user_decay_file = cms.FileInPath('HeavyFlavorAnalysis/Examples/data/Bs2JpsiPhi.dec'),
...
process.tree = cms.EDFilter("HFTree",
    fileName = cms.string('Bs2JpsiPhi.root')
)
...
process.outpath = cms.EndPath(process.BsFilter*process.JPsiFilter*process.mumugenFilter*
