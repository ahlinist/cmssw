...
process.generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    ExternalDecays = cms.PSet(
        EvtGen = cms.untracked.PSet(
             ...
             user_decay_file = cms.FileInPath('HeavyFlavorAnalysis/Examples/data/LambdaB_LambdaJpsi.dec'),
...
process.tree = cms.EDFilter("HFTree",
    fileName = cms.string('LambdaB2JpsiLambda.root')
)
...
process.signalDump = cms.EDFilter("HFLambdaB2JpsiLambda",
    deltaR = cms.untracked.double(18.),
    verbose = cms.untracked.int32(0),
    muonsLabel = cms.untracked.InputTag("muons"),
    muonPt = cms.untracked.double(3.0),
    trackPt = cms.untracked.double(0.2),
    tracksLabel = cms.untracked.string('generalTracks'),
    PrimaryVertexLabel = cms.untracked.string('offlinePrimaryVertices')
)
...
process.generation_step = cms.Sequence(cms.SequencePlaceholder("randomEngineStateProducer")*
                                       process.generator*
                                       process.LambdaBFilter*process.JPsiFilter*process.mumugenFilter
)
...
process.outpath = cms.EndPath(process.LambdaBFilter*process.JPsiFilter*process.mumugenFilter*
