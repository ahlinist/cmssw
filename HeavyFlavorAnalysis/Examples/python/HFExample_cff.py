...
mcCandidates = cms.EDFilter("CandSelector",
...
genDump = cms.EDFilter("HFDumpGenerator",
    generatorCandidates = cms.untracked.string('mcCandidates'),
...
trkDump = cms.EDFilter("HFDumpTracks",
    ...
    generatorEventLabel = cms.untracked.string('source'),
    ...
    tracksLabel = cms.untracked.string('ctfWithMaterialTracks')
)
