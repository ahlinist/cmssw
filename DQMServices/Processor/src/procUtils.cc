...
namespace dqmevf{
  namespace utils{
	...
	*out << upminutes << " minutes ";
    ...
    void cDiv(std::ostringstream *out,bool doendl){
      *out << "</div>";
	  if (doendl) *out << std::endl;
    } 
	...
	void mTd(std::ostringstream *out, std::string name,std::string id = std::string()){
      *out << "<td id=\"" << name << "\">";
    }
    void cTd(std::ostringstream *out,bool doendl){
      *out << "</div>";
	  if (doendl) *out << std::endl;
    } 
    void mTd(std::ostringstream *out, std::string name, std::string value,std::string id = std::string()){
      mDiv(out,name);
      *out << value;
      cDiv(out);
	  *out << std::endl;
    }
    void mDTd(std::ostringstream *out, std::string name, unsigned int value, std::string id = std::string()){
      mDiv(out,name);
      *out << value;
      cDiv(out);
	  *out << std::endl;
